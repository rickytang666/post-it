...
interactions can still be detected even if the user's hand accidentally penetrates through the plane."
  ...
  private buildMeshShape() {
    ...
    shape.size = new vec3(
      this.planeSize.x + DEFAULT_LERP_OFFSET_CM,
      this.planeSize.y + DEFAULT_LERP_OFFSET_CM,
      (this.proximityDistance + DEFAULT_LERP_OFFSET_CM) * 2
    )
