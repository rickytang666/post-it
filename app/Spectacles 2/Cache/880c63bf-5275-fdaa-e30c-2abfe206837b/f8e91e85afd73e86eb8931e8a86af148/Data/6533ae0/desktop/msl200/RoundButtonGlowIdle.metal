...
float4 param_1=(*sc_set0.UserUniforms).Port_Value_N010;
float4 param_2=param_1+float4(0.001);
param_2-=float4(0.001);
Output_N10=param_2;
float4 Output_N3=float4(0.0);
Output_N3=float4(float(Output_N10.x<(*sc_set0.UserUniforms).Port_Input1_N003),float(Output_N10.y<(*sc_set0.UserUniforms).Port_Input1_N003),float(Output_N10.z<(*sc_set0.UserUniforms).Port_Input1_N003),float(Output_N10.w<(*sc_set0.UserUniforms).Port_Input1_N003));
float4 Output_N2=float4(0.0);
float4 param_3=Output_N10;
float param_4=Output_N3.x;
float4 param_5=param_3;
if (param_3.x<param_4)
{
discard_fragment();
}
Output_N2=param_5;
...
float4 l9_4=fast::max(param_7,float4(0.0));
float4 param_8=l9_4;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float3 l9_59=mix(l9_55,l9_14.xyz,float3(l9_13.w));
l9_14=float4(l9_59.x,l9_59.y,l9_59.z,l9_14.w);
l9_14.w=1.0;
float4 l9_60=l9_14;
param_9=l9_60;
}
