...
//}
//ubo int UserUniforms 0:37:5056 {
//float4 sc_Time 1376
...
//float4 Port_Value0_N030 4848
//float Port_Position1_N030 4864
//float4 Port_Value1_N030 4880
//float Port_Position2_N030 4896
//float4 Port_Value2_N030 4912
//float Port_Position3_N030 4928
//float4 Port_Value3_N030 4944
//float Port_Position4_N030 4960
//float4 Port_Value4_N030 4976
//float4 Port_Value5_N030 4992
//float4 Port_Input1_N000 5008
//float3 Port_Normal_N001 5024
//float Port_Exponent_N001 5040
//float Port_Intensity_N001 5044
//float depthRef 5048
//}
...
float4 param_39=(*sc_set0.UserUniforms).Port_Value0_N030;
float param_40=(*sc_set0.UserUniforms).Port_Position1_N030;
float4 param_41=(*sc_set0.UserUniforms).Port_Value1_N030;
float param_42=(*sc_set0.UserUniforms).Port_Position2_N030;
float4 param_43=(*sc_set0.UserUniforms).Port_Value2_N030;
float param_44=(*sc_set0.UserUniforms).Port_Position3_N030;
float4 param_45=(*sc_set0.UserUniforms).Port_Value3_N030;
float param_46=(*sc_set0.UserUniforms).Port_Position4_N030;
float4 param_47=(*sc_set0.UserUniforms).Port_Value4_N030;
float4 param_48=(*sc_set0.UserUniforms).Port_Value5_N030;
param_38=fast::clamp(param_38,0.0,1.0);
float4 param_49;
if (param_38<param_40)
{
param_49=mix(param_39,param_41,float4(fast::clamp(param_38/param_40,0.0,1.0)));
}
else
{
if (param_38<param_42)
{
param_49=mix(param_41,param_43,float4(fast::clamp((param_38-param_40)/(param_42-param_40),0.0,1.0)));
}
else
{
if (param_38<param_44)
{
param_49=mix(param_43,param_45,float4(fast::clamp((param_38-param_42)/(param_44-param_42),0.0,1.0)));
}
else
{
if (param_38<param_46)
{
param_49=mix(param_45,param_47,float4(fast::clamp((param_38-param_44)/(param_46-param_44),0.0,1.0)));
}
else
{
param_49=mix(param_47,param_48,float4(fast::clamp((param_38-param_46)/(1.0-param_46),0.0,1.0)));
}
}
}
}
Value_N30=param_49;
float Rim_N1=0.0;
float3 param_50=(*sc_set0.UserUniforms).Port_Normal_N001;
float param_51=(*sc_set0.UserUniforms).Port_Exponent_N001;
float param_52=(*sc_set0.UserUniforms).Port_Intensity_N001;
ssGlobals param_54=Globals;
param_50=float3x3(float3(param_54.VertexTangent_WorldSpace),float3(param_54.VertexBinormal_WorldSpace),float3(param_54.VertexNormal_WorldSpace))*param_50;
float l9_236=abs(dot(-param_54.ViewDirWS,param_50));
float param_53=pow(1.0-l9_236,param_51);
param_53=fast::max(param_53,0.0);
param_53*=param_52;
Rim_N1=param_53;
float4 Output_N0=float4(0.0);
Output_N0=mix(Value_N30,(*sc_set0.UserUniforms).Port_Input1_N000,float4(Rim_N1));
float4 Output_N100=float4(0.0);
Output_N100=Output_N2+Output_N0;
FinalColor=Output_N100;
float param_55=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_55<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_240=fast::max(param_56,float4(0.0));
float4 param_57=l9_240;
if (sc_ShaderCacheConstant_tmp!=0)
{
