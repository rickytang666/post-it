...
//float4 Port_Value0_N030 4592
//float Port_Position1_N030 4608
//float4 Port_Value1_N030 4624
//float4 Port_Value2_N030 4640
//float4 Port_Input1_N034 4656
//float3 Port_Normal_N031 4672
//float Port_Exponent_N031 4688
//float Port_Intensity_N031 4692
//float depthRef 4696
//}
...
float4 param_15=(*sc_set0.UserUniforms).Port_Value0_N030;
float param_16=(*sc_set0.UserUniforms).Port_Position1_N030;
float4 param_17=(*sc_set0.UserUniforms).Port_Value1_N030;
float4 param_18=(*sc_set0.UserUniforms).Port_Value2_N030;
param_14=fast::clamp(param_14,0.0,1.0);
float4 param_19;
if (param_14<param_16)
{
param_19=mix(param_15,param_17,float4(fast::clamp(param_14/param_16,0.0,1.0)));
}
else
{
param_19=mix(param_17,param_18,float4(fast::clamp((param_14-param_16)/(1.0-param_16),0.0,1.0)));
}
Value_N30=param_19;
float Rim_N31=0.0;
float3 param_20=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_21=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_22=(*sc_set0.UserUniforms).Port_Intensity_N031;
ssGlobals param_24=Globals;
param_20=float3x3(float3(param_24.VertexTangent_WorldSpace),float3(param_24.VertexBinormal_WorldSpace),float3(param_24.VertexNormal_WorldSpace))*param_20;
float l9_81=abs(dot(-param_24.ViewDirWS,param_20));
float param_23=pow(1.0-l9_81,param_21);
param_23=fast::max(param_23,0.0);
param_23*=param_22;
Rim_N31=param_23;
float4 Output_N34=float4(0.0);
Output_N34=mix(Value_N30,(*sc_set0.UserUniforms).Port_Input1_N034,float4(Rim_N31));
float3 Value1_N23=float3(0.0);
float Value2_N23=0.0;
float4 param_25=Output_N34;
float3 param_26=param_25.xyz;
float param_27=param_25.w;
Value1_N23=param_26;
Value2_N23=param_27;
...
float4 l9_85=fast::max(param_29,float4(0.0));
float4 param_30=l9_85;
if (sc_ShaderCacheConstant_tmp!=0)
{
