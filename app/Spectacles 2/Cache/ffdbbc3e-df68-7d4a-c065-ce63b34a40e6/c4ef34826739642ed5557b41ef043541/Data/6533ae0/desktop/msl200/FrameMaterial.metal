...
int l9_132=l9_131;
l9_130=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_132]*param_13.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_137=param_13.position;
...
int l9_1=l9_0;
Globals.SurfacePosition_ViewSpace=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_1]*float4(in.varPos,1.0)).xyz;
...
int l9_165=l9_160;
float2 l9_166=l9_158;
int l9_167=sc_ScreenTextureLayout_tmp;
int l9_168=l9_165;
float l9_169=l9_159;
...
float4 l9_176=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_175.xy,bias(l9_169));
float4 l9_177=l9_176;
float4 l9_178=l9_177;
l9_140=l9_178;
}
float4 l9_179=l9_140;
float3 l9_180=l9_179.xyz;
float3 l9_181=l9_180;
float3 l9_182=l9_138.xyz;
float3 l9_183=definedBlend(l9_181,l9_182,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_139=float4(l9_183.x,l9_183.y,l9_183.z,l9_139.w);
float3 l9_184=mix(l9_180,l9_139.xyz,float3(l9_138.w));
l9_139=float4(l9_184.x,l9_184.y,l9_184.z,l9_139.w);
l9_139.w=1.0;
float4 l9_185=l9_139;
param_68=l9_185;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_186=float4(in.varScreenPos.xyz,1.0);
param_68=l9_186;
}
else
{
...
float l9_188=fast::clamp(abs(l9_187.z),0.0,1.0);
float4 l9_189=float4(l9_188,1.0-l9_188,1.0,1.0);
param_68=l9_189;
}
else
{
float4 l9_190=param_68;
float4 l9_191=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_191=float4(mix(float3(1.0),l9_190.xyz,float3(l9_190.w)),l9_190.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_192=l9_190.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_192=fast::clamp(l9_192,0.0,1.0);
}
l9_191=float4(l9_190.xyz*l9_192,l9_192);
}
else
{
l9_191=l9_190;
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_69,param_70,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_71=FinalColor;
float4 l9_197=param_71;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_197.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_197;
return out;
}
} // FRAGMENT SHADER
