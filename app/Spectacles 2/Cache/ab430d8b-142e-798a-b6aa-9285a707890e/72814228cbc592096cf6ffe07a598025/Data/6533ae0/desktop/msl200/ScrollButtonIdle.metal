...
//}
//ubo int UserUniforms 0:37:5200 {
//float4 sc_Time 1376
...
//float2 Port_Input1_N028 4808
//float2 Port_Input2_N028 4816
//float4 Port_Value0_N031 4832
//float Port_Position1_N031 4848
//float4 Port_Value1_N031 4864
//float Port_Position2_N031 4880
//float4 Port_Value2_N031 4896
//float Port_Position3_N031 4912
//float4 Port_Value3_N031 4928
//float4 Port_Value4_N031 4944
//float Port_Import_N027 4960
//float3 Port_Import_N041 4976
//float Port_Input1_N045 4992
//float Port_Input2_N045 4996
//float2 Port_Input1_N008 5000
//float2 Port_Input2_N008 5008
//float4 Port_Value0_N005 5024
//float Port_Position1_N005 5040
//float4 Port_Value1_N005 5056
//float Port_Position2_N005 5072
//float4 Port_Value2_N005 5088
//float4 Port_Value3_N005 5104
//float4 Port_Input1_N065 5120
//float3 Port_Normal_N064 5136
//float Port_Exponent_N064 5152
//float Port_Intensity_N064 5156
//float Port_Value0_N016 5160
//float Port_Position1_N016 5164
//float Port_Value1_N016 5168
//float Port_Position2_N016 5172
//float Port_Value2_N016 5176
//float Port_Position3_N016 5180
//float Port_Value3_N016 5184
//float Port_Value4_N016 5188
//float depthRef 5192
//}
...
float param_25=Output_N29;
float4 param_26=(*sc_set0.UserUniforms).Port_Value0_N031;
float param_27=(*sc_set0.UserUniforms).Port_Position1_N031;
float4 param_28=(*sc_set0.UserUniforms).Port_Value1_N031;
float param_29=(*sc_set0.UserUniforms).Port_Position2_N031;
float4 param_30=(*sc_set0.UserUniforms).Port_Value2_N031;
float param_31=(*sc_set0.UserUniforms).Port_Position3_N031;
float4 param_32=(*sc_set0.UserUniforms).Port_Value3_N031;
float4 param_33=(*sc_set0.UserUniforms).Port_Value4_N031;
param_25=fast::clamp(param_25,0.0,1.0);
float4 param_34;
if (param_25<param_27)
{
param_34=mix(param_26,param_28,float4(fast::clamp(param_25/param_27,0.0,1.0)));
}
else
{
if (param_25<param_29)
{
param_34=mix(param_28,param_30,float4(fast::clamp((param_25-param_27)/(param_29-param_27),0.0,1.0)));
}
else
{
if (param_25<param_31)
{
param_34=mix(param_30,param_32,float4(fast::clamp((param_25-param_29)/(param_31-param_29),0.0,1.0)));
}
else
{
param_34=mix(param_32,param_33,float4(fast::clamp((param_25-param_31)/(1.0-param_31),0.0,1.0)));
}
}
}
Value_N31=param_34;
...
float3 param_35=Output_N42;
float l9_156=dot(param_35,param_35);
float l9_157;
if (l9_156>0.0)
{
...
float l9_158=l9_157;
float3 param_36=param_35*l9_158;
Output_N43=param_36;
...
int l9_166=l9_161;
int param_37=capsule_btn_refl_tex_1Layout_tmp;
int param_38=l9_166;
float2 param_39=Output_N45.xy;
bool param_40=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1_tmp)!=0);
float3x3 param_41=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1Transform;
int2 param_42=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1_tmp);
bool param_43=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_44=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_45=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_46=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_47=0.0;
bool l9_167=param_45&&(!param_43);
float l9_168=1.0;
float l9_169=param_39.x;
int l9_170=param_42.x;
if (l9_170==1)
{
l9_169=fract(l9_169);
}
...
param_39.x=l9_169;
float l9_174=param_39.y;
int l9_175=param_42.y;
if (l9_175==1)
{
l9_174=fract(l9_174);
}
...
float l9_181=param_39.x;
float l9_182=param_44.x;
float l9_183=param_44.z;
bool l9_184=l9_180;
float l9_185=l9_168;
...
float l9_190=param_39.y;
float l9_191=param_44.y;
float l9_192=param_44.w;
bool l9_193=l9_189;
float l9_194=l9_168;
...
float2 l9_197=param_39;
bool l9_198=param_40;
float3x3 l9_199=param_41;
if (l9_198)
{
...
param_39=l9_200;
float l9_201=param_39.x;
int l9_202=param_42.x;
bool l9_203=l9_167;
float l9_204=l9_168;
...
param_39.x=l9_201;
l9_168=l9_204;
float l9_212=param_39.y;
int l9_213=param_42.y;
bool l9_214=l9_167;
float l9_215=l9_168;
...
param_39.y=l9_212;
l9_168=l9_215;
float2 l9_223=param_39;
int l9_224=param_37;
int l9_225=param_38;
float l9_226=param_47;
...
if (param_45)
{
l9_234=mix(param_46,l9_234,float4(l9_168));
}
...
float param_48=Output_N8.x;
float4 param_49=(*sc_set0.UserUniforms).Port_Value0_N005;
float param_50=(*sc_set0.UserUniforms).Port_Position1_N005;
float4 param_51=(*sc_set0.UserUniforms).Port_Value1_N005;
float param_52=(*sc_set0.UserUniforms).Port_Position2_N005;
float4 param_53=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 param_54=(*sc_set0.UserUniforms).Port_Value3_N005;
param_48=fast::clamp(param_48,0.0,1.0);
float4 param_55;
if (param_48<param_50)
{
param_55=mix(param_49,param_51,float4(fast::clamp(param_48/param_50,0.0,1.0)));
}
else
{
if (param_48<param_52)
{
param_55=mix(param_51,param_53,float4(fast::clamp((param_48-param_50)/(param_52-param_50),0.0,1.0)));
}
else
{
param_55=mix(param_53,param_54,float4(fast::clamp((param_48-param_52)/(1.0-param_52),0.0,1.0)));
}
}
Value_N5=param_55;
float Rim_N64=0.0;
float3 param_56=(*sc_set0.UserUniforms).Port_Normal_N064;
float param_57=(*sc_set0.UserUniforms).Port_Exponent_N064;
float param_58=(*sc_set0.UserUniforms).Port_Intensity_N064;
ssGlobals param_60=Globals;
param_56=float3x3(float3(param_60.VertexTangent_WorldSpace),float3(param_60.VertexBinormal_WorldSpace),float3(param_60.VertexNormal_WorldSpace))*param_56;
float l9_236=abs(dot(-param_60.ViewDirWS,param_56));
float param_59=pow(1.0-l9_236,param_57);
param_59=fast::max(param_59,0.0);
param_59*=param_58;
Rim_N64=param_59;
...
float Value_N16=0.0;
float param_61=Output_N29;
float param_62=(*sc_set0.UserUniforms).Port_Value0_N016;
float param_63=(*sc_set0.UserUniforms).Port_Position1_N016;
float param_64=(*sc_set0.UserUniforms).Port_Value1_N016;
float param_65=(*sc_set0.UserUniforms).Port_Position2_N016;
float param_66=(*sc_set0.UserUniforms).Port_Value2_N016;
float param_67=(*sc_set0.UserUniforms).Port_Position3_N016;
float param_68=(*sc_set0.UserUniforms).Port_Value3_N016;
float param_69=(*sc_set0.UserUniforms).Port_Value4_N016;
param_61=fast::clamp(param_61,0.0,1.0);
float param_70;
if (param_61<param_63)
{
param_70=mix(param_62,param_64,fast::clamp(param_61/param_63,0.0,1.0));
}
else
{
if (param_61<param_65)
{
param_70=mix(param_64,param_66,fast::clamp((param_61-param_63)/(param_65-param_63),0.0,1.0));
}
else
{
if (param_61<param_67)
{
param_70=mix(param_66,param_68,fast::clamp((param_61-param_65)/(param_67-param_65),0.0,1.0));
}
else
{
param_70=mix(param_68,param_69,fast::clamp((param_61-param_67)/(1.0-param_67),0.0,1.0));
}
}
}
Value_N16=param_70;
...
float2 l9_238=floor(mod(l9_237.xy,float2(4.0)));
float l9_239=(mod(dot(l9_238,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_71<l9_239)
{
discard_fragment();
}
...
float4 l9_240=fast::max(param_72,float4(0.0));
float4 param_73=l9_240;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_243=fast::clamp(l9_242.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_243=fast::clamp(dot(l9_242.xyz,float3(l9_242.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_243=(1.0-dot(l9_242.xyz,float3(0.33333001)))*l9_242.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_243=(1.0-fast::clamp(dot(l9_242.xyz,float3(1.0)),0.0,1.0))*l9_242.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_243=fast::clamp(dot(l9_242.xyz,float3(1.0)),0.0,1.0)*l9_242.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_243=fast::clamp(dot(l9_242.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_243=dot(l9_242.xyz,float3(0.33333001))*l9_242.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_243=1.0-fast::clamp(dot(l9_242.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_244=l9_243;
float l9_245=l9_244;
float l9_246=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_245;
float3 l9_247=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_241.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_248=float4(l9_247.x,l9_247.y,l9_247.z,l9_246);
param_74=l9_248;
}
else
{
...
float2 l9_255=l9_254.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_260=l9_259;
int l9_261=l9_260;
float3 l9_262=float3(l9_256,0.0);
int l9_263=l9_258;
int l9_264=l9_261;
if (l9_263==1)
{
l9_262.y=((2.0*l9_262.y)+float(l9_264))-1.0;
}
float2 l9_265=l9_262.xy;
l9_257=l9_265;
}
else
{
...
int l9_276=l9_271;
float2 l9_277=l9_269;
int l9_278=sc_ScreenTextureLayout_tmp;
int l9_279=l9_276;
float l9_280=l9_270;
...
float4 l9_287=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_286.xy,bias(l9_280));
float4 l9_288=l9_287;
float4 l9_289=l9_288;
l9_251=l9_289;
}
float4 l9_290=l9_251;
float3 l9_291=l9_290.xyz;
float3 l9_292=l9_291;
float3 l9_293=l9_249.xyz;
float3 l9_294=definedBlend(l9_292,l9_293,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_250=float4(l9_294.x,l9_294.y,l9_294.z,l9_250.w);
float3 l9_295=mix(l9_291,l9_250.xyz,float3(l9_249.w));
l9_250=float4(l9_295.x,l9_295.y,l9_295.z,l9_250.w);
l9_250.w=1.0;
float4 l9_296=l9_250;
param_74=l9_296;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_297=float4(in.varScreenPos.xyz,1.0);
param_74=l9_297;
}
else
{
...
float l9_299=fast::clamp(abs(l9_298.z),0.0,1.0);
float4 l9_300=float4(l9_299,1.0-l9_299,1.0,1.0);
param_74=l9_300;
}
else
{
...
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_302=float4(mix(float3(1.0),l9_301.xyz,float3(l9_301.w)),l9_301.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_303=l9_301.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_303=fast::clamp(l9_303,0.0,1.0);
}
l9_302=float4(l9_301.xyz*l9_303,l9_303);
}
else
{
l9_302=l9_301;
...
float4 l9_308=param_77;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_308.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_308;
return out;
}
} // FRAGMENT SHADER
