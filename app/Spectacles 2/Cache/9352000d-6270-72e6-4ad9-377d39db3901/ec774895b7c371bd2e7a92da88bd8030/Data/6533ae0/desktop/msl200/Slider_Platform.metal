...
//}
//ubo int UserUniforms 0:31:4544 {
//float4 sc_Time 1376
...
//float pinch 4384
//float level 4388
//float4 Port_Value_N013 4400
//float Port_Position1_N010 4416
//float2 Port_Offset_N009 4424
//float4 Port_Value0_N011 4432
//float Port_Position1_N011 4448
//float4 Port_Value1_N011 4464
//float Port_Position2_N011 4480
//float4 Port_Value2_N011 4496
//float4 Port_Value3_N011 4512
//float Port_Input0_N005 4528
//float depthRef 4532
//}
...
float Output_N8=0.0;
float param_1=(*sc_set0.UserUniforms).pinch;
Output_N8=param_1;
...
float param_2=CoordsOut_N9.x;
float4 param_3=(*sc_set0.UserUniforms).Port_Value0_N011;
float param_4=(*sc_set0.UserUniforms).Port_Position1_N011;
float4 param_5=(*sc_set0.UserUniforms).Port_Value1_N011;
float param_6=(*sc_set0.UserUniforms).Port_Position2_N011;
float4 param_7=(*sc_set0.UserUniforms).Port_Value2_N011;
float4 param_8=(*sc_set0.UserUniforms).Port_Value3_N011;
param_2=fast::clamp(param_2,0.0,1.0);
float4 param_9;
if (param_2<param_4)
{
param_9=mix(param_3,param_5,float4(fast::clamp(param_2/param_4,0.0,1.0)));
}
else
{
if (param_2<param_6)
{
param_9=mix(param_5,param_7,float4(fast::clamp((param_2-param_4)/(param_6-param_4),0.0,1.0)));
}
else
{
param_9=mix(param_7,param_8,float4(fast::clamp((param_2-param_6)/(1.0-param_6),0.0,1.0)));
}
}
...
if (l9_2)
{
l9_3=11==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_3=l9_2;
...
PreviewInfo.Color=param_9;
PreviewInfo.Color.w=1.0;
}
Value_N11=param_9;
float4 Value_N10=float4(0.0);
float param_10=Output_N8;
float4 param_11=Output_N13;
float param_12=(*sc_set0.UserUniforms).Port_Position1_N010;
float4 param_13=Value_N11;
float4 param_14=Value_N11;
param_10=fast::clamp(param_10,0.0,1.0);
float4 param_15;
if (param_10<param_12)
{
param_15=mix(param_11,param_13,float4(fast::clamp(param_10/param_12,0.0,1.0)));
}
else
{
param_15=mix(param_13,param_14,float4(fast::clamp((param_10-param_12)/(1.0-param_12),0.0,1.0)));
}
...
if (l9_5)
{
l9_6=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_6=l9_5;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=param_15;
PreviewInfo.Color.w=1.0;
}
Value_N10=param_15;
float Output_N3=0.0;
float param_16=(*sc_set0.UserUniforms).level;
Output_N3=param_16;
float Output_N5=0.0;
...
float4 l9_10=fast::max(param_18,float4(0.0));
float4 param_19=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float3 l9_55=l9_54;
float3 l9_56=l9_55;
float4 l9_57=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_56.xy,bias(l9_50));
float4 l9_58=l9_57;
float4 l9_59=l9_58;
l9_21=l9_59;
}
float4 l9_60=l9_21;
float3 l9_61=l9_60.xyz;
float3 l9_62=l9_61;
float3 l9_63=l9_19.xyz;
float3 l9_64=definedBlend(l9_62,l9_63,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_20=float4(l9_64.x,l9_64.y,l9_64.z,l9_20.w);
float3 l9_65=mix(l9_61,l9_20.xyz,float3(l9_19.w));
l9_20=float4(l9_65.x,l9_65.y,l9_65.z,l9_20.w);
l9_20.w=1.0;
float4 l9_66=l9_20;
param_20=l9_66;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_67=float4(in.varScreenPos.xyz,1.0);
param_20=l9_67;
}
else
{
...
float l9_69=fast::clamp(abs(l9_68.z),0.0,1.0);
float4 l9_70=float4(l9_69,1.0-l9_69,1.0,1.0);
param_20=l9_70;
}
else
{
float4 l9_71=param_20;
float4 l9_72=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_72=float4(mix(float3(1.0),l9_71.xyz,float3(l9_71.w)),l9_71.w);
}
else
{
...
{
l9_73=fast::clamp(l9_73,0.0,1.0);
}
l9_72=float4(l9_71.xyz*l9_73,l9_73);
}
else
{
l9_72=l9_71;
...
float4 l9_78=param_23;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_78.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_78;
return out;
}
} // FRAGMENT SHADER
