...
float4 param_13=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_14=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_15=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_16=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_17=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_18=(*sc_set0.UserUniforms).Port_Value3_N007;
...
if (l9_77)
{
l9_78=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_78=l9_77;
