...
float4 l9_660=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_659.xy,bias(l9_653));
float4 l9_661=l9_660;
float4 l9_662=l9_661;
l9_624=l9_662;
}
float4 l9_663=l9_624;
float3 l9_664=l9_663.xyz;
float3 l9_665=l9_664;
float3 l9_666=l9_622.xyz;
float3 l9_667=definedBlend(l9_665,l9_666,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_623=float4(l9_667.x,l9_667.y,l9_667.z,l9_623.w);
float3 l9_668=mix(l9_664,l9_623.xyz,float3(l9_622.w));
l9_623=float4(l9_668.x,l9_668.y,l9_668.z,l9_623.w);
l9_623.w=1.0;
float4 l9_669=l9_623;
param_13=l9_669;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_670=float4(in.varScreenPos.xyz,1.0);
param_13=l9_670;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_671=gl_FragCoord;
float l9_672=fast::clamp(abs(l9_671.z),0.0,1.0);
float4 l9_673=float4(l9_672,1.0-l9_672,1.0,1.0);
param_13=l9_673;
}
else
{
float4 l9_674=param_13;
float4 l9_675=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_675=float4(mix(float3(1.0),l9_674.xyz,float3(l9_674.w)),l9_674.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_676=l9_674.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_676=fast::clamp(l9_676,0.0,1.0);
}
l9_675=float4(l9_674.xyz*l9_676,l9_676);
}
else
{
l9_675=l9_674;
...
float4 l9_681=param_16;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_681.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_681;
return out;
}
} // FRAGMENT SHADER
