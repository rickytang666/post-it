...
let HandVisual = class HandVisual extends BaseScriptComponent {
    ...
    onAwake() {
        ...
        if (this.handMeshFull === undefined) {
            this.handMeshFull = this.sceneObject
                .getChild(HAND_MODEL_INDEX)
                .getChild(HAND_MESH_FULL_INDEX)
                .getComponent("RenderMeshVisual");
        }
        if (this.handMeshIndexThumb === undefined) {
            this.handMeshIndexThumb = this.sceneObject
                .getChild(HAND_MODEL_INDEX)
                .getChild(HAND_MESH_INDEX_THUMB_INDEX)
                .getComponent("RenderMeshVisual");
        }
        ...
        if (this.handType === "left" && this.handMeshPin === undefined) {
            this.handMeshPin = this.sceneObject
                .getChild(HAND_MODEL_INDEX)
                .getChild(HAND_MESH_PIN_INDEX)
                .getComponent("RenderMeshVisual");
        }
