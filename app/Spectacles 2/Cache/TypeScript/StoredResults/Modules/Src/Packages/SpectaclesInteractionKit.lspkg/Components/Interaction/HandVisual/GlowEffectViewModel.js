...
class GlowEffectViewModel {
    ...
    updateInteractionEffects(isAlwaysOn) {
        ...
        this.pokePinchBlend = (_a = this.hand.getPinchStrength()) !== null && _a !== void 0 ? _a : 0.0;
    ...
    calculatePokeEffects(isPoking, distance, deltaTime, isAlwaysOn, finalColor) {
        ...
        const normalizedPokeDepth = (_a = this.handInteractor.normalizedPokeDepth) !== null && _a !== void 0 ? _a : 0;
