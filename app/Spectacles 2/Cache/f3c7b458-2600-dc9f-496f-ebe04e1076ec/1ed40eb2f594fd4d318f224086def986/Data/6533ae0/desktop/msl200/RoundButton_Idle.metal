...
float4 l9_84=fast::max(param_28,float4(0.0));
float4 param_29=l9_84;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_31,param_32,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_33=FinalColor;
float4 l9_152=param_33;
if (sc_ShaderCacheConstant_tmp!=0)
{
