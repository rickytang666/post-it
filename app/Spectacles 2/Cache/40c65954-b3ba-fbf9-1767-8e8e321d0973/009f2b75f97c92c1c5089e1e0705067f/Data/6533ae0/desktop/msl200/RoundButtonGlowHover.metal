...
//float3x3 glow_mapTransform 4432
//float4 glow_mapUvMinMax 4480
//float4 glow_mapBorderColor 4496
//float2 Port_Offset_N009 4512
//float4 Port_Value0_N005 4528
//float Port_Position1_N005 4544
//float4 Port_Value1_N005 4560
//float Port_Position2_N005 4576
//float4 Port_Value2_N005 4592
//float4 Port_Value3_N005 4608
//float Port_Input1_N003 4624
//float depthRef 4628
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int glow_mapLayout 75 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_glow_map [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_glow_map [[function_constant(73)]];
...
constant int glow_mapLayout [[function_constant(75)]];
...
int l9_6=l9_1;
int param_1=glow_mapLayout_tmp;
int param_2=l9_6;
float2 param_3=CoordsOut_N9;
bool param_4=(int(SC_USE_UV_TRANSFORM_glow_map_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).glow_mapTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_glow_map_tmp,SC_SOFTWARE_WRAP_MODE_V_glow_map_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_glow_map_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).glow_mapUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_glow_map_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).glow_mapBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.glow_map.sample(sc_set0.glow_mapSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
float param_12=Color_N1.x;
float4 param_13=(*sc_set0.UserUniforms).Port_Value0_N005;
float param_14=(*sc_set0.UserUniforms).Port_Position1_N005;
float4 param_15=(*sc_set0.UserUniforms).Port_Value1_N005;
float param_16=(*sc_set0.UserUniforms).Port_Position2_N005;
float4 param_17=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 param_18=(*sc_set0.UserUniforms).Port_Value3_N005;
param_12=fast::clamp(param_12,0.0,1.0);
float4 param_19;
if (param_12<param_14)
{
param_19=mix(param_13,param_15,float4(fast::clamp(param_12/param_14,0.0,1.0)));
}
else
{
if (param_12<param_16)
{
param_19=mix(param_15,param_17,float4(fast::clamp((param_12-param_14)/(param_16-param_14),0.0,1.0)));
}
else
{
param_19=mix(param_17,param_18,float4(fast::clamp((param_12-param_16)/(1.0-param_16),0.0,1.0)));
}
}
...
if (l9_77)
{
l9_78=5==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_78=l9_77;
...
float4 param_20=Value_N5;
float param_21=Output_N3.x;
...
float4 l9_82=fast::max(param_24,float4(0.0));
float4 param_25=l9_82;
if (sc_ShaderCacheConstant_tmp!=0)
{
