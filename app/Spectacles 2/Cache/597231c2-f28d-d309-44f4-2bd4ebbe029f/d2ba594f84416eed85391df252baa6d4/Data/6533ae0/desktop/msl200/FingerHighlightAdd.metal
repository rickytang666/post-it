...
//sampler sampler maskMapSmpSC 0:23
...
//texture texture2D maskMap 0:5:0:23
...
//float4 pokeColor 4384
//float4 pinchColor 4400
//float pokePinchBlend 4416
//float pinchBrightness 4420
//float3x3 maskMapTransform 4480
//float4 maskMapUvMinMax 4528
//float4 maskMapBorderColor 4544
//float pinchExponent 4560
//float pokeBrightness 4564
//float pokeExponent 4568
//float pokeHighlightGradientMaskPosition 4572
//float Port_Rotation_N018 4576
//float2 Port_Center_N018 4584
//float Port_Value0_N020 4592
//float Port_Position1_N020 4596
//float Port_Value1_N020 4600
//float Port_Value2_N020 4604
//float Port_Value3_N020 4608
//float depthRef 4612
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_maskMap 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_maskMap 74 -1
//spec_const int intensityTextureLayout 75 0
//spec_const int maskMapLayout 76 0
...
constant bool SC_USE_CLAMP_TO_BORDER_maskMap [[function_constant(32)]];
constant bool SC_USE_CLAMP_TO_BORDER_maskMap_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_maskMap) ? SC_USE_CLAMP_TO_BORDER_maskMap : false;
constant bool SC_USE_UV_MIN_MAX_intensityTexture [[function_constant(33)]];
constant bool SC_USE_UV_MIN_MAX_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_intensityTexture) ? SC_USE_UV_MIN_MAX_intensityTexture : false;
constant bool SC_USE_UV_MIN_MAX_maskMap [[function_constant(34)]];
constant bool SC_USE_UV_MIN_MAX_maskMap_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_maskMap) ? SC_USE_UV_MIN_MAX_maskMap : false;
constant bool SC_USE_UV_TRANSFORM_intensityTexture [[function_constant(35)]];
constant bool SC_USE_UV_TRANSFORM_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_intensityTexture) ? SC_USE_UV_TRANSFORM_intensityTexture : false;
constant bool SC_USE_UV_TRANSFORM_maskMap [[function_constant(36)]];
constant bool SC_USE_UV_TRANSFORM_maskMap_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_maskMap) ? SC_USE_UV_TRANSFORM_maskMap : false;
...
constant bool maskMapHasSwappedViews [[function_constant(39)]];
constant bool maskMapHasSwappedViews_tmp = is_function_constant_defined(maskMapHasSwappedViews) ? maskMapHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_maskMap [[function_constant(72)]];
constant int SC_SOFTWARE_WRAP_MODE_U_maskMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_maskMap) ? SC_SOFTWARE_WRAP_MODE_U_maskMap : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(73)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_maskMap [[function_constant(74)]];
constant int SC_SOFTWARE_WRAP_MODE_V_maskMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_maskMap) ? SC_SOFTWARE_WRAP_MODE_V_maskMap : -1;
constant int intensityTextureLayout [[function_constant(75)]];
constant int intensityTextureLayout_tmp = is_function_constant_defined(intensityTextureLayout) ? intensityTextureLayout : 0;
constant int maskMapLayout [[function_constant(76)]];
constant int maskMapLayout_tmp = is_function_constant_defined(maskMapLayout) ? maskMapLayout : 0;
...
float4 pokeColor;
float4 pinchColor;
float pokePinchBlend;
float pinchBrightness;
float4 maskMapSize;
float4 maskMapDims;
float4 maskMapView;
float3x3 maskMapTransform;
float4 maskMapUvMinMax;
float4 maskMapBorderColor;
float pinchExponent;
float pokeBrightness;
float pokeExponent;
float pokeHighlightGradientMaskPosition;
float Port_Rotation_N018;
float2 Port_Center_N018;
float Port_Value0_N020;
float Port_Position1_N020;
float Port_Value1_N020;
float Port_Value2_N020;
float Port_Value3_N020;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param_1=(*sc_set0.UserUniforms).pokeColor;
Output_N30=param_1;
float3 Output_N16=float3(0.0);
Output_N16=float3(Output_N30.x,Output_N30.y,Output_N30.z);
float4 Output_N6=float4(0.0);
float4 param_2=(*sc_set0.UserUniforms).pinchColor;
Output_N6=param_2;
float3 Output_N15=float3(0.0);
Output_N15=float3(Output_N6.x,Output_N6.y,Output_N6.z);
float Output_N59=0.0;
float param_3=(*sc_set0.UserUniforms).pokePinchBlend;
Output_N59=param_3;
float3 Output_N60=float3(0.0);
Output_N60=mix(Output_N16,Output_N15,float3(Output_N59));
float Output_N28=0.0;
float param_4=(*sc_set0.UserUniforms).pinchBrightness;
Output_N28=param_4;
float2 UVCoord_N34=float2(0.0);
UVCoord_N34=Globals.Surface_UVCoord1;
float4 Color_N31=float4(0.0);
int l9_1;
if ((int(maskMapHasSwappedViews_tmp)!=0))
{
int l9_2=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_6=l9_1;
int param_5=maskMapLayout_tmp;
int param_6=l9_6;
float2 param_7=UVCoord_N34;
bool param_8=(int(SC_USE_UV_TRANSFORM_maskMap_tmp)!=0);
float3x3 param_9=(*sc_set0.UserUniforms).maskMapTransform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_maskMap_tmp,SC_SOFTWARE_WRAP_MODE_V_maskMap_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_maskMap_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).maskMapUvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_maskMap_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).maskMapBorderColor;
float param_15=0.0;
bool l9_7=param_13&&(!param_11);
float l9_8=1.0;
float l9_9=param_7.x;
int l9_10=param_10.x;
if (l9_10==1)
{
l9_9=fract(l9_9);
}
...
param_7.x=l9_9;
float l9_14=param_7.y;
int l9_15=param_10.y;
if (l9_15==1)
{
l9_14=fract(l9_14);
}
...
float l9_22=param_12.x;
float l9_23=param_12.z;
bool l9_24=l9_20;
float l9_25=l9_8;
...
float l9_31=param_12.y;
float l9_32=param_12.w;
bool l9_33=l9_29;
float l9_34=l9_8;
...
float2 l9_37=param_7;
bool l9_38=param_8;
float3x3 l9_39=param_9;
if (l9_38)
{
...
param_7.x=l9_41;
l9_8=l9_44;
float l9_52=param_7.y;
int l9_53=param_10.y;
bool l9_54=l9_7;
float l9_55=l9_8;
if ((l9_53==0)||(l9_53==3))
{
...
param_7.y=l9_52;
l9_8=l9_55;
float2 l9_63=param_7;
int l9_64=param_5;
int l9_65=param_6;
float l9_66=param_15;
float2 l9_67=l9_63;
int l9_68=l9_64;
int l9_69=l9_65;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.maskMap.sample(sc_set0.maskMapSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_13)
{
l9_74=mix(param_14,l9_74,float4(l9_8));
}
float4 l9_75=l9_74;
Color_N31=l9_75;
float Value1_N36=0.0;
float Value2_N36=0.0;
float4 param_16=Color_N31;
float param_17=param_16.x;
float param_18=param_16.y;
Value1_N36=param_17;
Value2_N36=param_18;
float3 Normal_N29=float3(0.0);
Normal_N29=Globals.VertexNormal_WorldSpace;
float3 ViewVector_N39=float3(0.0);
ViewVector_N39=Globals.ViewDirWS;
float Output_N42=0.0;
Output_N42=dot(Normal_N29,ViewVector_N39);
float Output_N46=0.0;
Output_N46=1.0-Output_N42;
float Output_N7=0.0;
float param_19=(*sc_set0.UserUniforms).pinchExponent;
Output_N7=param_19;
...
{
l9_76=pow(Output_N46,Output_N7);
}
Output_N43=l9_76;
float Output_N50=0.0;
Output_N50=Value1_N36*Output_N43;
float Output_N11=0.0;
Output_N11=Output_N28*Output_N50;
float Output_N41=0.0;
float param_20=(*sc_set0.UserUniforms).pokeBrightness;
Output_N41=param_20;
float Output_N0=0.0;
float param_21=(*sc_set0.UserUniforms).pokeExponent;
Output_N0=param_21;
...
{
l9_77=pow(Output_N46,Output_N0);
}
Output_N47=l9_77;
float Output_N24=0.0;
Output_N24=Output_N47*Value2_N36;
float Output_N32=0.0;
Output_N32=Output_N41*Output_N24;
float2 UVCoord_N8=float2(0.0);
UVCoord_N8=Globals.Surface_UVCoord0;
float2 CoordsOut_N18=float2(0.0);
float2 param_22=UVCoord_N8;
float param_23=(*sc_set0.UserUniforms).Port_Rotation_N018;
float2 param_24=(*sc_set0.UserUniforms).Port_Center_N018;
float l9_78=sin(radians(param_23));
float l9_79=cos(radians(param_23));
float2 param_25=param_22-param_24;
param_25=float2(dot(float2(l9_79,l9_78),param_25),dot(float2(-l9_78,l9_79),param_25))+param_24;
CoordsOut_N18=param_25;
float Output_N21=0.0;
float param_26=(*sc_set0.UserUniforms).pokeHighlightGradientMaskPosition;
Output_N21=param_26;
float Value_N20=0.0;
float param_27=CoordsOut_N18.x;
float param_28=(*sc_set0.UserUniforms).Port_Value0_N020;
float param_29=(*sc_set0.UserUniforms).Port_Position1_N020;
float param_30=(*sc_set0.UserUniforms).Port_Value1_N020;
float param_31=Output_N21;
float param_32=(*sc_set0.UserUniforms).Port_Value2_N020;
float param_33=(*sc_set0.UserUniforms).Port_Value3_N020;
param_27=fast::clamp(param_27,0.0,1.0);
float param_34;
if (param_27<param_29)
{
param_34=mix(param_28,param_30,fast::clamp(param_27/param_29,0.0,1.0));
}
else
{
if (param_27<param_31)
{
param_34=mix(param_30,param_32,fast::clamp((param_27-param_29)/(param_31-param_29),0.0,1.0));
}
else
{
param_34=mix(param_32,param_33,fast::clamp((param_27-param_31)/(1.0-param_31),0.0,1.0));
}
}
bool l9_80=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_81;
if (l9_80)
{
l9_81=!PreviewInfo.Saved;
}
else
{
l9_81=l9_80;
...
if (l9_81)
{
l9_82=20==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_82=l9_81;
...
PreviewInfo.Color=float4(param_34,param_34,param_34,1.0);
PreviewInfo.Color.w=1.0;
}
Value_N20=param_34;
float Output_N37=0.0;
Output_N37=Output_N32*Value_N20;
float Output_N51=0.0;
Output_N51=fast::max(Output_N11,Output_N37);
float4 Value_N52=float4(0.0);
Value_N52=float4(Output_N60.x,Output_N60.y,Output_N60.z,Value_N52.w);
Value_N52.w=Output_N51;
...
float4 l9_86=fast::max(param_36,float4(0.0));
float4 param_37=l9_86;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_89=fast::clamp(l9_88.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_89=fast::clamp(dot(l9_88.xyz,float3(l9_88.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_89=(1.0-dot(l9_88.xyz,float3(0.33333001)))*l9_88.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_89=(1.0-fast::clamp(dot(l9_88.xyz,float3(1.0)),0.0,1.0))*l9_88.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_89=fast::clamp(dot(l9_88.xyz,float3(1.0)),0.0,1.0)*l9_88.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_89=fast::clamp(dot(l9_88.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_89=dot(l9_88.xyz,float3(0.33333001))*l9_88.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_89=1.0-fast::clamp(dot(l9_88.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_90=l9_89;
float l9_91=l9_90;
float l9_92=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_91;
float3 l9_93=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_87.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_94=float4(l9_93.x,l9_93.y,l9_93.z,l9_92);
param_38=l9_94;
}
else
{
...
float2 l9_101=l9_100.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_106=l9_105;
int l9_107=l9_106;
float3 l9_108=float3(l9_102,0.0);
int l9_109=l9_104;
int l9_110=l9_107;
if (l9_109==1)
{
l9_108.y=((2.0*l9_108.y)+float(l9_110))-1.0;
}
...
int l9_124=sc_ScreenTextureLayout_tmp;
int l9_125=l9_122;
float l9_126=l9_116;
...
float4 l9_133=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_132.xy,bias(l9_126));
float4 l9_134=l9_133;
float4 l9_135=l9_134;
l9_97=l9_135;
}
float4 l9_136=l9_97;
float3 l9_137=l9_136.xyz;
float3 l9_138=l9_137;
float3 l9_139=l9_95.xyz;
float3 l9_140=definedBlend(l9_138,l9_139,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_96=float4(l9_140.x,l9_140.y,l9_140.z,l9_96.w);
float3 l9_141=mix(l9_137,l9_96.xyz,float3(l9_95.w));
l9_96=float4(l9_141.x,l9_141.y,l9_141.z,l9_96.w);
l9_96.w=1.0;
float4 l9_142=l9_96;
param_38=l9_142;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_143=float4(in.varScreenPos.xyz,1.0);
param_38=l9_143;
}
else
{
...
float l9_145=fast::clamp(abs(l9_144.z),0.0,1.0);
float4 l9_146=float4(l9_145,1.0-l9_145,1.0,1.0);
param_38=l9_146;
}
else
{
float4 l9_147=param_38;
float4 l9_148=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_148=float4(mix(float3(1.0),l9_147.xyz,float3(l9_147.w)),l9_147.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_149=l9_147.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_149=fast::clamp(l9_149,0.0,1.0);
}
l9_148=float4(l9_147.xyz*l9_149,l9_149);
}
else
{
l9_148=l9_147;
...
float4 l9_154=param_41;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_154.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_154;
return out;
}
} // FRAGMENT SHADER
