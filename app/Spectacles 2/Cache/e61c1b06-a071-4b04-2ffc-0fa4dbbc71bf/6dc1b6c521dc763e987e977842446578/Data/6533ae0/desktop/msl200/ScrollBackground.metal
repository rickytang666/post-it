...
//}
//ubo int UserUniforms 0:31:4704 {
//float4 sc_Time 1376
...
//float size 4392
//float scale 4396
//float Port_Input1_N049 4400
//float Port_RangeMinA_N035 4404
//float Port_RangeMaxA_N035 4408
//float Port_RangeMinA_N050 4412
//float Port_RangeMaxA_N050 4416
//float Port_RangeMinB_N050 4420
//float Port_RangeMaxB_N050 4424
//float Port_RangeMinA_N048 4428
//float Port_RangeMaxA_N048 4432
//float Port_RangeMinB_N048 4436
//float Port_RangeMaxB_N048 4440
//float Port_Value2_N034 4444
//float Port_RangeMinA_N046 4448
//float Port_RangeMaxA_N046 4452
//float Port_RangeMinB_N046 4456
//float Port_RangeMaxB_N046 4460
//float2 Port_Center_N039 4464
//float4 Port_Value0_N040 4480
//float Port_Position1_N040 4496
//float4 Port_Value1_N040 4512
//float Port_Position2_N040 4528
//float4 Port_Value2_N040 4544
//float Port_Position3_N040 4560
//float4 Port_Value3_N040 4576
//float Port_Position4_N040 4592
//float4 Port_Value4_N040 4608
//float Port_Position5_N040 4624
//float4 Port_Value5_N040 4640
//float4 Port_Value6_N040 4656
//float4 Port_Value_N005 4672
//float depthRef 4688
//}
...
float l9_1=0.0;
float l9_2=(*sc_set0.UserUniforms).status;
l9_1=l9_2;
param_1=l9_1;
float4 param_4;
if ((param_1*1.0)!=0.0)
...
l9_3=param_5.SurfacePosition_ObjectSpace;
float l9_4=0.0;
float3 l9_5=l9_3;
float l9_6=l9_5.y;
l9_4=l9_6;
float l9_7=0.0;
l9_7=l9_4*(*sc_set0.UserUniforms).Port_Input1_N049;
float l9_8=0.0;
float l9_9=(*sc_set0.UserUniforms).offset;
l9_8=l9_9;
float l9_10=0.0;
float l9_11=(*sc_set0.UserUniforms).size;
l9_10=l9_11;
float l9_12=0.0;
l9_12=(((l9_10-(*sc_set0.UserUniforms).Port_RangeMinA_N050)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N050-(*sc_set0.UserUniforms).Port_RangeMinA_N050)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N050-(*sc_set0.UserUniforms).Port_RangeMinB_N050))+(*sc_set0.UserUniforms).Port_RangeMinB_N050;
float l9_13=0.0;
l9_13=(((l9_10-(*sc_set0.UserUniforms).Port_RangeMinA_N048)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N048-(*sc_set0.UserUniforms).Port_RangeMinA_N048)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N048-(*sc_set0.UserUniforms).Port_RangeMinB_N048))+(*sc_set0.UserUniforms).Port_RangeMinB_N048;
float l9_14=0.0;
l9_14=(((l9_8-(*sc_set0.UserUniforms).Port_RangeMinA_N035)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035)+1e-06))*(l9_13-l9_12))+l9_12;
float2 l9_15=float2(0.0);
l9_15.x=l9_14;
l9_15.y=(*sc_set0.UserUniforms).Port_Value2_N034;
float2 l9_16=float2(0.0);
l9_16=float2(l9_7)+l9_15;
float l9_17=0.0;
float l9_18=(*sc_set0.UserUniforms).scale;
l9_17=l9_18;
float l9_19=0.0;
l9_19=(((l9_17-(*sc_set0.UserUniforms).Port_RangeMinA_N046)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N046-(*sc_set0.UserUniforms).Port_RangeMinA_N046)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N046-(*sc_set0.UserUniforms).Port_RangeMinB_N046))+(*sc_set0.UserUniforms).Port_RangeMinB_N046;
float2 l9_20=float2(0.0);
l9_20=((l9_16-(*sc_set0.UserUniforms).Port_Center_N039)*float2(l9_19))+(*sc_set0.UserUniforms).Port_Center_N039;
float4 l9_21=float4(0.0);
float l9_22=l9_20.x;
float4 l9_23=(*sc_set0.UserUniforms).Port_Value0_N040;
float l9_24=(*sc_set0.UserUniforms).Port_Position1_N040;
float4 l9_25=(*sc_set0.UserUniforms).Port_Value1_N040;
float l9_26=(*sc_set0.UserUniforms).Port_Position2_N040;
float4 l9_27=(*sc_set0.UserUniforms).Port_Value2_N040;
float l9_28=(*sc_set0.UserUniforms).Port_Position3_N040;
float4 l9_29=(*sc_set0.UserUniforms).Port_Value3_N040;
float l9_30=(*sc_set0.UserUniforms).Port_Position4_N040;
float4 l9_31=(*sc_set0.UserUniforms).Port_Value4_N040;
float l9_32=(*sc_set0.UserUniforms).Port_Position5_N040;
float4 l9_33=(*sc_set0.UserUniforms).Port_Value5_N040;
float4 l9_34=(*sc_set0.UserUniforms).Port_Value6_N040;
l9_22=fast::clamp(l9_22,0.0,1.0);
float4 l9_35;
if (l9_22<l9_24)
{
l9_35=mix(l9_23,l9_25,float4(fast::clamp(l9_22/l9_24,0.0,1.0)));
}
else
{
if (l9_22<l9_26)
{
l9_35=mix(l9_25,l9_27,float4(fast::clamp((l9_22-l9_24)/(l9_26-l9_24),0.0,1.0)));
}
else
{
if (l9_22<l9_28)
{
l9_35=mix(l9_27,l9_29,float4(fast::clamp((l9_22-l9_26)/(l9_28-l9_26),0.0,1.0)));
}
else
{
if (l9_22<l9_30)
{
l9_35=mix(l9_29,l9_31,float4(fast::clamp((l9_22-l9_28)/(l9_30-l9_28),0.0,1.0)));
}
else
{
if (l9_22<l9_32)
{
l9_35=mix(l9_31,l9_33,float4(fast::clamp((l9_22-l9_30)/(l9_32-l9_30),0.0,1.0)));
}
else
{
l9_35=mix(l9_33,l9_34,float4(fast::clamp((l9_22-l9_32)/(1.0-l9_32),0.0,1.0)));
}
}
}
}
}
bool l9_36=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_37;
if (l9_36)
{
l9_37=!PreviewInfo.Saved;
}
else
{
l9_37=l9_36;
...
if (l9_37)
{
l9_38=40==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_38=l9_37;
...
l9_39=(*sc_set0.UserUniforms).Port_Value_N005;
param_3=l9_39;
param_4=param_3;
}
Output_N3=param_4;
...
float4 l9_43=fast::max(param_7,float4(0.0));
float4 param_8=l9_43;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_46=fast::clamp(l9_45.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_46=fast::clamp(dot(l9_45.xyz,float3(l9_45.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_46=(1.0-dot(l9_45.xyz,float3(0.33333001)))*l9_45.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_46=(1.0-fast::clamp(dot(l9_45.xyz,float3(1.0)),0.0,1.0))*l9_45.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_46=fast::clamp(dot(l9_45.xyz,float3(1.0)),0.0,1.0)*l9_45.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_46=fast::clamp(dot(l9_45.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_46=dot(l9_45.xyz,float3(0.33333001))*l9_45.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_46=1.0-fast::clamp(dot(l9_45.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_47=l9_46;
float l9_48=l9_47;
float l9_49=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_48;
float3 l9_50=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_44.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_51=float4(l9_50.x,l9_50.y,l9_50.z,l9_49);
param_9=l9_51;
}
else
{
...
float2 l9_58=l9_57.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_59=l9_58;
...
int l9_63=l9_62;
int l9_64=l9_63;
float3 l9_65=float3(l9_59,0.0);
int l9_66=l9_61;
int l9_67=l9_64;
if (l9_66==1)
{
l9_65.y=((2.0*l9_65.y)+float(l9_67))-1.0;
}
float2 l9_68=l9_65.xy;
l9_60=l9_68;
}
else
{
...
float3 l9_88=l9_87;
float3 l9_89=l9_88;
float4 l9_90=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_89.xy,bias(l9_83));
float4 l9_91=l9_90;
float4 l9_92=l9_91;
l9_54=l9_92;
}
float4 l9_93=l9_54;
float3 l9_94=l9_93.xyz;
float3 l9_95=l9_94;
float3 l9_96=l9_52.xyz;
float3 l9_97=definedBlend(l9_95,l9_96,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_53=float4(l9_97.x,l9_97.y,l9_97.z,l9_53.w);
float3 l9_98=mix(l9_94,l9_53.xyz,float3(l9_52.w));
l9_53=float4(l9_98.x,l9_98.y,l9_98.z,l9_53.w);
l9_53.w=1.0;
float4 l9_99=l9_53;
param_9=l9_99;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_100=float4(in.varScreenPos.xyz,1.0);
param_9=l9_100;
}
else
{
...
float l9_102=fast::clamp(abs(l9_101.z),0.0,1.0);
float4 l9_103=float4(l9_102,1.0-l9_102,1.0,1.0);
param_9=l9_103;
}
else
{
float4 l9_104=param_9;
float4 l9_105=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_105=float4(mix(float3(1.0),l9_104.xyz,float3(l9_104.w)),l9_104.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_106=l9_104.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_106=fast::clamp(l9_106,0.0,1.0);
}
l9_105=float4(l9_104.xyz*l9_106,l9_106);
}
else
{
l9_105=l9_104;
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_10,param_11,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_12=FinalColor;
float4 l9_111=param_12;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_111.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_111;
return out;
}
} // FRAGMENT SHADER
