...
//float4 Port_Value0_N003 4736
//float Port_Position1_N003 4752
//float4 Port_Value1_N003 4768
//float Port_Position2_N003 4784
//float4 Port_Value2_N003 4800
//float Port_Position3_N003 4816
//float4 Port_Value3_N003 4832
//float4 Port_Value4_N003 4848
//float4 Port_Input1_N024 4864
...
float4 param_28=(*sc_set0.UserUniforms).Port_Value0_N003;
float param_29=(*sc_set0.UserUniforms).Port_Position1_N003;
float4 param_30=(*sc_set0.UserUniforms).Port_Value1_N003;
float param_31=(*sc_set0.UserUniforms).Port_Position2_N003;
float4 param_32=(*sc_set0.UserUniforms).Port_Value2_N003;
float param_33=(*sc_set0.UserUniforms).Port_Position3_N003;
float4 param_34=(*sc_set0.UserUniforms).Port_Value3_N003;
float4 param_35=(*sc_set0.UserUniforms).Port_Value4_N003;
param_27=fast::clamp(param_27,0.0,1.0);
float4 param_36;
if (param_27<param_29)
{
param_36=mix(param_28,param_30,float4(fast::clamp(param_27/param_29,0.0,1.0)));
}
else
{
if (param_27<param_31)
{
param_36=mix(param_30,param_32,float4(fast::clamp((param_27-param_29)/(param_31-param_29),0.0,1.0)));
}
else
{
if (param_27<param_33)
{
param_36=mix(param_32,param_34,float4(fast::clamp((param_27-param_31)/(param_33-param_31),0.0,1.0)));
}
else
{
param_36=mix(param_34,param_35,float4(fast::clamp((param_27-param_33)/(1.0-param_33),0.0,1.0)));
}
}
}
...
if (l9_162)
{
l9_163=3==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_163=l9_162;
...
PreviewInfo.Color=param_36;
PreviewInfo.Color.w=1.0;
}
Value_N3=param_36;
float Rim_N31=0.0;
float3 param_37=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_38=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_39=(*sc_set0.UserUniforms).Port_Intensity_N031;
ssGlobals param_41=Globals;
param_37=float3x3(float3(param_41.VertexTangent_WorldSpace),float3(param_41.VertexBinormal_WorldSpace),float3(param_41.VertexNormal_WorldSpace))*param_37;
float l9_164=abs(dot(-param_41.ViewDirWS,param_37));
float param_40=pow(1.0-l9_164,param_38);
param_40=fast::max(param_40,0.0);
param_40*=param_39;
Rim_N31=param_40;
...
int l9_170=l9_165;
int param_42=iconLayout_tmp;
int param_43=l9_170;
float2 param_44=CoordsOut_N2;
bool param_45=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 param_46=(*sc_set0.UserUniforms).iconTransform;
int2 param_47=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool param_48=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 param_49=(*sc_set0.UserUniforms).iconUvMinMax;
bool param_50=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_51=(*sc_set0.UserUniforms).iconBorderColor;
float param_52=0.0;
bool l9_171=param_50&&(!param_48);
float l9_172=1.0;
float l9_173=param_44.x;
int l9_174=param_47.x;
if (l9_174==1)
{
l9_173=fract(l9_173);
}
...
param_44.x=l9_173;
float l9_178=param_44.y;
int l9_179=param_47.y;
if (l9_179==1)
{
l9_178=fract(l9_178);
}
...
float l9_186=param_49.x;
float l9_187=param_49.z;
bool l9_188=l9_184;
float l9_189=l9_172;
...
float l9_194=param_44.y;
float l9_195=param_49.y;
float l9_196=param_49.w;
bool l9_197=l9_193;
float l9_198=l9_172;
...
float2 l9_201=param_44;
bool l9_202=param_45;
float3x3 l9_203=param_46;
if (l9_202)
{
...
param_44=l9_204;
float l9_205=param_44.x;
int l9_206=param_47.x;
bool l9_207=l9_171;
float l9_208=l9_172;
...
param_44.x=l9_205;
l9_172=l9_208;
float l9_216=param_44.y;
int l9_217=param_47.y;
bool l9_218=l9_171;
float l9_219=l9_172;
...
param_44.y=l9_216;
l9_172=l9_219;
float2 l9_227=param_44;
int l9_228=param_42;
int l9_229=param_43;
float l9_230=param_52;
...
if (param_50)
{
l9_238=mix(param_51,l9_238,float4(l9_172));
}
...
float param_53=1.0;
float param_54=1.0;
float param_55=(*sc_set0.UserUniforms).Port_Input2_N007;
...
l9_242=param_57.Surface_UVCoord1;
...
float param_58=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_58<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_337=fast::max(param_59,float4(0.0));
float4 param_60=l9_337;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_60.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_60;
return out;
}
float4 param_61=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_338=param_61;
...
float3 param_62=in.varPos;
float4 param_63=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_62,param_63,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_64=FinalColor;
float4 l9_405=param_64;
if (sc_ShaderCacheConstant_tmp!=0)
{
