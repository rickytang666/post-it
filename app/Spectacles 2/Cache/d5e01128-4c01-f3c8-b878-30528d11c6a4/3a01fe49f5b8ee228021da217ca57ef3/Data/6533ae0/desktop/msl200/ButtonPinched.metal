...
//}
//ubo int UserUniforms 0:35:4832 {
//float4 sc_Time 1376
...
//float Port_Import_N062 4644
//float3 Port_Import_N068 4656
//float Port_Input1_N073 4672
//float Port_Input2_N073 4676
//float2 Port_Input1_N009 4680
//float2 Port_Input2_N009 4688
//float4 Port_Value0_N014 4704
//float Port_Position1_N014 4720
//float4 Port_Value1_N014 4736
//float Port_Position2_N014 4752
//float4 Port_Value2_N014 4768
//float4 Port_Value3_N014 4784
//float2 Port_Scale_N002 4800
//float2 Port_Center_N002 4808
//float Port_Input2_N003 4816
//float depthRef 4820
//}
...
int l9_5=l9_4;
VectorOut_N71=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_5]*float4(Output_N70,0.0)).xyz;
...
float4 param_15=(*sc_set0.UserUniforms).Port_Value0_N014;
float param_16=(*sc_set0.UserUniforms).Port_Position1_N014;
float4 param_17=(*sc_set0.UserUniforms).Port_Value1_N014;
float param_18=(*sc_set0.UserUniforms).Port_Position2_N014;
float4 param_19=(*sc_set0.UserUniforms).Port_Value2_N014;
float4 param_20=(*sc_set0.UserUniforms).Port_Value3_N014;
...
int l9_86=l9_81;
int param_22=iconLayout_tmp;
int param_23=l9_86;
float2 param_24=CoordsOut_N2;
bool param_25=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 param_26=(*sc_set0.UserUniforms).iconTransform;
int2 param_27=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool param_28=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 param_29=(*sc_set0.UserUniforms).iconUvMinMax;
bool param_30=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_31=(*sc_set0.UserUniforms).iconBorderColor;
float param_32=0.0;
bool l9_87=param_30&&(!param_28);
float l9_88=1.0;
float l9_89=param_24.x;
int l9_90=param_27.x;
if (l9_90==1)
{
l9_89=fract(l9_89);
}
...
param_24.x=l9_89;
float l9_94=param_24.y;
int l9_95=param_27.y;
if (l9_95==1)
{
l9_94=fract(l9_94);
}
...
float l9_102=param_29.x;
float l9_103=param_29.z;
bool l9_104=l9_100;
float l9_105=l9_88;
...
float l9_111=param_29.y;
float l9_112=param_29.w;
bool l9_113=l9_109;
float l9_114=l9_88;
...
float2 l9_117=param_24;
bool l9_118=param_25;
float3x3 l9_119=param_26;
if (l9_118)
{
...
param_24=l9_120;
float l9_121=param_24.x;
int l9_122=param_27.x;
bool l9_123=l9_87;
float l9_124=l9_88;
...
param_24.x=l9_121;
l9_88=l9_124;
float l9_132=param_24.y;
int l9_133=param_27.y;
bool l9_134=l9_87;
float l9_135=l9_88;
...
param_24.y=l9_132;
l9_88=l9_135;
float2 l9_143=param_24;
int l9_144=param_22;
int l9_145=param_23;
float l9_146=param_32;
...
float4 l9_153=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_152.xy,bias(l9_146));
float4 l9_154=l9_153;
if (param_30)
{
l9_154=mix(param_31,l9_154,float4(l9_88));
}
float4 l9_155=l9_154;
Color_N30=l9_155;
float Output_N3=0.0;
float param_33=1.0;
float param_34=1.0;
float param_35=(*sc_set0.UserUniforms).Port_Input2_N003;
ssGlobals param_37=Globals;
float l9_156=0.0;
float l9_157=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_156=l9_157;
param_33=l9_156;
float param_36;
if ((param_33*1.0)!=0.0)
...
l9_158=param_37.Surface_UVCoord1;
float2 l9_159=float2(0.0);
l9_159=((l9_158-(*sc_set0.UserUniforms).Port_Center_N002)*(*sc_set0.UserUniforms).Port_Scale_N002)+(*sc_set0.UserUniforms).Port_Center_N002;
...
int l9_166=l9_161;
int l9_167=iconLayout_tmp;
int l9_168=l9_166;
float2 l9_169=l9_159;
bool l9_170=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 l9_171=(*sc_set0.UserUniforms).iconTransform;
int2 l9_172=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool l9_173=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 l9_174=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_175=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_176=(*sc_set0.UserUniforms).iconBorderColor;
float l9_177=0.0;
...
float4 l9_244=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_243.xy,bias(l9_237));
...
l9_160=l9_246;
float l9_247=0.0;
float4 l9_248=l9_160;
float l9_249=l9_248.w;
l9_247=l9_249;
param_34=l9_247;
param_36=param_34;
}
...
float2 l9_251=floor(mod(l9_250.xy,float2(4.0)));
float l9_252=(mod(dot(l9_251,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_38<l9_252)
{
discard_fragment();
}
...
float4 l9_253=fast::max(param_39,float4(0.0));
float4 param_40=l9_253;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_262=param_41;
float4 l9_263=float4(0.0);
float4 l9_264=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_265=out.FragColor0;
float4 l9_266=l9_265;
l9_264=l9_266;
}
else
{
float4 l9_267=gl_FragCoord;
float2 l9_268=l9_267.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_273=l9_272;
int l9_274=l9_273;
float3 l9_275=float3(l9_269,0.0);
int l9_276=l9_271;
int l9_277=l9_274;
if (l9_276==1)
{
l9_275.y=((2.0*l9_275.y)+float(l9_277))-1.0;
}
float2 l9_278=l9_275.xy;
l9_270=l9_278;
}
else
{
...
int l9_289=l9_284;
float2 l9_290=l9_282;
int l9_291=sc_ScreenTextureLayout_tmp;
int l9_292=l9_289;
float l9_293=l9_283;
...
float4 l9_300=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_299.xy,bias(l9_293));
float4 l9_301=l9_300;
float4 l9_302=l9_301;
l9_264=l9_302;
}
float4 l9_303=l9_264;
float3 l9_304=l9_303.xyz;
float3 l9_305=l9_304;
float3 l9_306=l9_262.xyz;
float3 l9_307=definedBlend(l9_305,l9_306,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_263=float4(l9_307.x,l9_307.y,l9_307.z,l9_263.w);
float3 l9_308=mix(l9_304,l9_263.xyz,float3(l9_262.w));
l9_263=float4(l9_308.x,l9_308.y,l9_308.z,l9_263.w);
l9_263.w=1.0;
float4 l9_309=l9_263;
param_41=l9_309;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_310=float4(in.varScreenPos.xyz,1.0);
param_41=l9_310;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_311=gl_FragCoord;
float l9_312=fast::clamp(abs(l9_311.z),0.0,1.0);
float4 l9_313=float4(l9_312,1.0-l9_312,1.0,1.0);
param_41=l9_313;
}
else
{
float4 l9_314=param_41;
float4 l9_315=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_315=float4(mix(float3(1.0),l9_314.xyz,float3(l9_314.w)),l9_314.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_316=l9_314.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_316=fast::clamp(l9_316,0.0,1.0);
}
l9_315=float4(l9_314.xyz*l9_316,l9_316);
}
else
{
l9_315=l9_314;
...
float4 l9_321=param_44;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_321.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_321;
return out;
}
} // FRAGMENT SHADER
