...
//}
//ubo int UserUniforms 0:35:4960 {
//float4 sc_Time 1376
...
//float3x3 additional_settings_btn_refl_texTransform 4448
//float4 additional_settings_btn_refl_texUvMinMax 4496
//float4 additional_settings_btn_refl_texBorderColor 4512
//float triggered 4528
//float isToggle 4532
//float4 hoverColor 4544
//float hovered 4560
//float3x3 iconTransform 4624
//float4 iconUvMinMax 4672
//float4 iconBorderColor 4688
//float2 iconScale 4704
//float alpha 4712
//float2 Port_Input1_N009 4736
//float2 Port_Input2_N009 4744
//float4 Port_Value_N026 4752
//float4 Port_Value_N027 4768
//float Port_Position1_N007 4784
//float4 Port_Input1_N019 4800
//float Port_Position2_N007 4816
//float4 Port_Value2_N007 4832
//float4 Port_Value3_N007 4848
//float Port_Input1_N014 4864
//float Port_Input0_N038 4868
//float4 Port_Input1_N043 4880
//float4 Port_Input2_N043 4896
//float Port_Input1_N031 4912
//float Port_Input1_N028 4916
//float Port_Input2_N028 4920
//float Port_Input1_N022 4924
//float Port_Input1_N034 4928
//float Port_Input1_N041 4932
//float2 Port_Center_N002 4936
//float Port_Input0_N018 4944
//float Port_Input1_N018 4948
//float depthRef 4952
//}
...
int l9_2=l9_1;
Globals.SurfacePosition_ViewSpace=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_2]*float4(rhp.positionWS,1.0)).xyz;
...
int l9_4=l9_3;
Globals.VertexNormal_ViewSpace=normalize(((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_4]*float4(Globals.VertexNormal_WorldSpace,0.0)).xyz);
...
int l9_6=l9_5;
Globals.SurfacePosition_ViewSpace=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_6]*float4(in.varPos,1.0)).xyz;
...
float param_2=Value_N42;
float3 param_3=Value_N54;
ssGlobals param_5=Globals;
ssGlobals tempGlobals=param_5;
float2 param_4=float2(0.0);
N44_NormalSpace=int(param_2);
N44_Normal=param_3;
float3 l9_9=N44_Normal;
if (N44_NormalSpace==2)
{
float3 l9_10=tempGlobals.VertexTangent_WorldSpace;
float3 l9_11=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_12=tempGlobals.VertexNormal_WorldSpace;
float3x3 l9_13=float3x3(float3(l9_10),float3(l9_11),float3(l9_12));
l9_9=normalize(l9_13*l9_9);
}
...
int l9_15=l9_14;
float4x4 l9_16=(*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_15];
l9_9=float3x3(l9_16[0].xyz,l9_16[1].xyz,l9_16[2].xyz)*l9_9;
}
float3 l9_17=tempGlobals.SurfacePosition_ViewSpace;
N44_ReflectionUV=cross(normalize(l9_17),l9_9).yx;
N44_ReflectionUV.x*=(-1.0);
N44_ReflectionUV=(N44_ReflectionUV*0.5)+float2(0.5);
param_4=N44_ReflectionUV;
ReflectionUV_N44=param_4;
...
int l9_23=l9_18;
int param_6=additional_settings_btn_refl_texLayout_tmp;
int param_7=l9_23;
float2 param_8=ReflectionUV_N44;
bool param_9=(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex_tmp)!=0);
float3x3 param_10=(*sc_set0.UserUniforms).additional_settings_btn_refl_texTransform;
int2 param_11=int2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex_tmp);
bool param_12=(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex_tmp)!=0);
float4 param_13=(*sc_set0.UserUniforms).additional_settings_btn_refl_texUvMinMax;
bool param_14=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).additional_settings_btn_refl_texBorderColor;
float param_16=0.0;
bool l9_24=param_14&&(!param_12);
float l9_25=1.0;
float l9_26=param_8.x;
int l9_27=param_11.x;
if (l9_27==1)
{
l9_26=fract(l9_26);
}
...
float l9_39=param_13.x;
float l9_40=param_13.z;
bool l9_41=l9_37;
float l9_42=l9_25;
...
float l9_48=param_13.y;
float l9_49=param_13.w;
bool l9_50=l9_46;
float l9_51=l9_25;
...
float2 l9_54=param_8;
bool l9_55=param_9;
float3x3 l9_56=param_10;
if (l9_55)
{
...
float2 l9_57=l9_54;
param_8=l9_57;
float l9_58=param_8.x;
int l9_59=param_11.x;
bool l9_60=l9_24;
float l9_61=l9_25;
if ((l9_59==0)||(l9_59==3))
{
...
param_8.x=l9_58;
l9_25=l9_61;
float l9_69=param_8.y;
int l9_70=param_11.y;
bool l9_71=l9_24;
float l9_72=l9_25;
if ((l9_70==0)||(l9_70==3))
{
...
param_8.y=l9_69;
l9_25=l9_72;
float2 l9_80=param_8;
int l9_81=param_6;
int l9_82=param_7;
float l9_83=param_16;
float2 l9_84=l9_80;
int l9_85=l9_81;
int l9_86=l9_82;
...
float3 l9_88=l9_87;
float3 l9_89=l9_88;
float4 l9_90=sc_set0.additional_settings_btn_refl_tex.sample(sc_set0.additional_settings_btn_refl_texSmpSC,l9_89.xy,bias(l9_83));
float4 l9_91=l9_90;
if (param_14)
{
l9_91=mix(param_15,l9_91,float4(l9_25));
}
float4 l9_92=l9_91;
Color_N53=l9_92;
...
float4 param_17=float4(Normal_N8,0.0);
float2 param_18=param_17.xy;
Value1_N32=param_18;
...
float param_19=(*sc_set0.UserUniforms).triggered;
Output_N24=param_19;
...
float4 param_21=Output_N17;
float param_22=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_23=Output_N19;
float param_24=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_25=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_26=(*sc_set0.UserUniforms).Port_Value3_N007;
param_20=fast::clamp(param_20,0.0,1.0);
float4 param_27;
if (param_20<param_22)
{
param_27=mix(param_21,param_23,float4(fast::clamp(param_20/param_22,0.0,1.0)));
}
else
{
if (param_20<param_24)
{
param_27=mix(param_23,param_25,float4(fast::clamp((param_20-param_22)/(param_24-param_22),0.0,1.0)));
}
else
{
param_27=mix(param_25,param_26,float4(fast::clamp((param_20-param_24)/(1.0-param_24),0.0,1.0)));
}
}
bool l9_93=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_94;
if (l9_93)
{
l9_94=!PreviewInfo.Saved;
}
else
{
l9_94=l9_93;
...
if (l9_94)
{
l9_95=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_95=l9_94;
...
float param_28=(*sc_set0.UserUniforms).isToggle;
Output_N40=param_28;
...
float4 param_29=(*sc_set0.UserUniforms).hoverColor;
Output_N33=param_29;
float Output_N37=0.0;
float param_30=(*sc_set0.UserUniforms).hovered;
Output_N37=param_30;
...
{
l9_96=pow(Output_N28,(*sc_set0.UserUniforms).Port_Input1_N022);
}
Output_N22=l9_96;
...
{
l9_97=pow(Output_N22,(*sc_set0.UserUniforms).Port_Input1_N034);
}
Output_N34=l9_97;
...
float2 param_31=(*sc_set0.UserUniforms).iconScale;
Output_N16=param_31;
...
float param_42=0.0;
bool l9_104=param_40&&(!param_38);
float l9_105=1.0;
float l9_106=param_34.x;
int l9_107=param_37.x;
if (l9_107==1)
{
l9_106=fract(l9_106);
}
...
param_34.x=l9_106;
float l9_111=param_34.y;
int l9_112=param_37.y;
if (l9_112==1)
{
l9_111=fract(l9_111);
}
...
float l9_118=param_34.x;
float l9_119=param_39.x;
float l9_120=param_39.z;
bool l9_121=l9_117;
float l9_122=l9_105;
...
float l9_127=param_34.y;
float l9_128=param_39.y;
float l9_129=param_39.w;
bool l9_130=l9_126;
float l9_131=l9_105;
...
float2 l9_134=param_34;
bool l9_135=param_35;
float3x3 l9_136=param_36;
if (l9_135)
{
...
param_34=l9_137;
float l9_138=param_34.x;
int l9_139=param_37.x;
bool l9_140=l9_104;
float l9_141=l9_105;
...
param_34.x=l9_138;
l9_105=l9_141;
float l9_149=param_34.y;
int l9_150=param_37.y;
bool l9_151=l9_104;
float l9_152=l9_105;
...
param_34.y=l9_149;
l9_105=l9_152;
float2 l9_160=param_34;
int l9_161=param_32;
int l9_162=param_33;
float l9_163=param_42;
...
float4 l9_170=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_169.xy,bias(l9_163));
float4 l9_171=l9_170;
if (param_40)
{
l9_171=mix(param_41,l9_171,float4(l9_105));
}
float4 l9_172=l9_171;
Color_N30=l9_172;
float3 Value1_N13=float3(0.0);
float Value2_N13=0.0;
float4 param_43=Color_N30;
float3 param_44=param_43.xyz;
float param_45=param_43.w;
Value1_N13=param_44;
Value2_N13=param_45;
...
float Output_N1=0.0;
float param_46=(*sc_set0.UserUniforms).alpha;
Output_N1=param_46;
...
float4 l9_176=fast::max(param_48,float4(0.0));
float4 param_49=l9_176;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_226=l9_187;
float3 l9_227=l9_226.xyz;
float3 l9_228=l9_227;
float3 l9_229=l9_185.xyz;
...
float3 l9_231=mix(l9_227,l9_186.xyz,float3(l9_185.w));
l9_186=float4(l9_231.x,l9_231.y,l9_231.z,l9_186.w);
l9_186.w=1.0;
float4 l9_232=l9_186;
param_50=l9_232;
}
else
{
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_51,param_52,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_53=FinalColor;
float4 l9_244=param_53;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_244.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_244;
return out;
}
} // FRAGMENT SHADER
