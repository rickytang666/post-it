...
//float pokePinchBlend 4384
//float3x3 maskMapTransform 4448
//float4 maskMapUvMinMax 4496
//float4 maskMapBorderColor 4512
//float pokeOccludeGradientMaskPosition 4528
//float Port_Value1_N000 4532
//float Port_Value2_N000 4536
//float Port_Value3_N000 4540
//float Port_Rotation_N018 4544
//float2 Port_Center_N018 4552
//float Port_Value0_N020 4560
//float Port_Position1_N020 4564
//float Port_Value1_N020 4568
//float Port_Value2_N020 4572
//float Port_Value3_N020 4576
//float depthRef 4580
//}
...
float pokeOccludeGradientMaskPosition;
float Port_Value1_N000;
float Port_Value2_N000;
float Port_Value3_N000;
...
float param_1=(*sc_set0.UserUniforms).pokePinchBlend;
Output_N59=param_1;
float Output_N14=0.0;
Output_N14=1.0-Output_N59;
...
int l9_6=l9_1;
int param_2=maskMapLayout_tmp;
int param_3=l9_6;
float2 param_4=UVCoord_N34;
bool param_5=(int(SC_USE_UV_TRANSFORM_maskMap_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).maskMapTransform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_maskMap_tmp,SC_SOFTWARE_WRAP_MODE_V_maskMap_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_maskMap_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).maskMapUvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_maskMap_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).maskMapBorderColor;
float param_12=0.0;
...
float4 l9_75=l9_74;
Color_N31=l9_75;
float Value3_N36=0.0;
float4 param_13=Color_N31;
float param_14=param_13.z;
Value3_N36=param_14;
float2 UVCoord_N3=float2(0.0);
UVCoord_N3=Globals.Surface_UVCoord0;
float2 CoordsOut_N18=float2(0.0);
float2 param_15=UVCoord_N3;
float param_16=(*sc_set0.UserUniforms).Port_Rotation_N018;
float2 param_17=(*sc_set0.UserUniforms).Port_Center_N018;
float l9_76=sin(radians(param_16));
float l9_77=cos(radians(param_16));
float2 param_18=param_15-param_17;
param_18=float2(dot(float2(l9_77,l9_76),param_18),dot(float2(-l9_76,l9_77),param_18))+param_17;
CoordsOut_N18=param_18;
float Output_N21=0.0;
float param_19=(*sc_set0.UserUniforms).pokeOccludeGradientMaskPosition;
Output_N21=param_19;
float Value_N20=0.0;
float param_20=CoordsOut_N18.x;
float param_21=(*sc_set0.UserUniforms).Port_Value0_N020;
float param_22=(*sc_set0.UserUniforms).Port_Position1_N020;
float param_23=(*sc_set0.UserUniforms).Port_Value1_N020;
float param_24=Output_N21;
float param_25=(*sc_set0.UserUniforms).Port_Value2_N020;
float param_26=(*sc_set0.UserUniforms).Port_Value3_N020;
param_20=fast::clamp(param_20,0.0,1.0);
float param_27;
if (param_20<param_22)
{
param_27=mix(param_21,param_23,fast::clamp(param_20/param_22,0.0,1.0));
}
else
{
if (param_20<param_24)
{
param_27=mix(param_23,param_25,fast::clamp((param_20-param_22)/(param_24-param_22),0.0,1.0));
}
else
{
param_27=mix(param_25,param_26,fast::clamp((param_20-param_24)/(1.0-param_24),0.0,1.0));
}
}
bool l9_78=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_79;
if (l9_78)
{
l9_79=!PreviewInfo.Saved;
}
else
{
l9_79=l9_78;
...
if (l9_79)
{
l9_80=20==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_80=l9_79;
...
PreviewInfo.Color=float4(param_27,param_27,param_27,1.0);
PreviewInfo.Color.w=1.0;
}
Value_N20=param_27;
float Output_N37=0.0;
Output_N37=Value3_N36*Value_N20;
float4 Value_N0=float4(0.0);
Value_N0.x=(*sc_set0.UserUniforms).Port_Value1_N000;
Value_N0.y=(*sc_set0.UserUniforms).Port_Value2_N000;
Value_N0.z=(*sc_set0.UserUniforms).Port_Value3_N000;
Value_N0.w=Output_N37;
float4 Output_N8=float4(0.0);
Output_N8=float4(Output_N14)*Value_N0;
...
{
l9_87=fast::clamp(l9_86.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_87=fast::clamp(dot(l9_86.xyz,float3(l9_86.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_87=(1.0-dot(l9_86.xyz,float3(0.33333001)))*l9_86.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_87=(1.0-fast::clamp(dot(l9_86.xyz,float3(1.0)),0.0,1.0))*l9_86.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_87=fast::clamp(dot(l9_86.xyz,float3(1.0)),0.0,1.0)*l9_86.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_87=fast::clamp(dot(l9_86.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_87=dot(l9_86.xyz,float3(0.33333001))*l9_86.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_87=1.0-fast::clamp(dot(l9_86.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_88=l9_87;
float l9_89=l9_88;
float l9_90=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_89;
float3 l9_91=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_85.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_92=float4(l9_91.x,l9_91.y,l9_91.z,l9_90);
param_31=l9_92;
}
else
{
...
float2 l9_99=l9_98.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_100=l9_99;
...
int l9_104=l9_103;
int l9_105=l9_104;
float3 l9_106=float3(l9_100,0.0);
int l9_107=l9_102;
int l9_108=l9_105;
if (l9_107==1)
{
l9_106.y=((2.0*l9_106.y)+float(l9_108))-1.0;
}
float2 l9_109=l9_106.xy;
l9_101=l9_109;
}
else
{
...
int l9_122=sc_ScreenTextureLayout_tmp;
int l9_123=l9_120;
float l9_124=l9_114;
...
float4 l9_131=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_130.xy,bias(l9_124));
float4 l9_132=l9_131;
float4 l9_133=l9_132;
l9_95=l9_133;
}
float4 l9_134=l9_95;
float3 l9_135=l9_134.xyz;
float3 l9_136=l9_135;
float3 l9_137=l9_93.xyz;
float3 l9_138=definedBlend(l9_136,l9_137,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_94=float4(l9_138.x,l9_138.y,l9_138.z,l9_94.w);
float3 l9_139=mix(l9_135,l9_94.xyz,float3(l9_93.w));
l9_94=float4(l9_139.x,l9_139.y,l9_139.z,l9_94.w);
l9_94.w=1.0;
float4 l9_140=l9_94;
param_31=l9_140;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_141=float4(in.varScreenPos.xyz,1.0);
param_31=l9_141;
}
else
{
...
float l9_143=fast::clamp(abs(l9_142.z),0.0,1.0);
float4 l9_144=float4(l9_143,1.0-l9_143,1.0,1.0);
param_31=l9_144;
}
else
{
...
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_146=float4(mix(float3(1.0),l9_145.xyz,float3(l9_145.w)),l9_145.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_147=l9_145.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_147=fast::clamp(l9_147,0.0,1.0);
}
l9_146=float4(l9_145.xyz*l9_147,l9_147);
}
else
{
l9_146=l9_145;
...
float3 param_32=in.varPos;
float4 param_33=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_32,param_33,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_34=FinalColor;
float4 l9_152=param_34;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_152.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_152;
return out;
}
} // FRAGMENT SHADER
