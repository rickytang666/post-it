...
//}
//ubo int UserUniforms 0:35:5040 {
//float4 sc_Time 1376
...
//float blur 4688
//float2 boxSize 4696
//float cornerRadius 4704
//float Port_Speed_N022 4768
//float Port_Speed_N063 4816
//float4 Port_Default_N369 4832
//float Port_Default_N204 4888
//float Port_Input1_N098 4892
//float2 Port_Input1_N085 4896
//float2 Port_Input1_N089 4904
//float Port_Input1_N094 4912
//float3 Port_Input0_N073 4928
//float3 Port_Input1_N073 4944
//float2 Port_Input0_N042 4960
//float2 Port_Input1_N046 4968
//float Port_Input1_N047 4976
//float Port_Multiplier_N054 4980
//float Port_Input1_N078 4984
//float Port_Input1_N080 4988
//float Port_Input1_N079 4992
//float Port_Input1_N057 4996
//float Port_Input1_N070 5000
//float2 Port_Scale_N081 5008
//float Port_Input2_N082 5016
//float Port_Input2_N045 5020
//float Port_Input1_N099 5024
//float depthRef 5028
//}
...
float param_10=(*sc_set0.UserUniforms).blur;
Output_N97=param_10;
float Output_N98=0.0;
Output_N98=Output_N97*(*sc_set0.UserUniforms).Port_Input1_N098;
float2 UVCoord_N84=float2(0.0);
UVCoord_N84=Globals.Surface_UVCoord0;
float2 Output_N85=float2(0.0);
Output_N85=UVCoord_N84-(*sc_set0.UserUniforms).Port_Input1_N085;
float2 Output_N86=float2(0.0);
Output_N86=abs(Output_N85);
float2 Output_N83=float2(0.0);
float2 param_11=(*sc_set0.UserUniforms).boxSize;
Output_N83=param_11;
...
Output_N89=fast::max(Output_N90,(*sc_set0.UserUniforms).Port_Input1_N089);
...
Output_N94=fast::max(Output_N93,(*sc_set0.UserUniforms).Port_Input1_N094);
...
Output_N46=UVCoord_N41-(*sc_set0.UserUniforms).Port_Input1_N046;
float2 Output_N47=float2(0.0);
Output_N47=Output_N46*float2((*sc_set0.UserUniforms).Port_Input1_N047);
float Output_N42=0.0;
Output_N42=distance((*sc_set0.UserUniforms).Port_Input0_N042,Output_N47);
...
Output_N73=smoothstep((*sc_set0.UserUniforms).Port_Input0_N073,(*sc_set0.UserUniforms).Port_Input1_N073,Value_N44);
float Time_N54=0.0;
Time_N54=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N054;
float Output_N76=0.0;
Output_N76=sin(Time_N54);
float Output_N78=0.0;
Output_N78=Output_N76*(*sc_set0.UserUniforms).Port_Input1_N078;
float Output_N75=0.0;
Output_N75=sin(Time_N54);
float Output_N77=0.0;
Output_N77=Output_N78*Output_N75;
float Output_N80=0.0;
Output_N80=Output_N77*(*sc_set0.UserUniforms).Port_Input1_N080;
float Output_N79=0.0;
Output_N79=fast::max(Output_N80,(*sc_set0.UserUniforms).Port_Input1_N079);
float Output_N57=0.0;
Output_N57=Output_N79*(*sc_set0.UserUniforms).Port_Input1_N057;
float Output_N70=0.0;
Output_N70=Output_N57+(*sc_set0.UserUniforms).Port_Input1_N070;
...
{
l9_610=pow(Output_N73.x,Output_N70);
}
float l9_611=l9_610;
float l9_612;
if (Output_N73.y<=0.0)
...
{
l9_612=pow(Output_N73.y,Output_N70);
}
float l9_613=l9_612;
float l9_614;
if (Output_N73.z<=0.0)
...
{
l9_614=pow(Output_N73.z,Output_N70);
}
Output_N48=float3(l9_611,l9_613,l9_614);
float2 UVCoord_N72=float2(0.0);
UVCoord_N72=Globals.Surface_UVCoord0;
float Random_N81=0.0;
float2 param_13=UVCoord_N72;
float2 param_14=(*sc_set0.UserUniforms).Port_Scale_N081;
param_13=floor(param_13*10000.0)*9.9999997e-05;
float param_15=dot(floor(param_13*param_14),float2(0.98000002,0.72000003));
param_15=floor(param_15*10000.0)*9.9999997e-05;
param_15=sin(param_15);
param_15*=437.58499;
param_15=fract(param_15);
param_15=floor(param_15*10000.0)*9.9999997e-05;
Random_N81=param_15;
float3 Output_N82=float3(0.0);
Output_N82=mix(Output_N48,float3(Random_N81),float3((*sc_set0.UserUniforms).Port_Input2_N082));
...
Output_N45=mix(Value_N1,Value_N74,float4((*sc_set0.UserUniforms).Port_Input2_N045));
float Output_N99=0.0;
Output_N99=step(Output_N95,(*sc_set0.UserUniforms).Port_Input1_N099);
float4 Output_N96=float4(0.0);
float4 param_16=Output_N45;
float param_17=Output_N99;
...
{
float4 l9_615=gl_FragCoord;
float2 l9_616=floor(mod(l9_615.xy,float2(4.0)));
float l9_617=(mod(dot(l9_616,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_617)
{
discard_fragment();
}
...
float4 l9_618=fast::max(param_20,float4(0.0));
float4 param_21=l9_618;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_621=fast::clamp(l9_620.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_621=fast::clamp(dot(l9_620.xyz,float3(l9_620.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_621=(1.0-dot(l9_620.xyz,float3(0.33333001)))*l9_620.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_621=(1.0-fast::clamp(dot(l9_620.xyz,float3(1.0)),0.0,1.0))*l9_620.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_621=fast::clamp(dot(l9_620.xyz,float3(1.0)),0.0,1.0)*l9_620.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_621=fast::clamp(dot(l9_620.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_621=dot(l9_620.xyz,float3(0.33333001))*l9_620.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_621=1.0-fast::clamp(dot(l9_620.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_622=l9_621;
float l9_623=l9_622;
float l9_624=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_623;
float3 l9_625=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_619.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_626=float4(l9_625.x,l9_625.y,l9_625.z,l9_624);
param_22=l9_626;
}
else
{
...
float2 l9_633=l9_632.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_638=l9_637;
int l9_639=l9_638;
float3 l9_640=float3(l9_634,0.0);
int l9_641=l9_636;
int l9_642=l9_639;
if (l9_641==1)
{
l9_640.y=((2.0*l9_640.y)+float(l9_642))-1.0;
}
float2 l9_643=l9_640.xy;
l9_635=l9_643;
}
else
{
...
{
l9_652=in.varStereoViewID;
}
int l9_653=l9_652;
l9_649=l9_653;
}
int l9_654=l9_649;
float2 l9_655=l9_647;
int l9_656=sc_ScreenTextureLayout_tmp;
int l9_657=l9_654;
float l9_658=l9_648;
...
float4 l9_665=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_664.xy,bias(l9_658));
float4 l9_666=l9_665;
float4 l9_667=l9_666;
l9_629=l9_667;
}
float4 l9_668=l9_629;
float3 l9_669=l9_668.xyz;
float3 l9_670=l9_669;
float3 l9_671=l9_627.xyz;
float3 l9_672=definedBlend(l9_670,l9_671,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_628=float4(l9_672.x,l9_672.y,l9_672.z,l9_628.w);
float3 l9_673=mix(l9_669,l9_628.xyz,float3(l9_627.w));
l9_628=float4(l9_673.x,l9_673.y,l9_673.z,l9_628.w);
l9_628.w=1.0;
float4 l9_674=l9_628;
param_22=l9_674;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_675=float4(in.varScreenPos.xyz,1.0);
param_22=l9_675;
}
else
{
...
float l9_677=fast::clamp(abs(l9_676.z),0.0,1.0);
float4 l9_678=float4(l9_677,1.0-l9_677,1.0,1.0);
param_22=l9_678;
}
else
{
float4 l9_679=param_22;
float4 l9_680=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_680=float4(mix(float3(1.0),l9_679.xyz,float3(l9_679.w)),l9_679.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_681=l9_679.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_681=fast::clamp(l9_681,0.0,1.0);
}
l9_680=float4(l9_679.xyz*l9_681,l9_681);
}
else
{
l9_680=l9_679;
...
float4 l9_686=param_25;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_686.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_686;
return out;
}
} // FRAGMENT SHADER
