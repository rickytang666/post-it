...
float2 l9_616=l9_615.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_621=l9_620;
int l9_622=l9_621;
float3 l9_623=float3(l9_617,0.0);
int l9_624=l9_619;
int l9_625=l9_622;
if (l9_624==1)
{
l9_623.y=((2.0*l9_623.y)+float(l9_625))-1.0;
}
float2 l9_626=l9_623.xy;
l9_618=l9_626;
}
else
{
...
int l9_637=l9_632;
float2 l9_638=l9_630;
int l9_639=sc_ScreenTextureLayout_tmp;
int l9_640=l9_637;
float l9_641=l9_631;
...
float4 l9_648=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_647.xy,bias(l9_641));
float4 l9_649=l9_648;
float4 l9_650=l9_649;
l9_612=l9_650;
}
float4 l9_651=l9_612;
float3 l9_652=l9_651.xyz;
float3 l9_653=l9_652;
float3 l9_654=l9_610.xyz;
float3 l9_655=definedBlend(l9_653,l9_654,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_611=float4(l9_655.x,l9_655.y,l9_655.z,l9_611.w);
float3 l9_656=mix(l9_652,l9_611.xyz,float3(l9_610.w));
l9_611=float4(l9_656.x,l9_656.y,l9_656.z,l9_611.w);
l9_611.w=1.0;
float4 l9_657=l9_611;
param_9=l9_657;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_658=float4(in.varScreenPos.xyz,1.0);
param_9=l9_658;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_659=gl_FragCoord;
float l9_660=fast::clamp(abs(l9_659.z),0.0,1.0);
float4 l9_661=float4(l9_660,1.0-l9_660,1.0,1.0);
param_9=l9_661;
}
else
{
float4 l9_662=param_9;
float4 l9_663=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_663=float4(mix(float3(1.0),l9_662.xyz,float3(l9_662.w)),l9_662.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_664=l9_662.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_664=fast::clamp(l9_664,0.0,1.0);
}
l9_663=float4(l9_662.xyz*l9_664,l9_664);
}
else
{
l9_663=l9_662;
...
float4 l9_669=param_12;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_669.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_669;
return out;
}
} // FRAGMENT SHADER
