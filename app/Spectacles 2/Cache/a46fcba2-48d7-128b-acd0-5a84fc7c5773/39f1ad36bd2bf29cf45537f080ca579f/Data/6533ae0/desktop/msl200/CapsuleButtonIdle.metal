...
//}
//ubo int UserUniforms 0:37:5168 {
//float4 sc_Time 1376
...
//float4 Port_Value0_N007 4848
//float Port_Position1_N007 4864
//float4 Port_Value1_N007 4880
//float Port_Position2_N007 4896
//float4 Port_Value2_N007 4912
//float Port_Position3_N007 4928
//float4 Port_Value3_N007 4944
//float4 Port_Value4_N007 4960
//float2 Port_Input1_N028 4976
//float2 Port_Input2_N028 4984
//float4 Port_Value0_N031 4992
//float Port_Position1_N031 5008
//float4 Port_Value1_N031 5024
//float Port_Position2_N031 5040
//float4 Port_Value2_N031 5056
//float Port_Position3_N031 5072
//float4 Port_Value3_N031 5088
//float4 Port_Value4_N031 5104
//float Port_Value0_N011 5120
//float Port_Position1_N011 5124
//float Port_Value1_N011 5128
//float Port_Position2_N011 5132
//float Port_Value2_N011 5136
//float Port_Position3_N011 5140
//float Port_Value3_N011 5144
//float Port_Value4_N011 5148
//float depthRef 5152
//}
...
float4 param_39=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_40=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_41=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_42=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_43=(*sc_set0.UserUniforms).Port_Value2_N007;
float param_44=(*sc_set0.UserUniforms).Port_Position3_N007;
float4 param_45=(*sc_set0.UserUniforms).Port_Value3_N007;
float4 param_46=(*sc_set0.UserUniforms).Port_Value4_N007;
...
Output_N28=(UVCoord_N17*(*sc_set0.UserUniforms).Port_Input1_N028)+(*sc_set0.UserUniforms).Port_Input2_N028;
float Output_N29=0.0;
Output_N29=length(Output_N28);
float4 Value_N31=float4(0.0);
float param_48=Output_N29;
float4 param_49=(*sc_set0.UserUniforms).Port_Value0_N031;
float param_50=(*sc_set0.UserUniforms).Port_Position1_N031;
float4 param_51=(*sc_set0.UserUniforms).Port_Value1_N031;
float param_52=(*sc_set0.UserUniforms).Port_Position2_N031;
float4 param_53=(*sc_set0.UserUniforms).Port_Value2_N031;
float param_54=(*sc_set0.UserUniforms).Port_Position3_N031;
float4 param_55=(*sc_set0.UserUniforms).Port_Value3_N031;
float4 param_56=(*sc_set0.UserUniforms).Port_Value4_N031;
param_48=fast::clamp(param_48,0.0,1.0);
float4 param_57;
if (param_48<param_50)
{
param_57=mix(param_49,param_51,float4(fast::clamp(param_48/param_50,0.0,1.0)));
}
else
{
if (param_48<param_52)
{
param_57=mix(param_51,param_53,float4(fast::clamp((param_48-param_50)/(param_52-param_50),0.0,1.0)));
}
else
{
if (param_48<param_54)
{
param_57=mix(param_53,param_55,float4(fast::clamp((param_48-param_52)/(param_54-param_52),0.0,1.0)));
}
else
{
param_57=mix(param_55,param_56,float4(fast::clamp((param_48-param_54)/(1.0-param_54),0.0,1.0)));
}
}
}
Value_N31=param_57;
...
float Value_N11=0.0;
float param_58=Value_N7.x;
float param_59=(*sc_set0.UserUniforms).Port_Value0_N011;
float param_60=(*sc_set0.UserUniforms).Port_Position1_N011;
float param_61=(*sc_set0.UserUniforms).Port_Value1_N011;
float param_62=(*sc_set0.UserUniforms).Port_Position2_N011;
float param_63=(*sc_set0.UserUniforms).Port_Value2_N011;
float param_64=(*sc_set0.UserUniforms).Port_Position3_N011;
float param_65=(*sc_set0.UserUniforms).Port_Value3_N011;
float param_66=(*sc_set0.UserUniforms).Port_Value4_N011;
param_58=fast::clamp(param_58,0.0,1.0);
float param_67;
if (param_58<param_60)
{
param_67=mix(param_59,param_61,fast::clamp(param_58/param_60,0.0,1.0));
}
else
{
if (param_58<param_62)
{
param_67=mix(param_61,param_63,fast::clamp((param_58-param_60)/(param_62-param_60),0.0,1.0));
}
else
{
if (param_58<param_64)
{
param_67=mix(param_63,param_65,fast::clamp((param_58-param_62)/(param_64-param_62),0.0,1.0));
}
else
{
param_67=mix(param_65,param_66,fast::clamp((param_58-param_64)/(1.0-param_64),0.0,1.0));
}
}
}
Value_N11=param_67;
...
{
float4 l9_236=gl_FragCoord;
float2 l9_237=floor(mod(l9_236.xy,float2(4.0)));
float l9_238=(mod(dot(l9_237,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_68<l9_238)
{
discard_fragment();
}
...
float4 l9_239=fast::max(param_69,float4(0.0));
float4 param_70=l9_239;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_70.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_70;
return out;
}
float4 param_71=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_240=param_71;
...
{
l9_242=fast::clamp(l9_241.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_242=fast::clamp(dot(l9_241.xyz,float3(l9_241.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_242=(1.0-dot(l9_241.xyz,float3(0.33333001)))*l9_241.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_242=(1.0-fast::clamp(dot(l9_241.xyz,float3(1.0)),0.0,1.0))*l9_241.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_242=fast::clamp(dot(l9_241.xyz,float3(1.0)),0.0,1.0)*l9_241.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_242=fast::clamp(dot(l9_241.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_242=dot(l9_241.xyz,float3(0.33333001))*l9_241.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_242=1.0-fast::clamp(dot(l9_241.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_243=l9_242;
float l9_244=l9_243;
float l9_245=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_244;
float3 l9_246=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_240.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_247=float4(l9_246.x,l9_246.y,l9_246.z,l9_245);
param_71=l9_247;
}
else
{
...
{
param_71=float4(param_71.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_248=param_71;
float4 l9_249=float4(0.0);
float4 l9_250=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_251=out.FragColor0;
...
float2 l9_254=l9_253.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_259=l9_258;
int l9_260=l9_259;
float3 l9_261=float3(l9_255,0.0);
int l9_262=l9_257;
int l9_263=l9_260;
if (l9_262==1)
{
l9_261.y=((2.0*l9_261.y)+float(l9_263))-1.0;
}
float2 l9_264=l9_261.xy;
l9_256=l9_264;
}
else
{
...
int l9_275=l9_270;
float2 l9_276=l9_268;
int l9_277=sc_ScreenTextureLayout_tmp;
int l9_278=l9_275;
float l9_279=l9_269;
...
float4 l9_286=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_285.xy,bias(l9_279));
float4 l9_287=l9_286;
float4 l9_288=l9_287;
l9_250=l9_288;
}
float4 l9_289=l9_250;
float3 l9_290=l9_289.xyz;
float3 l9_291=l9_290;
float3 l9_292=l9_248.xyz;
float3 l9_293=definedBlend(l9_291,l9_292,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_249=float4(l9_293.x,l9_293.y,l9_293.z,l9_249.w);
float3 l9_294=mix(l9_290,l9_249.xyz,float3(l9_248.w));
l9_249=float4(l9_294.x,l9_294.y,l9_294.z,l9_249.w);
l9_249.w=1.0;
float4 l9_295=l9_249;
param_71=l9_295;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_296=float4(in.varScreenPos.xyz,1.0);
param_71=l9_296;
}
else
{
...
float l9_298=fast::clamp(abs(l9_297.z),0.0,1.0);
float4 l9_299=float4(l9_298,1.0-l9_298,1.0,1.0);
param_71=l9_299;
}
else
{
float4 l9_300=param_71;
float4 l9_301=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_301=float4(mix(float3(1.0),l9_300.xyz,float3(l9_300.w)),l9_300.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_302=l9_300.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_302=fast::clamp(l9_302,0.0,1.0);
}
l9_301=float4(l9_300.xyz*l9_302,l9_302);
}
else
{
l9_301=l9_300;
...
float3 param_72=in.varPos;
float4 param_73=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_72,param_73,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_74=FinalColor;
float4 l9_307=param_74;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_307.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_307;
return out;
}
} // FRAGMENT SHADER
