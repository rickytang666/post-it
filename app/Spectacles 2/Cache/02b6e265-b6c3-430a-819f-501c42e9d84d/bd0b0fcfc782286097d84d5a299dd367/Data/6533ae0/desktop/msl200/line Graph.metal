...
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1002=out.FragColor0;
float4 l9_1003=l9_1002;
l9_1001=l9_1003;
}
else
{
float4 l9_1004=gl_FragCoord;
float2 l9_1005=l9_1004.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_1009=in.varStereoViewID;
}
int l9_1010=l9_1009;
int l9_1011=l9_1010;
float3 l9_1012=float3(l9_1006,0.0);
int l9_1013=l9_1008;
int l9_1014=l9_1011;
if (l9_1013==1)
{
l9_1012.y=((2.0*l9_1012.y)+float(l9_1014))-1.0;
}
float2 l9_1015=l9_1012.xy;
l9_1007=l9_1015;
}
else
{
...
int l9_1026=l9_1021;
float2 l9_1027=l9_1019;
int l9_1028=sc_ScreenTextureLayout_tmp;
int l9_1029=l9_1026;
float l9_1030=l9_1020;
float2 l9_1031=l9_1027;
int l9_1032=l9_1028;
int l9_1033=l9_1029;
float3 l9_1034=float3(0.0);
if (l9_1032==0)
{
l9_1034=float3(l9_1031,0.0);
}
else
{
if (l9_1032==1)
{
l9_1034=float3(l9_1031.x,(l9_1031.y*0.5)+(0.5-(float(l9_1033)*0.5)),0.0);
}
else
{
l9_1034=float3(l9_1031,float(l9_1033));
}
}
float3 l9_1035=l9_1034;
float3 l9_1036=l9_1035;
float4 l9_1037=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_1036.xy,bias(l9_1030));
float4 l9_1038=l9_1037;
float4 l9_1039=l9_1038;
l9_1001=l9_1039;
}
float4 l9_1040=l9_1001;
float3 l9_1041=l9_1040.xyz;
float3 l9_1042=l9_1041;
float3 l9_1043=l9_999.xyz;
float3 l9_1044=definedBlend(l9_1042,l9_1043,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1000=float4(l9_1044.x,l9_1044.y,l9_1044.z,l9_1000.w);
float3 l9_1045=mix(l9_1041,l9_1000.xyz,float3(l9_999.w));
l9_1000=float4(l9_1045.x,l9_1045.y,l9_1045.z,l9_1000.w);
l9_1000.w=1.0;
float4 l9_1046=l9_1000;
param_44=l9_1046;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_1047=float4(in.varScreenPos.xyz,1.0);
param_44=l9_1047;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_1048=gl_FragCoord;
float l9_1049=fast::clamp(abs(l9_1048.z),0.0,1.0);
float4 l9_1050=float4(l9_1049,1.0-l9_1049,1.0,1.0);
param_44=l9_1050;
}
else
{
float4 l9_1051=param_44;
float4 l9_1052=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1052=float4(mix(float3(1.0),l9_1051.xyz,float3(l9_1051.w)),l9_1051.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_1053=l9_1051.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_1053=fast::clamp(l9_1053,0.0,1.0);
}
l9_1052=float4(l9_1051.xyz*l9_1053,l9_1053);
}
else
{
l9_1052=l9_1051;
...
float3 param_45=in.varPos;
float4 param_46=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_45,param_46,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_47=FinalColor;
float4 l9_1058=param_47;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_1058.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_1058;
return out;
}
} // FRAGMENT SHADER
