...
//sampler sampler glowTextureSmpSC 0:22
...
//texture texture2D glowTexture 0:4:0:22
...
//float3x3 glowTextureTransform 4432
//float4 glowTextureUvMinMax 4480
//float4 glowTextureBorderColor 4496
//float4 pokeGlowColor 4512
//float4 pinchGlowColor 4528
//float pokePinchBlend 4544
//float pokeGlowBrightness 4548
//float pinchGlowBrightness 4552
//float depthRef 4556
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glowTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glowTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int glowTextureLayout 75 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_glowTexture [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_glowTexture [[function_constant(73)]];
...
constant int glowTextureLayout [[function_constant(75)]];
...
float4 pokeGlowColor;
float4 pinchGlowColor;
float pokePinchBlend;
float pokeGlowBrightness;
float pinchGlowBrightness;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> glowTexture [[id(4)]];
...
sampler glowTextureSmpSC [[id(22)]];
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.glowTexture.sample(sc_set0.glowTextureSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
Output_N21=float3(Color_N18.x,Color_N18.y,Color_N18.z);
float4 Output_N20=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).pokeGlowColor;
Output_N20=param_12;
float4 Output_N19=float4(0.0);
float4 param_13=(*sc_set0.UserUniforms).pinchGlowColor;
Output_N19=param_13;
float Output_N59=0.0;
float param_14=(*sc_set0.UserUniforms).pokePinchBlend;
Output_N59=param_14;
float4 Output_N60=float4(0.0);
Output_N60=mix(Output_N20,Output_N19,float4(Output_N59));
float3 Output_N26=float3(0.0);
Output_N26=float3(Output_N60.x,Output_N60.y,Output_N60.z);
float3 Output_N25=float3(0.0);
Output_N25=Output_N21*Output_N26;
float Output_N27=0.0;
Output_N27=Output_N60.w;
float Output_N22=0.0;
Output_N22=Color_N18.w;
float Output_N14=0.0;
float param_15=(*sc_set0.UserUniforms).pokeGlowBrightness;
Output_N14=param_15;
float Output_N13=0.0;
float param_16=(*sc_set0.UserUniforms).pinchGlowBrightness;
Output_N13=param_16;
float Output_N1=0.0;
Output_N1=mix(Output_N14,Output_N13,Output_N59);
float Output_N23=0.0;
Output_N23=(Output_N27*Output_N22)*Output_N1;
float4 Value_N24=float4(0.0);
Value_N24=float4(Output_N25.x,Output_N25.y,Output_N25.z,Value_N24.w);
Value_N24.w=Output_N23;
...
float4 l9_79=fast::max(param_18,float4(0.0));
float4 param_19=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
