...
//sampler sampler simple_round_buttonSmpSC 0:32
...
//texture texture2D simple_round_button 0:21:0:32
...
//float3x3 simple_round_buttonTransform 4432
//float4 simple_round_buttonUvMinMax 4480
//float4 simple_round_buttonBorderColor 4496
//float Port_Import_N027 4512
//float3 Port_Import_N089 4528
//float Port_Input1_N037 4544
//float Port_Input2_N037 4548
//float3 Port_Input1_N002 4560
//float2 Port_Input1_N010 4576
//float2 Port_Input2_N010 4584
...
//float Port_Position3_N007 4672
//float4 Port_Value3_N007 4688
//float4 Port_Value4_N007 4704
//float4 Port_Input1_N035 4720
//float3 Port_Normal_N031 4736
//float Port_Exponent_N031 4752
//float Port_Intensity_N031 4756
//float depthRef 4760
//}
...
//spec_const bool simple_round_buttonHasSwappedViews 70 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_simple_round_button 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_simple_round_button 74 -1
...
//spec_const int simple_round_buttonLayout 83 0
//SG_REFLECTION_END
...
constant bool SC_USE_CLAMP_TO_BORDER_simple_round_button [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_simple_round_button [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_simple_round_button [[function_constant(36)]];
...
constant bool simple_round_buttonHasSwappedViews [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_simple_round_button [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_simple_round_button [[function_constant(74)]];
...
constant int simple_round_buttonLayout [[function_constant(83)]];
...
texture2d<float> simple_round_button [[id(21)]];
...
sampler simple_round_buttonSmpSC [[id(32)]];
...
int l9_5=l9_4;
VectorOut_N96=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_5]*float4(Output_N91,0.0)).xyz;
float3 Output_N37=float3(0.0);
Output_N37=(VectorOut_N96*float3((*sc_set0.UserUniforms).Port_Input1_N037))+float3((*sc_set0.UserUniforms).Port_Input2_N037);
...
int l9_11=l9_6;
int param_3=simple_round_buttonLayout_tmp;
int param_4=l9_11;
float2 param_5=Output_N37.xy;
bool param_6=(int(SC_USE_UV_TRANSFORM_simple_round_button_tmp)!=0);
float3x3 param_7=(*sc_set0.UserUniforms).simple_round_buttonTransform;
int2 param_8=int2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button_tmp,SC_SOFTWARE_WRAP_MODE_V_simple_round_button_tmp);
bool param_9=(int(SC_USE_UV_MIN_MAX_simple_round_button_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).simple_round_buttonUvMinMax;
bool param_11=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).simple_round_buttonBorderColor;
float param_13=0.0;
...
float3 l9_76=l9_75;
float3 l9_77=l9_76;
float4 l9_78=sc_set0.simple_round_button.sample(sc_set0.simple_round_buttonSmpSC,l9_77.xy,bias(l9_71));
float4 l9_79=l9_78;
if (param_11)
{
...
Output_N10=(UVCoord_N12*(*sc_set0.UserUniforms).Port_Input1_N010)+(*sc_set0.UserUniforms).Port_Input2_N010;
float Output_N14=0.0;
Output_N14=length(Output_N10);
float4 Value_N7=float4(0.0);
float param_14=Output_N14;
...
float param_20=(*sc_set0.UserUniforms).Port_Position3_N007;
float4 param_21=(*sc_set0.UserUniforms).Port_Value3_N007;
float4 param_22=(*sc_set0.UserUniforms).Port_Value4_N007;
...
Value_N7=param_23;
float Rim_N31=0.0;
float3 param_24=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_25=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_26=(*sc_set0.UserUniforms).Port_Intensity_N031;
ssGlobals param_28=Globals;
param_24=float3x3(float3(param_28.VertexTangent_WorldSpace),float3(param_28.VertexBinormal_WorldSpace),float3(param_28.VertexNormal_WorldSpace))*param_24;
float l9_81=abs(dot(-param_28.ViewDirWS,param_24));
float param_27=pow(1.0-l9_81,param_25);
param_27=fast::max(param_27,0.0);
param_27*=param_26;
Rim_N31=param_27;
float4 Output_N35=float4(0.0);
Output_N35=mix(Value_N7,(*sc_set0.UserUniforms).Port_Input1_N035,float4(Rim_N31));
float3 Value1_N23=float3(0.0);
float Value2_N23=0.0;
float4 param_29=Output_N35;
float3 param_30=param_29.xyz;
float param_31=param_29.w;
Value1_N23=param_30;
Value2_N23=param_31;
float3 Output_N2=float3(0.0);
Output_N2=(Export_N40.xyz+(*sc_set0.UserUniforms).Port_Input1_N002)+Value1_N23;
...
{
l9_88=fast::clamp(l9_87.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_88=fast::clamp(dot(l9_87.xyz,float3(l9_87.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_88=(1.0-dot(l9_87.xyz,float3(0.33333001)))*l9_87.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_88=(1.0-fast::clamp(dot(l9_87.xyz,float3(1.0)),0.0,1.0))*l9_87.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_88=fast::clamp(dot(l9_87.xyz,float3(1.0)),0.0,1.0)*l9_87.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_88=fast::clamp(dot(l9_87.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_88=dot(l9_87.xyz,float3(0.33333001))*l9_87.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_88=1.0-fast::clamp(dot(l9_87.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_89=l9_88;
float l9_90=l9_89;
float l9_91=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_90;
float3 l9_92=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_86.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_93=float4(l9_92.x,l9_92.y,l9_92.z,l9_91);
param_35=l9_93;
}
else
{
...
float2 l9_100=l9_99.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_105=l9_104;
int l9_106=l9_105;
float3 l9_107=float3(l9_101,0.0);
int l9_108=l9_103;
int l9_109=l9_106;
if (l9_108==1)
{
l9_107.y=((2.0*l9_107.y)+float(l9_109))-1.0;
}
float2 l9_110=l9_107.xy;
l9_102=l9_110;
}
else
{
...
int l9_121=l9_116;
float2 l9_122=l9_114;
int l9_123=sc_ScreenTextureLayout_tmp;
int l9_124=l9_121;
float l9_125=l9_115;
...
float4 l9_132=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_131.xy,bias(l9_125));
float4 l9_133=l9_132;
float4 l9_134=l9_133;
l9_96=l9_134;
}
float4 l9_135=l9_96;
float3 l9_136=l9_135.xyz;
float3 l9_137=l9_136;
float3 l9_138=l9_94.xyz;
float3 l9_139=definedBlend(l9_137,l9_138,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_95=float4(l9_139.x,l9_139.y,l9_139.z,l9_95.w);
float3 l9_140=mix(l9_136,l9_95.xyz,float3(l9_94.w));
l9_95=float4(l9_140.x,l9_140.y,l9_140.z,l9_95.w);
l9_95.w=1.0;
float4 l9_141=l9_95;
param_35=l9_141;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_142=float4(in.varScreenPos.xyz,1.0);
param_35=l9_142;
}
else
{
...
float l9_144=fast::clamp(abs(l9_143.z),0.0,1.0);
float4 l9_145=float4(l9_144,1.0-l9_144,1.0,1.0);
param_35=l9_145;
}
else
{
float4 l9_146=param_35;
float4 l9_147=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_147=float4(mix(float3(1.0),l9_146.xyz,float3(l9_146.w)),l9_146.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_148=l9_146.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_148=fast::clamp(l9_148,0.0,1.0);
}
l9_147=float4(l9_146.xyz*l9_148,l9_148);
}
else
{
l9_147=l9_146;
...
float3 param_36=in.varPos;
float4 param_37=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_36,param_37,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_38=FinalColor;
float4 l9_153=param_38;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_153.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_153;
return out;
}
} // FRAGMENT SHADER
