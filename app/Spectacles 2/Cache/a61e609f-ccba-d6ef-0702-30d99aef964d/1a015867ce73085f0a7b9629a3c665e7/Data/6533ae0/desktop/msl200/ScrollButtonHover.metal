...
//sampler sampler capsule_btn_refl_tex_1SmpSC 0:24
//sampler sampler capsule_btn_refl_tex_2SmpSC 0:25
//sampler sampler capsule_btn_refl_tex_3SmpSC 0:26
...
//texture texture2D capsule_btn_refl_tex_1 0:4:0:24
//texture texture2D capsule_btn_refl_tex_2 0:5:0:25
//texture texture2D capsule_btn_refl_tex_3 0:6:0:26
...
//}
//ubo int UserUniforms 0:37:5408 {
//float4 sc_Time 1376
...
//float3x3 capsule_btn_refl_tex_2Transform 4432
//float4 capsule_btn_refl_tex_2UvMinMax 4480
//float4 capsule_btn_refl_tex_2BorderColor 4496
//float3x3 capsule_btn_refl_tex_3Transform 4560
//float4 capsule_btn_refl_tex_3UvMinMax 4608
//float4 capsule_btn_refl_tex_3BorderColor 4624
//float3x3 capsule_btn_refl_tex_1Transform 4688
//float4 capsule_btn_refl_tex_1UvMinMax 4736
//float4 capsule_btn_refl_tex_1BorderColor 4752
//float Port_Import_N101 4768
//float3 Port_Import_N111 4784
//float Port_Input1_N115 4800
//float Port_Input2_N115 4804
//float Port_Import_N027 4808
//float3 Port_Import_N041 4816
//float Port_Input1_N045 4832
//float Port_Input2_N045 4836
//float2 Port_Input1_N008 4840
//float2 Port_Input2_N008 4848
//float4 Port_Value0_N005 4864
//float Port_Position1_N005 4880
//float4 Port_Value1_N005 4896
//float Port_Position2_N005 4912
//float4 Port_Value2_N005 4928
//float4 Port_Value3_N005 4944
//float4 Port_Input1_N065 4960
//float3 Port_Normal_N064 4976
//float Port_Exponent_N064 4992
//float Port_Intensity_N064 4996
//float2 Port_Input1_N067 5000
//float2 Port_Input2_N067 5008
//float4 Port_Value0_N069 5024
//float Port_Position1_N069 5040
//float4 Port_Value1_N069 5056
//float Port_Position2_N069 5072
//float4 Port_Value2_N069 5088
//float Port_Position3_N069 5104
//float4 Port_Value3_N069 5120
//float4 Port_Value4_N069 5136
//float4 Port_Input0_N092 5152
//float4 Port_Input1_N092 5168
//float3 Port_Normal_N091 5184
//float Port_Exponent_N091 5200
//float Port_Intensity_N091 5204
//float4 Port_Input1_N093 5216
//float4 Port_Import_N074 5232
//float4 Port_Import_N075 5248
//float Port_Input0_N087 5264
//float Port_Input1_N087 5268
//float Port_RangeMinA_N076 5272
//float Port_RangeMaxA_N076 5276
//float Port_RangeMinB_N076 5280
//float Port_RangeMaxB_N076 5284
//float2 Port_CoordsIn_N090 5288
//float Port_Rotation_N090 5296
//float2 Port_Center_N090 5304
//float2 Port_Center_N078 5320
//float2 Port_Import_N079 5328
//float2 Port_Import_N081 5336
//float Port_Input1_N086 5344
//float Port_Input2_N086 5348
//float2 Port_Input1_N028 5352
//float2 Port_Input2_N028 5360
//float Port_Value0_N016 5368
//float Port_Position1_N016 5372
//float Port_Value1_N016 5376
//float Port_Position2_N016 5380
//float Port_Value2_N016 5384
//float Port_Position3_N016 5388
//float Port_Value3_N016 5392
//float Port_Value4_N016 5396
//float depthRef 5400
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 86 -1
//spec_const int capsule_btn_refl_tex_1Layout 87 0
//spec_const int capsule_btn_refl_tex_2Layout 88 0
//spec_const int capsule_btn_refl_tex_3Layout 89 0
...
constant bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1 [[function_constant(31)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2 [[function_constant(32)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3 [[function_constant(33)]];
...
constant bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1 [[function_constant(35)]];
...
constant bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_2 [[function_constant(36)]];
...
constant bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_3 [[function_constant(37)]];
...
constant bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1 [[function_constant(39)]];
...
constant bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_2 [[function_constant(40)]];
...
constant bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_3 [[function_constant(41)]];
...
constant bool capsule_btn_refl_tex_1HasSwappedViews [[function_constant(44)]];
...
constant bool capsule_btn_refl_tex_2HasSwappedViews [[function_constant(45)]];
...
constant bool capsule_btn_refl_tex_3HasSwappedViews [[function_constant(46)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1 [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2 [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3 [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1 [[function_constant(83)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2 [[function_constant(84)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3 [[function_constant(85)]];
...
constant int capsule_btn_refl_tex_1Layout [[function_constant(87)]];
...
constant int capsule_btn_refl_tex_2Layout [[function_constant(88)]];
...
constant int capsule_btn_refl_tex_3Layout [[function_constant(89)]];
...
float3 param_1=Output_N112;
float l9_1=dot(param_1,param_1);
float l9_2;
if (l9_1>0.0)
{
l9_2=1.0/sqrt(l9_1);
...
int l9_5=l9_4;
VectorOut_N114=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_5]*float4(Output_N113,0.0)).xyz;
float3 Output_N115=float3(0.0);
Output_N115=(VectorOut_N114*float3((*sc_set0.UserUniforms).Port_Input1_N115))+float3((*sc_set0.UserUniforms).Port_Input2_N115);
...
int l9_11=l9_6;
int param_3=capsule_btn_refl_tex_2Layout_tmp;
int param_4=l9_11;
float2 param_5=Output_N115.xy;
bool param_6=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_2_tmp)!=0);
float3x3 param_7=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2Transform;
int2 param_8=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2_tmp);
bool param_9=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_2_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2UvMinMax;
bool param_11=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2BorderColor;
float param_13=0.0;
bool l9_12=param_11&&(!param_9);
float l9_13=1.0;
float l9_14=param_5.x;
int l9_15=param_8.x;
if (l9_15==1)
{
l9_14=fract(l9_14);
...
float l9_26=param_5.x;
float l9_27=param_10.x;
float l9_28=param_10.z;
bool l9_29=l9_25;
float l9_30=l9_13;
...
float l9_35=param_5.y;
float l9_36=param_10.y;
float l9_37=param_10.w;
bool l9_38=l9_34;
float l9_39=l9_13;
...
float2 l9_42=param_5;
bool l9_43=param_6;
float3x3 l9_44=param_7;
if (l9_43)
{
...
param_5.y=l9_57;
l9_13=l9_60;
float2 l9_68=param_5;
int l9_69=param_3;
int l9_70=param_4;
float l9_71=param_13;
float2 l9_72=l9_68;
int l9_73=l9_69;
int l9_74=l9_70;
...
float3 l9_76=l9_75;
float3 l9_77=l9_76;
float4 l9_78=sc_set0.capsule_btn_refl_tex_2.sample(sc_set0.capsule_btn_refl_tex_2SmpSC,l9_77.xy,bias(l9_71));
float4 l9_79=l9_78;
if (param_11)
{
l9_79=mix(param_12,l9_79,float4(l9_13));
}
float4 l9_80=l9_79;
Color_N116=l9_80;
...
int l9_86=l9_81;
int param_14=capsule_btn_refl_tex_3Layout_tmp;
int param_15=l9_86;
float2 param_16=UVCoord_N15;
bool param_17=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_3_tmp)!=0);
float3x3 param_18=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3Transform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_3_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3UvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3BorderColor;
float param_24=0.0;
bool l9_87=param_22&&(!param_20);
float l9_88=1.0;
float l9_89=param_16.x;
int l9_90=param_19.x;
if (l9_90==1)
{
l9_89=fract(l9_89);
}
...
param_16.x=l9_89;
float l9_94=param_16.y;
int l9_95=param_19.y;
if (l9_95==1)
{
l9_94=fract(l9_94);
}
...
float l9_101=param_16.x;
float l9_102=param_21.x;
float l9_103=param_21.z;
bool l9_104=l9_100;
float l9_105=l9_88;
...
float l9_110=param_16.y;
float l9_111=param_21.y;
float l9_112=param_21.w;
bool l9_113=l9_109;
float l9_114=l9_88;
...
bool l9_118=param_17;
float3x3 l9_119=param_18;
if (l9_118)
{
l9_117=float2((l9_119*float3(l9_117,1.0)).xy);
}
float2 l9_120=l9_117;
param_16=l9_120;
float l9_121=param_16.x;
int l9_122=param_19.x;
bool l9_123=l9_87;
float l9_124=l9_88;
...
param_16.x=l9_121;
l9_88=l9_124;
float l9_132=param_16.y;
int l9_133=param_19.y;
bool l9_134=l9_87;
float l9_135=l9_88;
...
param_16.y=l9_132;
l9_88=l9_135;
float2 l9_143=param_16;
int l9_144=param_14;
int l9_145=param_15;
float l9_146=param_24;
...
float4 l9_153=sc_set0.capsule_btn_refl_tex_3.sample(sc_set0.capsule_btn_refl_tex_3SmpSC,l9_152.xy,bias(l9_146));
float4 l9_154=l9_153;
if (param_22)
{
l9_154=mix(param_23,l9_154,float4(l9_88));
}
float4 l9_155=l9_154;
Color_N10=l9_155;
...
float3 param_25=Output_N42;
float l9_156=dot(param_25,param_25);
float l9_157;
if (l9_156>0.0)
{
...
float l9_158=l9_157;
float3 param_26=param_25*l9_158;
Output_N43=param_26;
...
int l9_160=l9_159;
VectorOut_N44=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_160]*float4(Output_N43,0.0)).xyz;
float3 Output_N45=float3(0.0);
Output_N45=(VectorOut_N44*float3((*sc_set0.UserUniforms).Port_Input1_N045))+float3((*sc_set0.UserUniforms).Port_Input2_N045);
...
int l9_166=l9_161;
int param_27=capsule_btn_refl_tex_1Layout_tmp;
int param_28=l9_166;
float2 param_29=Output_N45.xy;
bool param_30=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1_tmp)!=0);
float3x3 param_31=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1Transform;
int2 param_32=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1_tmp);
bool param_33=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_34=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_35=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_36=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_37=0.0;
bool l9_167=param_35&&(!param_33);
float l9_168=1.0;
float l9_169=param_29.x;
int l9_170=param_32.x;
if (l9_170==1)
{
l9_169=fract(l9_169);
}
...
param_29.x=l9_169;
float l9_174=param_29.y;
int l9_175=param_32.y;
if (l9_175==1)
{
l9_174=fract(l9_174);
}
...
float l9_182=param_34.x;
float l9_183=param_34.z;
bool l9_184=l9_180;
float l9_185=l9_168;
...
float l9_191=param_34.y;
float l9_192=param_34.w;
bool l9_193=l9_189;
float l9_194=l9_168;
...
float2 l9_197=param_29;
bool l9_198=param_30;
float3x3 l9_199=param_31;
if (l9_198)
{
...
param_29=l9_200;
float l9_201=param_29.x;
int l9_202=param_32.x;
bool l9_203=l9_167;
float l9_204=l9_168;
...
param_29.x=l9_201;
l9_168=l9_204;
float l9_212=param_29.y;
int l9_213=param_32.y;
bool l9_214=l9_167;
float l9_215=l9_168;
...
param_29.y=l9_212;
l9_168=l9_215;
float2 l9_223=param_29;
int l9_224=param_27;
int l9_225=param_28;
float l9_226=param_37;
...
float4 l9_233=sc_set0.capsule_btn_refl_tex_1.sample(sc_set0.capsule_btn_refl_tex_1SmpSC,l9_232.xy,bias(l9_226));
float4 l9_234=l9_233;
if (param_35)
{
l9_234=mix(param_36,l9_234,float4(l9_168));
}
...
Output_N8=(Export_N55.xy*(*sc_set0.UserUniforms).Port_Input1_N008)+(*sc_set0.UserUniforms).Port_Input2_N008;
float4 Value_N5=float4(0.0);
float param_38=Output_N8.x;
float4 param_39=(*sc_set0.UserUniforms).Port_Value0_N005;
float param_40=(*sc_set0.UserUniforms).Port_Position1_N005;
float4 param_41=(*sc_set0.UserUniforms).Port_Value1_N005;
float param_42=(*sc_set0.UserUniforms).Port_Position2_N005;
float4 param_43=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 param_44=(*sc_set0.UserUniforms).Port_Value3_N005;
param_38=fast::clamp(param_38,0.0,1.0);
float4 param_45;
if (param_38<param_40)
{
param_45=mix(param_39,param_41,float4(fast::clamp(param_38/param_40,0.0,1.0)));
}
else
{
if (param_38<param_42)
{
param_45=mix(param_41,param_43,float4(fast::clamp((param_38-param_40)/(param_42-param_40),0.0,1.0)));
}
else
{
param_45=mix(param_43,param_44,float4(fast::clamp((param_38-param_42)/(1.0-param_42),0.0,1.0)));
}
}
Value_N5=param_45;
float Rim_N64=0.0;
float3 param_46=(*sc_set0.UserUniforms).Port_Normal_N064;
float param_47=(*sc_set0.UserUniforms).Port_Exponent_N064;
float param_48=(*sc_set0.UserUniforms).Port_Intensity_N064;
ssGlobals param_50=Globals;
param_46=float3x3(float3(param_50.VertexTangent_WorldSpace),float3(param_50.VertexBinormal_WorldSpace),float3(param_50.VertexNormal_WorldSpace))*param_46;
float l9_236=abs(dot(-param_50.ViewDirWS,param_46));
float param_49=pow(1.0-l9_236,param_47);
param_49=fast::max(param_49,0.0);
param_49*=param_48;
Rim_N64=param_49;
float4 Output_N65=float4(0.0);
Output_N65=mix(Value_N5,(*sc_set0.UserUniforms).Port_Input1_N065,float4(Rim_N64));
float2 UVCoord_N66=float2(0.0);
UVCoord_N66=Globals.Surface_UVCoord0;
float2 Output_N67=float2(0.0);
Output_N67=(UVCoord_N66*(*sc_set0.UserUniforms).Port_Input1_N067)+(*sc_set0.UserUniforms).Port_Input2_N067;
float Output_N68=0.0;
Output_N68=length(Output_N67);
float4 Value_N69=float4(0.0);
float param_51=Output_N68;
float4 param_52=(*sc_set0.UserUniforms).Port_Value0_N069;
float param_53=(*sc_set0.UserUniforms).Port_Position1_N069;
float4 param_54=(*sc_set0.UserUniforms).Port_Value1_N069;
float param_55=(*sc_set0.UserUniforms).Port_Position2_N069;
float4 param_56=(*sc_set0.UserUniforms).Port_Value2_N069;
float param_57=(*sc_set0.UserUniforms).Port_Position3_N069;
float4 param_58=(*sc_set0.UserUniforms).Port_Value3_N069;
float4 param_59=(*sc_set0.UserUniforms).Port_Value4_N069;
param_51=fast::clamp(param_51,0.0,1.0);
float4 param_60;
if (param_51<param_53)
{
param_60=mix(param_52,param_54,float4(fast::clamp(param_51/param_53,0.0,1.0)));
}
else
{
if (param_51<param_55)
{
param_60=mix(param_54,param_56,float4(fast::clamp((param_51-param_53)/(param_55-param_53),0.0,1.0)));
}
else
{
if (param_51<param_57)
{
param_60=mix(param_56,param_58,float4(fast::clamp((param_51-param_55)/(param_57-param_55),0.0,1.0)));
}
else
{
param_60=mix(param_58,param_59,float4(fast::clamp((param_51-param_57)/(1.0-param_57),0.0,1.0)));
}
}
}
Value_N69=param_60;
...
float Rim_N91=0.0;
float3 param_61=(*sc_set0.UserUniforms).Port_Normal_N091;
float param_62=(*sc_set0.UserUniforms).Port_Exponent_N091;
float param_63=(*sc_set0.UserUniforms).Port_Intensity_N091;
ssGlobals param_65=Globals;
param_61=float3x3(float3(param_65.VertexTangent_WorldSpace),float3(param_65.VertexBinormal_WorldSpace),float3(param_65.VertexNormal_WorldSpace))*param_61;
float l9_237=abs(dot(-param_65.ViewDirWS,param_61));
float param_64=pow(1.0-l9_237,param_62);
param_64=fast::max(param_64,0.0);
param_64*=param_63;
Rim_N91=param_64;
float4 Output_N92=float4(0.0);
Output_N92=mix((*sc_set0.UserUniforms).Port_Input0_N092,(*sc_set0.UserUniforms).Port_Input1_N092,float4(Rim_N91));
...
ValueOut_N76=(((UVCoord_N119-float2((*sc_set0.UserUniforms).Port_RangeMinA_N076))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N076-(*sc_set0.UserUniforms).Port_RangeMinA_N076)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N076-(*sc_set0.UserUniforms).Port_RangeMinB_N076))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N076);
float2 CoordsOut_N90=float2(0.0);
float2 param_66=(*sc_set0.UserUniforms).Port_CoordsIn_N090;
float param_67=(*sc_set0.UserUniforms).Port_Rotation_N090;
float2 param_68=(*sc_set0.UserUniforms).Port_Center_N090;
float l9_238=sin(radians(param_67));
float l9_239=cos(radians(param_67));
float2 param_69=param_66-param_68;
param_69=float2(dot(float2(l9_239,l9_238),param_69),dot(float2(-l9_238,l9_239),param_69))+param_68;
CoordsOut_N90=param_69;
float2 Value_N77=float2(0.0);
Value_N77=CoordsOut_N90;
float2 CoordsOut_N78=float2(0.0);
CoordsOut_N78=((ValueOut_N76-(*sc_set0.UserUniforms).Port_Center_N078)*Value_N77)+(*sc_set0.UserUniforms).Port_Center_N078;
...
Output_N86=fast::clamp(Output_N85+0.001,(*sc_set0.UserUniforms).Port_Input1_N086+0.001,(*sc_set0.UserUniforms).Port_Input2_N086+0.001)-0.001;
float Output_N87=0.0;
Output_N87=smoothstep((*sc_set0.UserUniforms).Port_Input0_N087,(*sc_set0.UserUniforms).Port_Input1_N087,Output_N86);
...
Output_N93=mix(Output_N92,(*sc_set0.UserUniforms).Port_Input1_N093,Export_N89);
...
Output_N28=(UVCoord_N9*(*sc_set0.UserUniforms).Port_Input1_N028)+(*sc_set0.UserUniforms).Port_Input2_N028;
float Output_N29=0.0;
Output_N29=length(Output_N28);
float Value_N16=0.0;
float param_70=Output_N29;
float param_71=(*sc_set0.UserUniforms).Port_Value0_N016;
float param_72=(*sc_set0.UserUniforms).Port_Position1_N016;
float param_73=(*sc_set0.UserUniforms).Port_Value1_N016;
float param_74=(*sc_set0.UserUniforms).Port_Position2_N016;
float param_75=(*sc_set0.UserUniforms).Port_Value2_N016;
float param_76=(*sc_set0.UserUniforms).Port_Position3_N016;
float param_77=(*sc_set0.UserUniforms).Port_Value3_N016;
float param_78=(*sc_set0.UserUniforms).Port_Value4_N016;
param_70=fast::clamp(param_70,0.0,1.0);
float param_79;
if (param_70<param_72)
{
param_79=mix(param_71,param_73,fast::clamp(param_70/param_72,0.0,1.0));
}
else
{
if (param_70<param_74)
{
param_79=mix(param_73,param_75,fast::clamp((param_70-param_72)/(param_74-param_72),0.0,1.0));
}
else
{
if (param_70<param_76)
{
param_79=mix(param_75,param_77,fast::clamp((param_70-param_74)/(param_76-param_74),0.0,1.0));
}
else
{
param_79=mix(param_77,param_78,fast::clamp((param_70-param_76)/(1.0-param_76),0.0,1.0));
}
}
}
Value_N16=param_79;
...
{
float4 l9_240=gl_FragCoord;
float2 l9_241=floor(mod(l9_240.xy,float2(4.0)));
float l9_242=(mod(dot(l9_241,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_80<l9_242)
{
discard_fragment();
}
...
{
l9_246=fast::clamp(l9_245.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_246=fast::clamp(dot(l9_245.xyz,float3(l9_245.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_246=(1.0-dot(l9_245.xyz,float3(0.33333001)))*l9_245.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_246=(1.0-fast::clamp(dot(l9_245.xyz,float3(1.0)),0.0,1.0))*l9_245.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_246=fast::clamp(dot(l9_245.xyz,float3(1.0)),0.0,1.0)*l9_245.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_246=fast::clamp(dot(l9_245.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_246=dot(l9_245.xyz,float3(0.33333001))*l9_245.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_246=1.0-fast::clamp(dot(l9_245.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_247=l9_246;
float l9_248=l9_247;
float l9_249=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_248;
float3 l9_250=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_244.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_251=float4(l9_250.x,l9_250.y,l9_250.z,l9_249);
param_83=l9_251;
}
else
{
...
float2 l9_258=l9_257.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_263=l9_262;
int l9_264=l9_263;
float3 l9_265=float3(l9_259,0.0);
int l9_266=l9_261;
int l9_267=l9_264;
if (l9_266==1)
{
l9_265.y=((2.0*l9_265.y)+float(l9_267))-1.0;
}
float2 l9_268=l9_265.xy;
l9_260=l9_268;
}
else
{
...
int l9_279=l9_274;
float2 l9_280=l9_272;
int l9_281=sc_ScreenTextureLayout_tmp;
int l9_282=l9_279;
float l9_283=l9_273;
...
float4 l9_290=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_289.xy,bias(l9_283));
float4 l9_291=l9_290;
float4 l9_292=l9_291;
l9_254=l9_292;
}
float4 l9_293=l9_254;
float3 l9_294=l9_293.xyz;
float3 l9_295=l9_294;
float3 l9_296=l9_252.xyz;
float3 l9_297=definedBlend(l9_295,l9_296,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_253=float4(l9_297.x,l9_297.y,l9_297.z,l9_253.w);
float3 l9_298=mix(l9_294,l9_253.xyz,float3(l9_252.w));
l9_253=float4(l9_298.x,l9_298.y,l9_298.z,l9_253.w);
l9_253.w=1.0;
float4 l9_299=l9_253;
param_83=l9_299;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_300=float4(in.varScreenPos.xyz,1.0);
param_83=l9_300;
}
else
{
...
float l9_302=fast::clamp(abs(l9_301.z),0.0,1.0);
float4 l9_303=float4(l9_302,1.0-l9_302,1.0,1.0);
param_83=l9_303;
}
else
{
float4 l9_304=param_83;
float4 l9_305=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_305=float4(mix(float3(1.0),l9_304.xyz,float3(l9_304.w)),l9_304.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_306=l9_304.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_306=fast::clamp(l9_306,0.0,1.0);
}
l9_305=float4(l9_304.xyz*l9_306,l9_306);
}
else
{
l9_305=l9_304;
...
float3 param_84=in.varPos;
float4 param_85=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_84,param_85,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_86=FinalColor;
float4 l9_311=param_86;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_311.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_311;
return out;
}
} // FRAGMENT SHADER
