...
//}
//ubo int UserUniforms 0:37:5152 {
//float4 sc_Time 1376
...
//float4 Port_Value0_N016 4848
//float Port_Position1_N016 4864
//float4 Port_Value1_N016 4880
//float Port_Position2_N016 4896
//float4 Port_Value2_N016 4912
//float Port_Position3_N016 4928
//float4 Port_Value3_N016 4944
//float4 Port_Value4_N016 4960
//float4 Port_Input1_N050 4976
//float4 Port_Input0_N048 4992
//float3 Port_Normal_N023 5008
//float Port_Exponent_N023 5024
//float Port_Intensity_N023 5028
//float4 Port_Input0_N020 5040
//float4 Port_Input1_N020 5056
//float2 Port_Scale_N019 5072
//float2 Port_Center_N019 5080
//float Port_Rotation_N035 5088
//float2 Port_Center_N035 5096
//float Port_Value0_N030 5104
//float Port_Position1_N030 5108
//float Port_Value1_N030 5112
//float Port_Position2_N030 5116
//float Port_Value2_N030 5120
//float Port_Position3_N030 5124
//float Port_Value3_N030 5128
//float Port_Value4_N030 5132
//float depthRef 5136
//}
...
float param_38=Export_N55.x;
float4 param_39=(*sc_set0.UserUniforms).Port_Value0_N016;
float param_40=(*sc_set0.UserUniforms).Port_Position1_N016;
float4 param_41=(*sc_set0.UserUniforms).Port_Value1_N016;
float param_42=(*sc_set0.UserUniforms).Port_Position2_N016;
float4 param_43=(*sc_set0.UserUniforms).Port_Value2_N016;
float param_44=(*sc_set0.UserUniforms).Port_Position3_N016;
float4 param_45=(*sc_set0.UserUniforms).Port_Value3_N016;
float4 param_46=(*sc_set0.UserUniforms).Port_Value4_N016;
param_38=fast::clamp(param_38,0.0,1.0);
float4 param_47;
if (param_38<param_40)
{
param_47=mix(param_39,param_41,float4(fast::clamp(param_38/param_40,0.0,1.0)));
}
else
{
if (param_38<param_42)
{
param_47=mix(param_41,param_43,float4(fast::clamp((param_38-param_40)/(param_42-param_40),0.0,1.0)));
}
else
{
if (param_38<param_44)
{
param_47=mix(param_43,param_45,float4(fast::clamp((param_38-param_42)/(param_44-param_42),0.0,1.0)));
}
else
{
param_47=mix(param_45,param_46,float4(fast::clamp((param_38-param_44)/(1.0-param_44),0.0,1.0)));
}
}
}
Value_N16=param_47;
float Rim_N23=0.0;
float3 param_48=(*sc_set0.UserUniforms).Port_Normal_N023;
float param_49=(*sc_set0.UserUniforms).Port_Exponent_N023;
float param_50=(*sc_set0.UserUniforms).Port_Intensity_N023;
ssGlobals param_52=Globals;
param_48=float3x3(float3(param_52.VertexTangent_WorldSpace),float3(param_52.VertexBinormal_WorldSpace),float3(param_52.VertexNormal_WorldSpace))*param_48;
float l9_236=abs(dot(-param_52.ViewDirWS,param_48));
float param_51=pow(1.0-l9_236,param_49);
param_51=fast::max(param_51,0.0);
param_51*=param_50;
Rim_N23=param_51;
float2 UVCoord_N17=float2(0.0);
UVCoord_N17=Globals.Surface_UVCoord0;
float2 CoordsOut_N19=float2(0.0);
CoordsOut_N19=((UVCoord_N17-(*sc_set0.UserUniforms).Port_Center_N019)*(*sc_set0.UserUniforms).Port_Scale_N019)+(*sc_set0.UserUniforms).Port_Center_N019;
...
int l9_242=l9_237;
int param_53=capsule_btn_refl_tex_1Layout_tmp;
int param_54=l9_242;
float2 param_55=CoordsOut_N19;
bool param_56=(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1_tmp)!=0);
float3x3 param_57=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1Transform;
int2 param_58=int2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1_tmp,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1_tmp);
bool param_59=(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_60=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_61=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_62=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_63=0.0;
bool l9_243=param_61&&(!param_59);
float l9_244=1.0;
float l9_245=param_55.x;
int l9_246=param_58.x;
if (l9_246==1)
{
l9_245=fract(l9_245);
}
...
param_55.x=l9_245;
float l9_250=param_55.y;
int l9_251=param_58.y;
if (l9_251==1)
{
l9_250=fract(l9_250);
}
...
float l9_257=param_55.x;
float l9_258=param_60.x;
float l9_259=param_60.z;
bool l9_260=l9_256;
float l9_261=l9_244;
...
float l9_266=param_55.y;
float l9_267=param_60.y;
float l9_268=param_60.w;
bool l9_269=l9_265;
float l9_270=l9_244;
...
float2 l9_273=param_55;
bool l9_274=param_56;
float3x3 l9_275=param_57;
if (l9_274)
{
...
param_55=l9_276;
float l9_277=param_55.x;
int l9_278=param_58.x;
bool l9_279=l9_243;
float l9_280=l9_244;
...
param_55.x=l9_277;
l9_244=l9_280;
float l9_288=param_55.y;
int l9_289=param_58.y;
bool l9_290=l9_243;
float l9_291=l9_244;
...
param_55.y=l9_288;
l9_244=l9_291;
float2 l9_299=param_55;
int l9_300=param_53;
int l9_301=param_54;
float l9_302=param_63;
...
float4 l9_309=sc_set0.capsule_btn_refl_tex_1.sample(sc_set0.capsule_btn_refl_tex_1SmpSC,l9_308.xy,bias(l9_302));
float4 l9_310=l9_309;
if (param_61)
{
l9_310=mix(param_62,l9_310,float4(l9_244));
}
float4 l9_311=l9_310;
Color_N0=l9_311;
float4 Output_N20=float4(0.0);
Output_N20=smoothstep((*sc_set0.UserUniforms).Port_Input0_N020,(*sc_set0.UserUniforms).Port_Input1_N020,Color_N0);
float4 Output_N48=float4(0.0);
Output_N48=mix((*sc_set0.UserUniforms).Port_Input0_N048,float4(Rim_N23),Output_N20);
float4 Output_N50=float4(0.0);
Output_N50=mix(Value_N16,(*sc_set0.UserUniforms).Port_Input1_N050,Output_N48);
float2 CoordsOut_N35=float2(0.0);
float2 param_64=CoordsOut_N19;
float param_65=(*sc_set0.UserUniforms).Port_Rotation_N035;
float2 param_66=(*sc_set0.UserUniforms).Port_Center_N035;
float l9_312=sin(radians(param_65));
float l9_313=cos(radians(param_65));
float2 param_67=param_64-param_66;
param_67=float2(dot(float2(l9_313,l9_312),param_67),dot(float2(-l9_312,l9_313),param_67))+param_66;
CoordsOut_N35=param_67;
float Value_N30=0.0;
float param_68=CoordsOut_N35.x;
float param_69=(*sc_set0.UserUniforms).Port_Value0_N030;
float param_70=(*sc_set0.UserUniforms).Port_Position1_N030;
float param_71=(*sc_set0.UserUniforms).Port_Value1_N030;
float param_72=(*sc_set0.UserUniforms).Port_Position2_N030;
float param_73=(*sc_set0.UserUniforms).Port_Value2_N030;
float param_74=(*sc_set0.UserUniforms).Port_Position3_N030;
float param_75=(*sc_set0.UserUniforms).Port_Value3_N030;
float param_76=(*sc_set0.UserUniforms).Port_Value4_N030;
param_68=fast::clamp(param_68,0.0,1.0);
float param_77;
if (param_68<param_70)
{
param_77=mix(param_69,param_71,fast::clamp(param_68/param_70,0.0,1.0));
}
else
{
if (param_68<param_72)
{
param_77=mix(param_71,param_73,fast::clamp((param_68-param_70)/(param_72-param_70),0.0,1.0));
}
else
{
if (param_68<param_74)
{
param_77=mix(param_73,param_75,fast::clamp((param_68-param_72)/(param_74-param_72),0.0,1.0));
}
else
{
param_77=mix(param_75,param_76,fast::clamp((param_68-param_74)/(1.0-param_74),0.0,1.0));
}
}
}
Value_N30=param_77;
...
float param_78=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_78<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_314=gl_FragCoord;
float2 l9_315=floor(mod(l9_314.xy,float2(4.0)));
float l9_316=(mod(dot(l9_315,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_78<l9_316)
{
discard_fragment();
}
...
float4 l9_317=fast::max(param_79,float4(0.0));
float4 param_80=l9_317;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_80.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_80;
return out;
}
float4 param_81=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_318=param_81;
...
{
l9_320=fast::clamp(l9_319.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_320=fast::clamp(dot(l9_319.xyz,float3(l9_319.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_320=(1.0-dot(l9_319.xyz,float3(0.33333001)))*l9_319.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_320=(1.0-fast::clamp(dot(l9_319.xyz,float3(1.0)),0.0,1.0))*l9_319.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_320=fast::clamp(dot(l9_319.xyz,float3(1.0)),0.0,1.0)*l9_319.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_320=fast::clamp(dot(l9_319.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_320=dot(l9_319.xyz,float3(0.33333001))*l9_319.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_320=1.0-fast::clamp(dot(l9_319.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_321=l9_320;
float l9_322=l9_321;
float l9_323=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_322;
float3 l9_324=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_318.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_325=float4(l9_324.x,l9_324.y,l9_324.z,l9_323);
param_81=l9_325;
}
else
{
...
float4 l9_367=l9_328;
float3 l9_368=l9_367.xyz;
float3 l9_369=l9_368;
float3 l9_370=l9_326.xyz;
...
l9_327=float4(l9_371.x,l9_371.y,l9_371.z,l9_327.w);
float3 l9_372=mix(l9_368,l9_327.xyz,float3(l9_326.w));
l9_327=float4(l9_372.x,l9_372.y,l9_372.z,l9_327.w);
l9_327.w=1.0;
float4 l9_373=l9_327;
param_81=l9_373;
}
else
{
...
float3 param_82=in.varPos;
float4 param_83=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_82,param_83,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_84=FinalColor;
float4 l9_385=param_84;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_385.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_385;
return out;
}
} // FRAGMENT SHADER
