...
class CursorViewModel {
    ...
    setupStateMachine() {
            ...
            transitions: [
                {
                    ...
                    checkOnUpdate: () => {
                        var _a, _b;
                        return (_b = (this.checkVisibleTargetingState() && ((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentInteractable) === null)) !== null && _b !== void 0 ? _b : false;
                    }
                },
                {
                    ...
                    checkOnUpdate: () => {
                        var _a;
                        return this.checkVisibleTargetingState() && ((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentInteractable) !== null;
                    }
                }
            ]
        });
        ...
        this.stateMachine.addState({
            ...
            onUpdate: () => {
                ...
                if (this.isAnimating && ((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentTrigger) !== Interactor_1.InteractorTriggerType.None) {
            ...
            transitions: [
                ...
                },
                {
                    ...
                    checkOnUpdate: () => {
                        var _a;
                        return ((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentTrigger) !== Interactor_1.InteractorTriggerType.None && this.currentManipulation !== null;
                    }
                },
                {
                    ...
                    checkOnUpdate: () => {
                        ...
                        return (((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentTrigger) !== Interactor_1.InteractorTriggerType.None &&
                            this.isScrolling &&
                            ((_c = (_b = this.scrollView) === null || _b === void 0 ? void 0 : _b.isDragging) !== null && _c !== void 0 ? _c : false));
                    }
                }
            ],
            onExit: () => {
                ...
                },
                {
                    ...
                    checkOnUpdate: () => {
                        ...
                        return (!((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentInteractable) ||
                            ...
                            (!this.checkPlanecastWithinScrollView() && ((_b = this.interactor) === null || _b === void 0 ? void 0 : _b.currentTrigger) === Interactor_1.InteractorTriggerType.None));
                    }
                },
                {
                    nextStateName: CursorState.Hovering,
    ...
    shouldCursorHold() {
        ...
        return (this.enableCursorHolding &&
            ((_a = (this.interactor &&
                (this.interactor.inputType & (Interactor_1.InteractorInputType.BothHands | Interactor_1.InteractorInputType.Mouse)) !== 0)) !== null && _a !== void 0 ? _a : false));
    }
    shouldFilter() {
        var _a;
        return (this.enableFilter &&
            ((_a = (this.interactor && (this.interactor.inputType & Interactor_1.InteractorInputType.BothHands) !== 0)) !== null && _a !== void 0 ? _a : false));
    }
    ...
    updateIndirectCursorPosition(interactionStrength, position) {
        ...
        if (position !== null) {
            if (!this.isAnimating) {
                this.cursorDistance = (_c = (_b = (_a = this.interactor) === null || _a === void 0 ? void 0 : _a.startPoint) === null || _b === void 0 ? void 0 : _b.distance(position)) !== null && _c !== void 0 ? _c : this.cursorDistance;
            }
