...
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1857=out.FragColor0;
float4 l9_1858=l9_1857;
l9_1856=l9_1858;
}
else
{
float4 l9_1859=gl_FragCoord;
float2 l9_1860=l9_1859.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_1865=l9_1864;
int l9_1866=l9_1865;
float3 l9_1867=float3(l9_1861,0.0);
int l9_1868=l9_1863;
int l9_1869=l9_1866;
if (l9_1868==1)
{
l9_1867.y=((2.0*l9_1867.y)+float(l9_1869))-1.0;
}
float2 l9_1870=l9_1867.xy;
l9_1862=l9_1870;
}
else
{
...
float2 l9_1871=l9_1862;
float2 l9_1872=l9_1871;
float2 l9_1873=l9_1872;
float2 l9_1874=l9_1873;
float l9_1875=0.0;
int l9_1876;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
...
int l9_1883=sc_ScreenTextureLayout_tmp;
int l9_1884=l9_1881;
...
float4 l9_1892=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_1891.xy,bias(l9_1885));
float4 l9_1893=l9_1892;
float4 l9_1894=l9_1893;
l9_1856=l9_1894;
}
float4 l9_1895=l9_1856;
float3 l9_1896=l9_1895.xyz;
float3 l9_1897=l9_1896;
float3 l9_1898=l9_1854.xyz;
float3 l9_1899=definedBlend(l9_1897,l9_1898,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1855=float4(l9_1899.x,l9_1899.y,l9_1899.z,l9_1855.w);
float3 l9_1900=mix(l9_1896,l9_1855.xyz,float3(l9_1854.w));
l9_1855=float4(l9_1900.x,l9_1900.y,l9_1900.z,l9_1855.w);
l9_1855.w=1.0;
float4 l9_1901=l9_1855;
param_10=l9_1901;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_1902=float4(in.varScreenPos.xyz,1.0);
param_10=l9_1902;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_1903=gl_FragCoord;
float l9_1904=fast::clamp(abs(l9_1903.z),0.0,1.0);
float4 l9_1905=float4(l9_1904,1.0-l9_1904,1.0,1.0);
param_10=l9_1905;
}
else
{
float4 l9_1906=param_10;
float4 l9_1907=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1907=float4(mix(float3(1.0),l9_1906.xyz,float3(l9_1906.w)),l9_1906.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_1908=l9_1906.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_1908=fast::clamp(l9_1908,0.0,1.0);
}
l9_1907=float4(l9_1906.xyz*l9_1908,l9_1908);
}
else
{
l9_1907=l9_1906;
...
float4 l9_1913=param_13;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_1913.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_1913;
return out;
}
} // FRAGMENT SHADER
