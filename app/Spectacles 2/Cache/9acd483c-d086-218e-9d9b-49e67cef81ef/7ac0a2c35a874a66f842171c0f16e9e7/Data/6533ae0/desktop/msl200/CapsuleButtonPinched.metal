...
//}
//ubo int UserUniforms 0:37:5024 {
//float4 sc_Time 1376
...
//float4 Port_Value0_N067 4848
//float Port_Position1_N067 4864
//float4 Port_Value1_N067 4880
//float Port_Position2_N067 4896
//float4 Port_Value2_N067 4912
//float Port_Position3_N067 4928
//float4 Port_Value3_N067 4944
//float4 Port_Value4_N067 4960
//float4 Port_Input1_N034 4976
//float3 Port_Normal_N023 4992
//float Port_Exponent_N023 5008
//float Port_Intensity_N023 5012
//float depthRef 5016
//}
...
float4 param_39=(*sc_set0.UserUniforms).Port_Value0_N067;
float param_40=(*sc_set0.UserUniforms).Port_Position1_N067;
float4 param_41=(*sc_set0.UserUniforms).Port_Value1_N067;
float param_42=(*sc_set0.UserUniforms).Port_Position2_N067;
float4 param_43=(*sc_set0.UserUniforms).Port_Value2_N067;
float param_44=(*sc_set0.UserUniforms).Port_Position3_N067;
float4 param_45=(*sc_set0.UserUniforms).Port_Value3_N067;
float4 param_46=(*sc_set0.UserUniforms).Port_Value4_N067;
...
Output_N34=mix(Value_N67,(*sc_set0.UserUniforms).Port_Input1_N034,float4(Rim_N23));
...
float4 l9_240=fast::max(param_54,float4(0.0));
float4 param_55=l9_240;
if (sc_ShaderCacheConstant_tmp!=0)
{
