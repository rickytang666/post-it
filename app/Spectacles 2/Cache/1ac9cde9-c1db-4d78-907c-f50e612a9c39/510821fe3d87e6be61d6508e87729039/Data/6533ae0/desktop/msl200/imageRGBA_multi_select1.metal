...
float2 l9_1977=l9_1976.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_1982=l9_1981;
int l9_1983=l9_1982;
float3 l9_1984=float3(l9_1978,0.0);
int l9_1985=l9_1980;
int l9_1986=l9_1983;
if (l9_1985==1)
{
l9_1984.y=((2.0*l9_1984.y)+float(l9_1986))-1.0;
}
float2 l9_1987=l9_1984.xy;
l9_1979=l9_1987;
}
else
{
...
{
l9_1996=in.varStereoViewID;
}
int l9_1997=l9_1996;
l9_1993=l9_1997;
}
int l9_1998=l9_1993;
float2 l9_1999=l9_1991;
int l9_2000=sc_ScreenTextureLayout_tmp;
int l9_2001=l9_1998;
float l9_2002=l9_1992;
...
float4 l9_2009=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_2008.xy,bias(l9_2002));
float4 l9_2010=l9_2009;
float4 l9_2011=l9_2010;
l9_1973=l9_2011;
}
float4 l9_2012=l9_1973;
float3 l9_2013=l9_2012.xyz;
float3 l9_2014=l9_2013;
float3 l9_2015=l9_1971.xyz;
float3 l9_2016=definedBlend(l9_2014,l9_2015,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1972=float4(l9_2016.x,l9_2016.y,l9_2016.z,l9_1972.w);
float3 l9_2017=mix(l9_2013,l9_1972.xyz,float3(l9_1971.w));
l9_1972=float4(l9_2017.x,l9_2017.y,l9_2017.z,l9_1972.w);
l9_1972.w=1.0;
float4 l9_2018=l9_1972;
param_9=l9_2018;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_2019=float4(in.varScreenPos.xyz,1.0);
param_9=l9_2019;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_2020=gl_FragCoord;
float l9_2021=fast::clamp(abs(l9_2020.z),0.0,1.0);
float4 l9_2022=float4(l9_2021,1.0-l9_2021,1.0,1.0);
param_9=l9_2022;
}
else
{
float4 l9_2023=param_9;
float4 l9_2024=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2024=float4(mix(float3(1.0),l9_2023.xyz,float3(l9_2023.w)),l9_2023.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2025=l9_2023.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2025=fast::clamp(l9_2025,0.0,1.0);
}
l9_2024=float4(l9_2023.xyz*l9_2025,l9_2025);
}
else
{
l9_2024=l9_2023;
...
float4 l9_2030=param_12;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_2030.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_2030;
return out;
}
} // FRAGMENT SHADER
