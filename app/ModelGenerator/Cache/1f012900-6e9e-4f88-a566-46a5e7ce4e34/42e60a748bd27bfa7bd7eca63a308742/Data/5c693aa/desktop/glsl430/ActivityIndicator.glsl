...
float l9_11=radians((((l9_8-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*((Port_Input0_N067*((((in_out-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+Port_RangeMinB_N035))-Port_RangeMinB_N050))+Port_RangeMinB_N050);
...
float l9_27=Port_Input0_N057*in_out;
vec3 l9_28=(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3((((l9_8-Port_RangeMinA_N025)/((Port_RangeMaxA_N025-Port_RangeMinA_N025)+1e-06))*((Port_Input0_N058*in_out)-l9_27))+l9_27);
vec3 l9_29;
vec3 l9_30;
vec3 l9_31;
if (l9_5)
...
vec2 l9_13=(varTex01.xy*vec2(in_out))+vec2(l9_1*((((l9_12-Port_RangeMinA_N046)/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046));
