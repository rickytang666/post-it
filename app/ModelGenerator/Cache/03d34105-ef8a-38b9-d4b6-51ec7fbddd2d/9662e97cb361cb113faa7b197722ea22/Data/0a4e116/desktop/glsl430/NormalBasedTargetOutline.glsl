...
varColor=color;
vec3 l9_6=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
vec3 l9_7=varNormal;
float l9_8=float(l9_0);
ssGlobals l9_9=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_6,l9_7,normalize((sc_ModelMatrixInverse*vec4(l9_7,0.0)).xyz),l9_8);
vec3 param_3;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_3,l9_9);
vec3 l9_10=param_3;
...
float l9_14;
if ((float(l9_8>Port_Input1_N013)*1.0)!=0.0)
{
l9_14=abs(lineWeight)*Port_Input1_N017;
}
else
{
l9_14=abs(lineWeight);
}
vec3 l9_15=vec3(l9_14);
vec3 param_8;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_8,l9_9);
vec3 l9_16=param_8;
vec3 l9_17;
vec3 l9_18;
vec3 l9_19;
...
l9_19=varTangent.xyz;
l9_18=l9_16;
l9_17=(sc_ModelMatrix*vec4(l9_6+(l9_13*l9_15),1.0)).xyz;
}
varPos=l9_17;
varNormal=normalize(l9_18);
vec3 l9_20=normalize(l9_19);
...
#if (sc_RenderingSpace==3)
{
l9_21=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_22;
#if (sc_RenderingSpace==2)
{
l9_22=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_23;
#if (sc_RenderingSpace==1)
{
l9_23=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_23=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_25=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_26;
#if (sc_RenderingSpace==2)
{
l9_26=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_27;
#if (sc_RenderingSpace==1)
{
l9_27=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_27=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_28=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_28=l9_1.position;
...
#endif
vec4 l9_29=sc_ProjectorMatrix*l9_28;
varShadowTex=((l9_29.xy/vec2(l9_29.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_30;
...
{
vec4 l9_32=l9_24;
l9_32.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_24.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_24.w;
l9_31=l9_32;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_34=l9_30.xy+(sc_TAAJitterOffset*l9_30.w);
l9_33=vec4(l9_34.x,l9_34.y,l9_30.z,l9_30.w);
}
#else
{
l9_33=l9_30;
...
#endif
sc_SetClipPosition(l9_33);
#if (sc_Voxelization)
{
sc_Vertex_t l9_35=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
sc_BlendVertex(l9_35);
sc_SkinVertex(l9_35);
int l9_36=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_37=int(voxelization_params_0.w);
vec4 l9_38=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_35.position).xyz+vec3(float(l9_36%l9_37)*voxelization_params_0.y,float(l9_36/l9_37)*voxelization_params_0.y,(float(l9_36)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_38.w=1.0;
varScreenPos=l9_38;
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_39=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
sc_BlendVertex(l9_39);
sc_SkinVertex(l9_39);
vec2 l9_40=((l9_39.position.xy/vec2(l9_39.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_40.x,l9_40.y,varPackedTex.z,varPackedTex.w);
vec4 l9_41=sc_ModelMatrixVoxelization*l9_39.position;
vec3 l9_42=l9_41.xyz-voxelization_params_camera_pos;
varPos=l9_42.xyz;
varNormal=normalize(l9_39.normal);
vec4 l9_43=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_42.x,l9_42.y,l9_42.z,l9_41.w);
