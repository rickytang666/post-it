...
#endif
uvec3 l9_489=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
vec4 l9_544=sc_OutputMotionVectorIfNeeded(max(l9_542,vec4(0.0)));
