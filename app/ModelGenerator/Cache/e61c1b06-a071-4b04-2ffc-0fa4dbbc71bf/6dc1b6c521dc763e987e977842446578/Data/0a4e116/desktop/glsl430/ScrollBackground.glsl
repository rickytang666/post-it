...
in vec4 varColor;
vec3 sc_RayTracingInterpolateAnimatedFloat3(vec3 brc,uvec3 indices,uint offset_1)
{
uvec3 l9_0=(indices*uvec3(6u))+uvec3(offset_1);
uint l9_1=l9_0.x;
uint l9_2=l9_0.y;
uint l9_3=l9_0.z;
...
vec4 sc_RayTracingFetchUnorm4(uint offset_1)
{
uint l9_0=floatBitsToUint(sc_RayTracingCasterVertexBuffer_obj.sc_RayTracingCasterVertices[offset_1]);
...
l9_2=(sc_ModelMatrixInverse*vec4(l9_3.positionWS,1.0)).xyz;
}
else
{
l9_2=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
}
vec4 l9_4;
bool l9_5;
vec4 l9_6;
if ((status*1.0)!=0.0)
{
float l9_7=(((size-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*(Port_RangeMaxB_N050-Port_RangeMinB_N050))+Port_RangeMinB_N050;
float l9_8=clamp(((((vec2(l9_2.y*Port_Input1_N049)+vec2((((offset-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(((((size-Port_RangeMinA_N048)/((Port_RangeMaxA_N048-Port_RangeMinA_N048)+1e-06))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048)-l9_7))+l9_7,0.0))-Port_Center_N039)*vec2((((scale-Port_RangeMinA_N046)/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046))+Port_Center_N039).x,0.0,1.0);
vec4 l9_9;
if (l9_8<Port_Position1_N040)
{
l9_9=mix(Port_Value0_N040,Port_Value1_N040,vec4(clamp(l9_8/Port_Position1_N040,0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_8<Port_Position2_N040)
{
l9_10=mix(Port_Value1_N040,Port_Value2_N040,vec4(clamp((l9_8-Port_Position1_N040)/(Port_Position2_N040-Port_Position1_N040),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_8<Port_Position3_N040)
{
l9_11=mix(Port_Value2_N040,Port_Value3_N040,vec4(clamp((l9_8-Port_Position2_N040)/(Port_Position3_N040-Port_Position2_N040),0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_8<Port_Position4_N040)
{
l9_12=mix(Port_Value3_N040,Port_Value4_N040,vec4(clamp((l9_8-Port_Position3_N040)/(Port_Position4_N040-Port_Position3_N040),0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_8<Port_Position5_N040)
{
l9_13=mix(Port_Value4_N040,Port_Value5_N040,vec4(clamp((l9_8-Port_Position4_N040)/(Port_Position5_N040-Port_Position4_N040),0.0,1.0)));
}
else
{
l9_13=mix(Port_Value5_N040,Port_Value6_N040,vec4(clamp((l9_8-Port_Position5_N040)/(1.0-Port_Position5_N040),0.0,1.0)));
}
l9_12=l9_13;
}
l9_11=l9_12;
...
#endif
sc_writeFragData0Internal(max(l9_19,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_21;
...
{
l9_23=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_28;
...
#if (sc_BlendMode_Add)
{
l9_29=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_32;
#if (sc_BlendMode_Min)
{
l9_32=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_Max)
{
l9_33=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_33=1.0;
...
#endif
l9_21=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_22);
}
#else
{
vec4 l9_34;
...
#if (sc_FramebufferFetch)
{
l9_36=sc_readFragData0_Platform();
}
#else
{
...
#endif
vec3 l9_39=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
vec4 l9_49=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_47,vec4(0.0)));
