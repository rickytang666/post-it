...
vec4 l9_55;
if (l9_54<Port_Position1_N005)
{
l9_55=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_54/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_56;
if (l9_54<Port_Position2_N005)
{
l9_56=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_54-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_56=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_54-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_55=l9_56;
}
