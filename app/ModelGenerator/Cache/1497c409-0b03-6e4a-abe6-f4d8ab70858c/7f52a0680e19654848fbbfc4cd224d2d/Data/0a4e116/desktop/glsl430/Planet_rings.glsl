...
float l9_4=radians(Port_Rotation_N001);
vec2 l9_5=l9_2-Port_Center_N001;
vec2 l9_6=vec2(dot(vec2(cos(l9_4),sin(l9_4)),l9_5),0.0)+Port_Center_N001;
float l9_7=l9_6.x;
float l9_8=clamp(l9_7,0.0,1.0);
vec4 l9_9;
if (l9_8<Port_Position1_N000)
{
l9_9=mix(Port_Value0_N000,Port_Value1_N000,vec4(clamp(l9_8/Port_Position1_N000,0.0,1.0)));
}
else
{
vec4 l9_10;
if (l9_8<Port_Position2_N000)
{
l9_10=mix(Port_Value1_N000,Port_Value2_N000,vec4(clamp((l9_8-Port_Position1_N000)/(Port_Position2_N000-Port_Position1_N000),0.0,1.0)));
}
else
{
vec4 l9_11;
if (l9_8<Port_Position3_N000)
{
l9_11=mix(Port_Value2_N000,Port_Value3_N000,vec4(clamp((l9_8-Port_Position2_N000)/(Port_Position3_N000-Port_Position2_N000),0.0,1.0)));
}
else
{
vec4 l9_12;
if (l9_8<Port_Position4_N000)
{
l9_12=mix(Port_Value3_N000,Port_Value4_N000,vec4(clamp((l9_8-Port_Position3_N000)/(Port_Position4_N000-Port_Position3_N000),0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_8<Port_Position5_N000)
{
l9_13=mix(Port_Value4_N000,Port_Value5_N000,vec4(clamp((l9_8-Port_Position4_N000)/(Port_Position5_N000-Port_Position4_N000),0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_8<Port_Position6_N000)
{
l9_14=mix(Port_Value5_N000,Port_Value6_N000,vec4(clamp((l9_8-Port_Position5_N000)/(Port_Position6_N000-Port_Position5_N000),0.0,1.0)));
}
else
{
l9_14=mix(Port_Value6_N000,Port_Value7_N000,vec4(clamp((l9_8-Port_Position6_N000)/(1.0-Port_Position6_N000),0.0,1.0)));
}
l9_13=l9_14;
}
l9_12=l9_13;
...
float l9_20=fract(l9_7);
float l9_21;
if (l9_20<Port_Position1_N002)
{
l9_21=mix(Port_Value0_N002,Port_Value1_N002,clamp(l9_20/Port_Position1_N002,0.0,1.0));
}
else
{
float l9_22;
if (l9_20<Port_Position2_N002)
{
l9_22=mix(Port_Value1_N002,Port_Value2_N002,clamp((l9_20-Port_Position1_N002)/(Port_Position2_N002-Port_Position1_N002),0.0,1.0));
}
else
{
float l9_23;
if (l9_20<Port_Position3_N002)
{
l9_23=mix(Port_Value2_N002,Port_Value3_N002,clamp((l9_20-Port_Position2_N002)/(Port_Position3_N002-Port_Position2_N002),0.0,1.0));
}
else
{
float l9_24;
if (l9_20<Port_Position4_N002)
{
l9_24=mix(Port_Value3_N002,Port_Value4_N002,clamp((l9_20-Port_Position3_N002)/(Port_Position4_N002-Port_Position3_N002),0.0,1.0));
}
else
{
float l9_25;
if (l9_20<Port_Position5_N002)
{
l9_25=mix(Port_Value4_N002,Port_Value5_N002,clamp((l9_20-Port_Position4_N002)/(Port_Position5_N002-Port_Position4_N002),0.0,1.0));
}
else
{
float l9_26;
if (l9_20<Port_Position6_N002)
{
l9_26=mix(Port_Value5_N002,Port_Value6_N002,clamp((l9_20-Port_Position5_N002)/(Port_Position6_N002-Port_Position5_N002),0.0,1.0));
}
else
{
float l9_27;
if (l9_20<Port_Position7_N002)
{
l9_27=mix(Port_Value6_N002,Port_Value7_N002,clamp((l9_20-Port_Position6_N002)/(Port_Position7_N002-Port_Position6_N002),0.0,1.0));
}
else
{
float l9_28;
if (l9_20<Port_Position8_N002)
{
l9_28=mix(Port_Value7_N002,Port_Value8_N002,clamp((l9_20-Port_Position7_N002)/(Port_Position8_N002-Port_Position7_N002),0.0,1.0));
}
else
{
float l9_29;
if (l9_20<Port_Position9_N002)
{
l9_29=mix(Port_Value8_N002,Port_Value9_N002,clamp((l9_20-Port_Position8_N002)/(Port_Position9_N002-Port_Position8_N002),0.0,1.0));
}
else
{
float l9_30;
if (l9_20<Port_Position10_N002)
{
l9_30=mix(Port_Value9_N002,Port_Value10_N002,clamp((l9_20-Port_Position9_N002)/(Port_Position10_N002-Port_Position9_N002),0.0,1.0));
}
else
{
float l9_31;
if (l9_20<Port_Position11_N002)
{
l9_31=mix(Port_Value10_N002,Port_Value11_N002,clamp((l9_20-Port_Position10_N002)/(Port_Position11_N002-Port_Position10_N002),0.0,1.0));
}
else
{
float l9_32;
if (l9_20<Port_Position12_N002)
{
l9_32=mix(Port_Value11_N002,Port_Value12_N002,clamp((l9_20-Port_Position11_N002)/(Port_Position12_N002-Port_Position11_N002),0.0,1.0));
}
else
{
float l9_33;
if (l9_20<Port_Position13_N002)
{
l9_33=mix(Port_Value12_N002,Port_Value13_N002,clamp((l9_20-Port_Position12_N002)/(Port_Position13_N002-Port_Position12_N002),0.0,1.0));
}
else
{
float l9_34;
if (l9_20<Port_Position14_N002)
{
l9_34=mix(Port_Value13_N002,Port_Value14_N002,clamp((l9_20-Port_Position13_N002)/(Port_Position14_N002-Port_Position13_N002),0.0,1.0));
}
else
{
l9_34=mix(Port_Value14_N002,Port_Value15_N002,clamp((l9_20-Port_Position14_N002)/(1.0-Port_Position14_N002),0.0,1.0));
}
l9_33=l9_34;
}
l9_32=l9_33;
...
bool l9_36;
vec4 l9_37;
if (l9_35&&(2==PreviewNodeID))
{
vec4 l9_38=vec4(l9_21,l9_21,l9_21,1.0);
l9_38.w=1.0;
l9_37=l9_38;
l9_36=true;
}
...
vec4 l9_39=vec4(l9_9.x,l9_9.y,l9_9.z,vec4(0.0).w);
l9_39.w=l9_21;
...
#endif
sc_writeFragData0Internal(max(l9_40,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_42;
...
{
l9_45=clamp(dot(l9_39.xyz,vec3(l9_21)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*l9_21;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*l9_21;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_50;
#if (sc_BlendMode_Add)
{
l9_50=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_39.xyz,vec3(0.33333001))*l9_21;
}
#else
{
float l9_53;
#if (sc_BlendMode_Min)
{
l9_53=1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_54;
#if (sc_BlendMode_Max)
{
l9_54=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_54=1.0;
...
#endif
l9_42=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_39.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_43);
}
#else
{
vec4 l9_55;
...
#if (sc_FramebufferFetch)
{
l9_57=sc_readFragData0_Platform();
}
#else
{
...
{
l9_59=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_59=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_57=l9_59;
}
#endif
vec3 l9_60=mix(l9_57.xyz,definedBlend(l9_57.xyz,l9_39.xyz).xyz,vec3(l9_21));
...
#if (sc_Voxelization)
{
l9_62=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_63;
#if (sc_OutputBounds)
{
float l9_64=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_63=vec4(l9_64,1.0-l9_64,1.0,1.0);
}
#else
{
vec4 l9_65;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_21)),l9_21);
}
#else
{
vec4 l9_66;
...
vec4 l9_70=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_68,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_72-0.0039215689)),min(1.0,l9_72+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_74),packValue(l9_74),packValue(l9_74),packValue(l9_74)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_116,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
