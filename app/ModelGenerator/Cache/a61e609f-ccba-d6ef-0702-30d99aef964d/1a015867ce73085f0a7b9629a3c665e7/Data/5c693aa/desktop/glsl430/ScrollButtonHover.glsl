...
float l9_173=clamp(((l9_172.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_174;
if (l9_173<Port_Position1_N005)
{
l9_174=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_173/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_173<Port_Position2_N005)
{
l9_175=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_173-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_175=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_173-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_174=l9_175;
}
vec3 l9_176=-l9_5;
vec4 l9_177=mix(l9_174,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_176,l9_12*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec2 l9_178=l9_4*Port_Input1_N067;
float l9_179=clamp(length(l9_178+Port_Input2_N067),0.0,1.0);
vec4 l9_180;
if (l9_179<Port_Position1_N069)
{
l9_180=mix(Port_Value0_N069,Port_Value1_N069,vec4(clamp(l9_179/Port_Position1_N069,0.0,1.0)));
}
else
{
vec4 l9_181;
if (l9_179<Port_Position2_N069)
{
l9_181=mix(Port_Value1_N069,Port_Value2_N069,vec4(clamp((l9_179-Port_Position1_N069)/(Port_Position2_N069-Port_Position1_N069),0.0,1.0)));
}
else
{
vec4 l9_182;
if (l9_179<Port_Position3_N069)
{
l9_182=mix(Port_Value2_N069,Port_Value3_N069,vec4(clamp((l9_179-Port_Position2_N069)/(Port_Position3_N069-Port_Position2_N069),0.0,1.0)));
}
else
{
l9_182=mix(Port_Value3_N069,Port_Value4_N069,vec4(clamp((l9_179-Port_Position3_N069)/(1.0-Port_Position3_N069),0.0,1.0)));
}
l9_181=l9_182;
}
l9_180=l9_181;
}
vec4 l9_183=l9_177+l9_180;
vec2 l9_184=l9_4-vec2(Port_RangeMinA_N076);
float l9_185=radians(Port_Rotation_N090);
float l9_186=sin(l9_185);
float l9_187=cos(l9_185);
vec2 l9_188=Port_CoordsIn_N090-Port_Center_N090;
vec2 l9_189=Port_Import_N081-Port_Import_N079;
vec4 l9_190=l9_183+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_176,l9_12*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot(((((((l9_184/vec2((Port_RangeMaxA_N076-Port_RangeMinA_N076)+1e-06))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_187,l9_186),l9_188),dot(vec2(-l9_186,l9_187),l9_188))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_189)/dot(l9_189,l9_189))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
vec2 l9_191=l9_4*Port_Input1_N028;
float l9_192=clamp(length(l9_191+Port_Input2_N028),0.0,1.0);
float l9_193;
if (l9_192<Port_Position1_N016)
{
l9_193=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_192/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_194;
if (l9_192<Port_Position2_N016)
{
l9_194=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_192-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_195;
if (l9_192<Port_Position3_N016)
{
l9_195=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_192-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_195=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_192-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_194=l9_195;
}
l9_193=l9_194;
}
vec4 l9_196=vec4(l9_190.x,l9_190.y,l9_190.z,vec4(0.0).w);
l9_196.w=l9_193;
vec4 l9_197=l9_117+l9_196;
float l9_198=l9_197.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_198<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_198<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_199,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_201;
...
{
l9_203=clamp(l9_198*2.0,0.0,1.0);
}
#else
{
float l9_204;
...
{
l9_204=clamp(dot(l9_197.xyz,vec3(l9_198)),0.0,1.0);
}
#else
{
float l9_205;
...
{
l9_206=(1.0-dot(l9_197.xyz,vec3(0.33333001)))*l9_198;
}
#else
{
float l9_207;
...
{
l9_207=(1.0-clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0))*l9_198;
}
#else
{
float l9_208;
...
{
l9_208=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0)*l9_198;
}
#else
{
float l9_209;
#if (sc_BlendMode_Add)
{
l9_209=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_210;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_210=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0)*l9_198;
}
#else
{
float l9_211;
...
{
l9_211=dot(l9_197.xyz,vec3(0.33333001))*l9_198;
}
#else
{
float l9_212;
#if (sc_BlendMode_Min)
{
l9_212=1.0-clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_213;
#if (sc_BlendMode_Max)
{
l9_213=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_213=1.0;
...
#endif
l9_201=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_197.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_202);
}
#else
{
vec4 l9_214;
...
#if (sc_FramebufferFetch)
{
l9_216=sc_readFragData0_Platform();
}
#else
{
...
{
l9_218=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_217,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_218=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_217,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_216=l9_218;
}
#endif
vec3 l9_219=mix(l9_216.xyz,definedBlend(l9_216.xyz,l9_197.xyz).xyz,vec3(l9_198));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_224=vec4(mix(vec3(1.0),l9_197.xyz,vec3(l9_198)),l9_198);
}
#else
{
vec4 l9_225;
...
#endif
l9_225=vec4(l9_197.xyz*l9_226,l9_226);
}
#else
{
l9_225=l9_197;
...
vec4 l9_229=sc_OutputMotionVectorIfNeeded(max(l9_227,vec4(0.0)));
...
#endif
int l9_233=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_232).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_245).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_250==0)
{
l9_253=texture(sc_OITAlpha0,l9_245);
l9_252=texture(sc_OITDepthLow0,l9_245);
l9_251=texture(sc_OITDepthHigh0,l9_245);
}
else
{
l9_253=vec4(0.0);
...
if (l9_250==1)
{
l9_256=texture(sc_OITAlpha1,l9_245);
l9_255=texture(sc_OITDepthLow1,l9_245);
l9_254=texture(sc_OITDepthHigh1,l9_245);
}
else
{
l9_256=l9_253;
...
vec4 l9_271=texture(sc_OITFilteredDepthBoundsTexture,l9_245);
