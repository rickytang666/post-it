...
bool l9_14;
vec4 l9_15;
if ((float(l9_6.y<Port_Input1_N010)*1.0)!=0.0)
{
float l9_16=radians(Port_Rotation_N012);
vec2 l9_17=l9_6-Port_Center_N012;
float l9_18=fract((vec2(dot(vec2(cos(l9_16),sin(l9_16)),l9_17),0.0)+Port_Center_N012).x);
vec4 l9_19;
if (l9_18<Port_Position1_N005)
{
l9_19=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_18/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_20;
if (l9_18<Port_Position2_N005)
{
l9_20=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_18-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
vec4 l9_21;
if (l9_18<Port_Position3_N005)
{
l9_21=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_18-Port_Position2_N005)/(Port_Position3_N005-Port_Position2_N005),0.0,1.0)));
}
else
{
vec4 l9_22;
if (l9_18<Port_Position4_N005)
{
l9_22=mix(Port_Value3_N005,Port_Value4_N005,vec4(clamp((l9_18-Port_Position3_N005)/(Port_Position4_N005-Port_Position3_N005),0.0,1.0)));
}
else
{
vec4 l9_23;
if (l9_18<Port_Position5_N005)
{
l9_23=mix(Port_Value4_N005,Port_Value5_N005,vec4(clamp((l9_18-Port_Position4_N005)/(Port_Position5_N005-Port_Position4_N005),0.0,1.0)));
}
else
{
vec4 l9_24;
if (l9_18<Port_Position6_N005)
{
l9_24=mix(Port_Value5_N005,Port_Value6_N005,vec4(clamp((l9_18-Port_Position5_N005)/(Port_Position6_N005-Port_Position5_N005),0.0,1.0)));
}
else
{
vec4 l9_25;
if (l9_18<Port_Position7_N005)
{
l9_25=mix(Port_Value6_N005,Port_Value7_N005,vec4(clamp((l9_18-Port_Position6_N005)/(Port_Position7_N005-Port_Position6_N005),0.0,1.0)));
}
else
{
vec4 l9_26;
if (l9_18<Port_Position8_N005)
{
l9_26=mix(Port_Value7_N005,Port_Value8_N005,vec4(clamp((l9_18-Port_Position7_N005)/(Port_Position8_N005-Port_Position7_N005),0.0,1.0)));
}
else
{
vec4 l9_27;
if (l9_18<Port_Position9_N005)
{
l9_27=mix(Port_Value8_N005,Port_Value9_N005,vec4(clamp((l9_18-Port_Position8_N005)/(Port_Position9_N005-Port_Position8_N005),0.0,1.0)));
}
else
{
vec4 l9_28;
if (l9_18<Port_Position10_N005)
{
l9_28=mix(Port_Value9_N005,Port_Value10_N005,vec4(clamp((l9_18-Port_Position9_N005)/(Port_Position10_N005-Port_Position9_N005),0.0,1.0)));
}
else
{
vec4 l9_29;
if (l9_18<Port_Position11_N005)
{
l9_29=mix(Port_Value10_N005,Port_Value11_N005,vec4(clamp((l9_18-Port_Position10_N005)/(Port_Position11_N005-Port_Position10_N005),0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_18<Port_Position12_N005)
{
l9_30=mix(Port_Value11_N005,Port_Value12_N005,vec4(clamp((l9_18-Port_Position11_N005)/(Port_Position12_N005-Port_Position11_N005),0.0,1.0)));
}
else
{
vec4 l9_31;
if (l9_18<Port_Position13_N005)
{
l9_31=mix(Port_Value12_N005,Port_Value13_N005,vec4(clamp((l9_18-Port_Position12_N005)/(Port_Position13_N005-Port_Position12_N005),0.0,1.0)));
}
else
{
vec4 l9_32;
if (l9_18<Port_Position14_N005)
{
l9_32=mix(Port_Value13_N005,Port_Value14_N005,vec4(clamp((l9_18-Port_Position13_N005)/(Port_Position14_N005-Port_Position13_N005),0.0,1.0)));
}
else
{
l9_32=mix(Port_Value14_N005,Port_Value15_N005,vec4(clamp((l9_18-Port_Position14_N005)/(1.0-Port_Position14_N005),0.0,1.0)));
}
l9_31=l9_32;
}
l9_30=l9_31;
...
{
float l9_38=radians(Port_Rotation_N002);
vec2 l9_39=l9_6-Port_Center_N002;
float l9_40=fract((vec2(dot(vec2(cos(l9_38),sin(l9_38)),l9_39),0.0)+Port_Center_N002).x);
vec4 l9_41;
if (l9_40<Port_Position1_N019)
{
l9_41=mix(Port_Value0_N019,Port_Value1_N019,vec4(clamp(l9_40/Port_Position1_N019,0.0,1.0)));
}
else
{
vec4 l9_42;
if (l9_40<Port_Position2_N019)
{
l9_42=mix(Port_Value1_N019,Port_Value2_N019,vec4(clamp((l9_40-Port_Position1_N019)/(Port_Position2_N019-Port_Position1_N019),0.0,1.0)));
}
else
{
vec4 l9_43;
if (l9_40<Port_Position3_N019)
{
l9_43=mix(Port_Value2_N019,Port_Value3_N019,vec4(clamp((l9_40-Port_Position2_N019)/(Port_Position3_N019-Port_Position2_N019),0.0,1.0)));
}
else
{
vec4 l9_44;
if (l9_40<Port_Position4_N019)
{
l9_44=mix(Port_Value3_N019,Port_Value4_N019,vec4(clamp((l9_40-Port_Position3_N019)/(Port_Position4_N019-Port_Position3_N019),0.0,1.0)));
}
else
{
vec4 l9_45;
if (l9_40<Port_Position5_N019)
{
l9_45=mix(Port_Value4_N019,Port_Value5_N019,vec4(clamp((l9_40-Port_Position4_N019)/(Port_Position5_N019-Port_Position4_N019),0.0,1.0)));
}
else
{
vec4 l9_46;
if (l9_40<Port_Position6_N019)
{
l9_46=mix(Port_Value5_N019,Port_Value6_N019,vec4(clamp((l9_40-Port_Position5_N019)/(Port_Position6_N019-Port_Position5_N019),0.0,1.0)));
}
else
{
vec4 l9_47;
if (l9_40<Port_Position7_N019)
{
l9_47=mix(Port_Value6_N019,Port_Value7_N019,vec4(clamp((l9_40-Port_Position6_N019)/(Port_Position7_N019-Port_Position6_N019),0.0,1.0)));
}
else
{
vec4 l9_48;
if (l9_40<Port_Position8_N019)
{
l9_48=mix(Port_Value7_N019,Port_Value8_N019,vec4(clamp((l9_40-Port_Position7_N019)/(Port_Position8_N019-Port_Position7_N019),0.0,1.0)));
}
else
{
vec4 l9_49;
if (l9_40<Port_Position9_N019)
{
l9_49=mix(Port_Value8_N019,Port_Value9_N019,vec4(clamp((l9_40-Port_Position8_N019)/(Port_Position9_N019-Port_Position8_N019),0.0,1.0)));
}
else
{
vec4 l9_50;
if (l9_40<Port_Position10_N019)
{
l9_50=mix(Port_Value9_N019,Port_Value10_N019,vec4(clamp((l9_40-Port_Position9_N019)/(Port_Position10_N019-Port_Position9_N019),0.0,1.0)));
}
else
{
vec4 l9_51;
if (l9_40<Port_Position11_N019)
{
l9_51=mix(Port_Value10_N019,Port_Value11_N019,vec4(clamp((l9_40-Port_Position10_N019)/(Port_Position11_N019-Port_Position10_N019),0.0,1.0)));
}
else
{
vec4 l9_52;
if (l9_40<Port_Position12_N019)
{
l9_52=mix(Port_Value11_N019,Port_Value12_N019,vec4(clamp((l9_40-Port_Position11_N019)/(Port_Position12_N019-Port_Position11_N019),0.0,1.0)));
}
else
{
vec4 l9_53;
if (l9_40<Port_Position13_N019)
{
l9_53=mix(Port_Value12_N019,Port_Value13_N019,vec4(clamp((l9_40-Port_Position12_N019)/(Port_Position13_N019-Port_Position12_N019),0.0,1.0)));
}
else
{
vec4 l9_54;
if (l9_40<Port_Position14_N019)
{
l9_54=mix(Port_Value13_N019,Port_Value14_N019,vec4(clamp((l9_40-Port_Position13_N019)/(Port_Position14_N019-Port_Position13_N019),0.0,1.0)));
}
else
{
l9_54=mix(Port_Value14_N019,Port_Value15_N019,vec4(clamp((l9_40-Port_Position14_N019)/(1.0-Port_Position14_N019),0.0,1.0)));
}
l9_53=l9_54;
}
l9_52=l9_53;
...
mat3 l9_60=mat3(l9_5,l9_3,l9_4);
vec3 l9_61=-l9_2;
vec4 l9_62=mix(l9_13,mix(Port_Input0_N001,Port_Input1_N001,vec4(max(1.0-pow(1.0-abs(dot(l9_61,l9_60*Port_Normal_N024)),Port_Exponent_N024),0.0)*Port_Intensity_N024)),Port_Input2_N026);
float l9_63=l9_62.w;
...
#endif
sc_writeFragData0Internal(max(l9_64,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_66;
...
{
l9_69=clamp(dot(l9_62.xyz,vec3(l9_63)),0.0,1.0);
}
#else
{
float l9_70;
...
{
l9_71=(1.0-dot(l9_62.xyz,vec3(0.33333001)))*l9_63;
}
#else
{
float l9_72;
...
{
l9_72=(1.0-clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0))*l9_63;
}
#else
{
float l9_73;
...
{
l9_73=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0)*l9_63;
}
#else
{
float l9_74;
#if (sc_BlendMode_Add)
{
l9_74=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_75;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_75=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0)*l9_63;
}
#else
{
float l9_76;
...
{
l9_76=dot(l9_62.xyz,vec3(0.33333001))*l9_63;
}
#else
{
float l9_77;
#if (sc_BlendMode_Min)
{
l9_77=1.0-clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_Max)
{
l9_78=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_78=1.0;
...
#endif
l9_66=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_62.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_67);
}
#else
{
vec4 l9_79;
...
#if (sc_FramebufferFetch)
{
l9_81=sc_readFragData0_Platform();
}
#else
{
...
{
l9_83=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_82,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_83=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_82,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_81=l9_83;
}
#endif
vec3 l9_84=mix(l9_81.xyz,definedBlend(l9_81.xyz,l9_62.xyz).xyz,vec3(l9_63));
...
#if (sc_Voxelization)
{
l9_86=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_87;
#if (sc_OutputBounds)
{
float l9_88=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_87=vec4(l9_88,1.0-l9_88,1.0,1.0);
}
#else
{
vec4 l9_89;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_89=vec4(mix(vec3(1.0),l9_62.xyz,vec3(l9_63)),l9_63);
}
#else
{
vec4 l9_90;
...
#endif
l9_90=vec4(l9_62.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_62;
...
vec4 l9_94=sc_OutputMotionVectorIfNeeded(max(l9_92,vec4(0.0)));
