...
//sampler sampler maskMapSmpSC 0:22
...
//texture texture2D maskMap 0:4:0:22
...
//texture texture2DArray maskMapArrSC 0:33:0:22
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_maskMap 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_maskMap 79 -1
//spec_const int intensityTextureLayout 80 0
//spec_const int maskMapLayout 81 0
...
#define sc_OutputBounds 1
#endif
#ifndef maskMapHasSwappedViews
#define maskMapHasSwappedViews 0
#elif maskMapHasSwappedViews==1
#undef maskMapHasSwappedViews
#define maskMapHasSwappedViews 1
#endif
#ifndef maskMapLayout
#define maskMapLayout 0
#endif
#ifndef sc_DepthOnly
...
#ifndef SC_USE_UV_TRANSFORM_maskMap
#define SC_USE_UV_TRANSFORM_maskMap 0
#elif SC_USE_UV_TRANSFORM_maskMap==1
#undef SC_USE_UV_TRANSFORM_maskMap
#define SC_USE_UV_TRANSFORM_maskMap 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_maskMap
#define SC_SOFTWARE_WRAP_MODE_U_maskMap -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_maskMap
#define SC_SOFTWARE_WRAP_MODE_V_maskMap -1
#endif
#ifndef SC_USE_UV_MIN_MAX_maskMap
#define SC_USE_UV_MIN_MAX_maskMap 0
#elif SC_USE_UV_MIN_MAX_maskMap==1
#undef SC_USE_UV_MIN_MAX_maskMap
#define SC_USE_UV_MIN_MAX_maskMap 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_maskMap
#define SC_USE_CLAMP_TO_BORDER_maskMap 0
#elif SC_USE_CLAMP_TO_BORDER_maskMap==1
#undef SC_USE_CLAMP_TO_BORDER_maskMap
#define SC_USE_CLAMP_TO_BORDER_maskMap 1
#endif
layout(binding=1,std430) readonly buffer sc_RayTracingCasterVertexBuffer
{
float sc_RayTracingCasterVertices[1];
...
uniform vec4 pokeColor;
uniform vec4 pinchColor;
uniform float pokePinchBlend;
uniform float pinchBrightness;
uniform float pinchExponent;
uniform float pokeBrightness;
uniform float pokeExponent;
uniform float pokeHighlightGradientMaskPosition;
uniform int PreviewEnabled;
uniform int PreviewNodeID;
uniform sc_Camera_t sc_Camera;
uniform mat3 maskMapTransform;
uniform vec4 maskMapUvMinMax;
uniform vec4 maskMapBorderColor;
uniform float Port_Rotation_N018;
uniform vec2 Port_Center_N018;
uniform float Port_Value0_N020;
uniform float Port_Position1_N020;
uniform float Port_Value1_N020;
uniform float Port_Value2_N020;
uniform float Port_Value3_N020;
uniform usampler2D sc_RayTracingHitCasterIdAndBarycentric;
uniform sampler2D sc_RayTracingRayDirection;
uniform sampler2D maskMap;
uniform sampler2DArray maskMapArrSC;
...
int maskMapGetStereoViewIndex()
{
int l9_0;
#if (maskMapHasSwappedViews)
{
...
l9_3=normalize(varNormalAndMotion.xyz);
l9_2=varTex01.zw;
}
vec3 l9_7=mix(vec3(pokeColor.xyz),vec3(pinchColor.xyz),vec3(pokePinchBlend));
vec4 l9_8;
#if (maskMapLayout==2)
{
bool l9_9=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_10=l9_2.x;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_11=l9_10;
float l9_12=l9_2.y;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_13=l9_12;
vec2 l9_14;
float l9_15;
#if (SC_USE_UV_MIN_MAX_maskMap)
{
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_17=l9_11;
float l9_18=1.0;
sc_ClampUV(l9_17,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_16,l9_18);
float l9_19=l9_17;
float l9_20=l9_18;
bool l9_21;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_22=l9_13;
float l9_23=l9_20;
sc_ClampUV(l9_22,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_21,l9_23);
l9_15=l9_23;
...
#endif
vec2 l9_24=sc_TransformUV(l9_14,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_25=l9_24.x;
float l9_26=l9_15;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_9,l9_26);
float l9_27=l9_24.y;
float l9_28=l9_26;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_9,l9_28);
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),maskMapLayout,maskMapGetStereoViewIndex());
vec4 l9_31=texture(maskMapArrSC,l9_30,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_32=mix(maskMapBorderColor,l9_31,vec4(l9_29));
}
#else
{
l9_32=l9_31;
...
#else
{
bool l9_33=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_34=l9_2.x;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_35=l9_34;
float l9_36=l9_2.y;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_37=l9_36;
vec2 l9_38;
float l9_39;
#if (SC_USE_UV_MIN_MAX_maskMap)
...
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_41=l9_35;
float l9_42=1.0;
sc_ClampUV(l9_41,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_40,l9_42);
float l9_43=l9_41;
float l9_44=l9_42;
bool l9_45;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_46=l9_37;
float l9_47=l9_44;
sc_ClampUV(l9_46,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_45,l9_47);
l9_39=l9_47;
...
#endif
vec2 l9_48=sc_TransformUV(l9_38,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_33,l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_33,l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),maskMapLayout,maskMapGetStereoViewIndex());
vec4 l9_55=texture(maskMap,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_56=mix(maskMapBorderColor,l9_55,vec4(l9_53));
}
#else
{
l9_56=l9_55;
...
#endif
float l9_57=dot(l9_3,l9_4);
float l9_58=1.0-l9_57;
bool l9_59=l9_58<=0.0;
float l9_60;
if (l9_59)
{
l9_60=0.0;
...
{
l9_60=pow(l9_58,pinchExponent);
}
float l9_61=l9_8.x*l9_60;
float l9_62;
if (l9_59)
{
l9_62=0.0;
...
{
l9_62=pow(l9_58,pokeExponent);
}
float l9_63=l9_62*l9_8.y;
float l9_64=radians(Port_Rotation_N018);
vec2 l9_65=l9_5-Port_Center_N018;
float l9_66=clamp((vec2(dot(vec2(cos(l9_64),sin(l9_64)),l9_65),0.0)+Port_Center_N018).x,0.0,1.0);
float l9_67;
if (l9_66<Port_Position1_N020)
{
l9_67=mix(Port_Value0_N020,Port_Value1_N020,clamp(l9_66/Port_Position1_N020,0.0,1.0));
}
else
{
float l9_68;
if (l9_66<pokeHighlightGradientMaskPosition)
{
l9_68=mix(Port_Value1_N020,Port_Value2_N020,clamp((l9_66-Port_Position1_N020)/(pokeHighlightGradientMaskPosition-Port_Position1_N020),0.0,1.0));
}
else
{
l9_68=mix(Port_Value2_N020,Port_Value3_N020,clamp((l9_66-pokeHighlightGradientMaskPosition)/(1.0-pokeHighlightGradientMaskPosition),0.0,1.0));
}
l9_67=l9_68;
}
bool l9_69=PreviewEnabled==1;
bool l9_70;
if (l9_69)
{
l9_70=!l9_0;
...
bool l9_71;
vec4 l9_72;
if (l9_70&&(20==PreviewNodeID))
{
vec4 l9_73=vec4(l9_67,l9_67,l9_67,1.0);
l9_73.w=1.0;
l9_72=l9_73;
l9_71=true;
}
...
float l9_74=(pokeBrightness*l9_63)*l9_67;
float l9_75=max(pinchBrightness*l9_61,l9_74);
vec4 l9_76=vec4(l9_7.x,l9_7.y,l9_7.z,vec4(0.0).w);
l9_76.w=l9_75;
...
{
l9_82=clamp(dot(l9_76.xyz,vec3(l9_75)),0.0,1.0);
}
#else
{
float l9_83;
...
{
l9_84=(1.0-dot(l9_76.xyz,vec3(0.33333001)))*l9_75;
}
#else
{
float l9_85;
...
{
l9_85=(1.0-clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0))*l9_75;
}
#else
{
float l9_86;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_88=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0)*l9_75;
}
#else
{
float l9_89;
...
{
l9_89=dot(l9_76.xyz,vec3(0.33333001))*l9_75;
}
#else
{
float l9_90;
...
#if (sc_FramebufferFetch)
{
l9_94=sc_readFragData0_Platform();
}
#else
{
...
{
l9_96=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_95,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_96=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_95,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_94=l9_96;
}
#endif
vec3 l9_97=mix(l9_94.xyz,definedBlend(l9_94.xyz,l9_76.xyz).xyz,vec3(l9_75));
...
#if (sc_Voxelization)
{
l9_99=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_100;
#if (sc_OutputBounds)
{
float l9_101=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_100=vec4(l9_101,1.0-l9_101,1.0,1.0);
}
#else
{
vec4 l9_102;
...
vec4 l9_107=sc_OutputMotionVectorIfNeeded(max(l9_105,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_109-0.0039215689)),min(1.0,l9_109+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_111=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_110).xy);
float l9_112=packValue(l9_111);
int l9_119=int(l9_108.w*255.0);
float l9_120=packValue(l9_119);
sc_writeFragData0Internal(vec4(packValue(l9_111),packValue(l9_111),packValue(l9_111),packValue(l9_111)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_128==0)
{
l9_131=texture(sc_OITAlpha0,l9_123);
l9_130=texture(sc_OITDepthLow0,l9_123);
l9_129=texture(sc_OITDepthHigh0,l9_123);
}
else
{
l9_131=vec4(0.0);
...
if (l9_128==1)
{
l9_134=texture(sc_OITAlpha1,l9_123);
l9_133=texture(sc_OITDepthLow1,l9_123);
l9_132=texture(sc_OITDepthHigh1,l9_123);
}
else
{
l9_134=l9_131;
...
vec4 l9_149=texture(sc_OITFilteredDepthBoundsTexture,l9_123);
