...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int Tweak_N1Layout 80 0
...
#if (Tweak_N1Layout==2)
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_5=l9_1.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_6=l9_5;
float l9_7=l9_1.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
...
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_26=texture(Tweak_N1ArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_27=mix(Tweak_N1BorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
...
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_50=texture(Tweak_N1,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_51=mix(Tweak_N1BorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#if (sc_FramebufferFetch)
{
l9_71=sc_readFragData0_Platform();
}
#else
{
...
#endif
vec3 l9_74=mix(l9_71.xyz,definedBlend(l9_71.xyz,l9_52.xyz).xyz,vec3(l9_53));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_53)),l9_53);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_52.xyz*l9_81,l9_81);
}
#else
{
l9_80=l9_52;
...
vec4 l9_84=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_82,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_86-0.0039215689)),min(1.0,l9_86+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_88),packValue(l9_88),packValue(l9_88),packValue(l9_88)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_130,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
