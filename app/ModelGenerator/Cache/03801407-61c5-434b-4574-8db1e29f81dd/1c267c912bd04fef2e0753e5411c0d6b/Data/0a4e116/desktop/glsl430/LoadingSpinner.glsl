...
vec3 l9_6=varNormal;
vec2 l9_7=l9_5.xy*dot(l9_3,ringStroke);
vec3 l9_8=vec3(l9_7.x,l9_7.y,l9_5.z);
l9_8.x=l9_7.x+dot(l9_3,ringRadius);
float l9_9=dot(l9_3,arcCenter);
float l9_10=l9_9+(arcSpread*l9_0.texture1.x);
float l9_11=cos(l9_10);
float l9_12=sin(l9_10);
vec4 l9_13=sc_ModelMatrix*vec4(dot(l9_8.xy,vec2(l9_11,-l9_12)),dot(l9_8.xy,vec2(l9_12,l9_11)),l9_5.z,1.0);
vec3 l9_14;
vec3 l9_15;
vec3 l9_16;
if (l9_2)
{
l9_16=varTangent.xyz;
l9_15=varNormal;
l9_14=varPos;
}
else
...
l9_16=varTangent.xyz;
l9_15=l9_6;
l9_14=l9_13.xyz/vec3(l9_13.w);
}
varPos=l9_14;
varNormal=normalize(l9_15);
...
#if (sc_RenderingSpace==1)
{
l9_24=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_24=vec4(0.0);
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_32=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_36=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_36);
sc_SkinVertex(l9_36);
vec2 l9_37=((l9_36.position.xy/vec2(l9_36.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_37.x,l9_37.y,varPackedTex.z,varPackedTex.w);
vec4 l9_38=sc_ModelMatrixVoxelization*l9_36.position;
vec3 l9_39=l9_38.xyz-voxelization_params_camera_pos;
varPos=l9_39.xyz;
varNormal=normalize(l9_36.normal);
vec4 l9_40=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_39.x,l9_39.y,l9_39.z,l9_38.w);
...
#if (sc_FramebufferFetch)
{
l9_17=sc_readFragData0_Platform();
}
#else
{
...
vec4 l9_30=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_28,vec4(0.0)));
