...
//sampler sampler texture_mapSmpSC 0:31
...
//spec_const bool texture_mapHasSwappedViews 75 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texture_map 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texture_map 79 -1
...
//spec_const int texture_mapLayout 89 0
//SG_REFLECTION_END
...
float l9_6=clamp(mod((sc_Time.x*Port_Multiplier_N039)+(l9_2.x*Port_Input1_N041),Port_Input1_N043),0.0,1.0);
vec4 l9_7;
if (l9_6<Port_Position1_N038)
{
l9_7=mix(Port_Value0_N038,Port_Value1_N038,vec4(clamp(l9_6/Port_Position1_N038,0.0,1.0)));
}
else
{
l9_7=mix(Port_Value1_N038,Port_Value2_N038,vec4(clamp((l9_6-Port_Position1_N038)/(1.0-Port_Position1_N038),0.0,1.0)));
}
...
vec2 l9_13=l9_3-Port_Center_N032;
vec2 l9_14=(((l9_13*Port_Scale_N032)+Port_Center_N032)+vec2(l9_2.x*Port_Input1_N034))+(Port_Direction_N037*(sc_Time.x*(Tweak_N44*Port_Input1_N046)));
vec4 l9_15;
#if (texture_mapLayout==2)
{
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0));
float l9_17=l9_14.x;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x);
float l9_18=l9_17;
float l9_19=l9_14.y;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y);
float l9_20=l9_19;
vec2 l9_21;
float l9_22;
...
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x==3;
}
#else
{
...
float l9_24=l9_18;
float l9_25=1.0;
sc_ClampUV(l9_24,texture_mapUvMinMax.x,texture_mapUvMinMax.z,l9_23,l9_25);
float l9_26=l9_24;
float l9_27=l9_25;
bool l9_28;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y==3;
}
#else
{
l9_28=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_29=l9_20;
float l9_30=l9_27;
sc_ClampUV(l9_29,texture_mapUvMinMax.y,texture_mapUvMinMax.w,l9_28,l9_30);
l9_22=l9_30;
...
#endif
vec2 l9_31=sc_TransformUV(l9_21,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform);
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,l9_16,l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,l9_16,l9_35);
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),texture_mapLayout,texture_mapGetStereoViewIndex());
vec4 l9_38=texture(texture_mapArrSC,l9_37,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_39=mix(texture_mapBorderColor,l9_38,vec4(l9_36));
}
#else
{
l9_39=l9_38;
...
#else
{
bool l9_40=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0));
float l9_41=l9_14.x;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x);
float l9_42=l9_41;
float l9_43=l9_14.y;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
#if (SC_USE_UV_MIN_MAX_texture_map)
...
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_48=l9_42;
float l9_49=1.0;
sc_ClampUV(l9_48,texture_mapUvMinMax.x,texture_mapUvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,texture_mapUvMinMax.y,texture_mapUvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,l9_40,l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,l9_40,l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),texture_mapLayout,texture_mapGetStereoViewIndex());
vec4 l9_62=texture(texture_map,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_63=mix(texture_mapBorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
#endif
vec4 l9_64=vec4(1.0)-l9_15;
float l9_65=mix(((vec4((1.0-max(smoothstep(Port_Input0_N000,Port_Input1_N000,l9_3.x),1.0-smoothstep(Port_Input0_N003,Port_Input1_N003,l9_3.x)))*(1.0-smoothstep(Port_Input0_N014,Port_Input1_N014,abs(l9_3.y-Port_Input1_N013))))*l9_64)*vec4(smoothstep(Port_Input0_N045,Port_Input1_N045,Tweak_N44))).x,Port_Input1_N047,float(l9_4.y<black_height));
vec4 l9_66=vec4(l9_7.x,l9_7.y,l9_7.z,vec4(0.0).w);
l9_66.w=l9_65;
...
{
l9_72=clamp(dot(l9_66.xyz,vec3(l9_65)),0.0,1.0);
}
#else
{
float l9_73;
...
{
l9_74=(1.0-dot(l9_66.xyz,vec3(0.33333001)))*l9_65;
}
#else
{
float l9_75;
...
{
l9_75=(1.0-clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0))*l9_65;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_Add)
{
l9_77=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_78=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0)*l9_65;
}
#else
{
float l9_79;
...
{
l9_79=dot(l9_66.xyz,vec3(0.33333001))*l9_65;
}
#else
{
float l9_80;
#if (sc_BlendMode_Min)
{
l9_80=1.0-clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_81;
#if (sc_BlendMode_Max)
{
l9_81=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_81=1.0;
...
#endif
l9_69=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_66.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_70);
}
#else
{
vec4 l9_82;
...
#endif
vec3 l9_87=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_66.xyz).xyz,vec3(l9_65));
