...
vec3 l9_13=l9_12*Port_Import_N068;
...
vec3 l9_17=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_16,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_18;
...
#endif
vec4 l9_67=vec4(Port_Import_N062)*l9_18;
vec2 l9_68=l9_4*Port_Input1_N009;
float l9_69=clamp(length(l9_68+Port_Input2_N009),0.0,1.0);
vec4 l9_70;
if (l9_69<Port_Position1_N014)
{
l9_70=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_69/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_71;
if (l9_69<Port_Position2_N014)
{
l9_71=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_69-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_71=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_69-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_70=l9_71;
}
vec4 l9_72=l9_67+l9_70;
vec2 l9_73=l9_5-Port_Center_N002;
vec2 l9_74=(l9_73*Port_Scale_N002)+Port_Center_N002;
vec4 l9_75;
#if (iconLayout==2)
{
bool l9_76=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_77=l9_74.x;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_78=l9_77;
float l9_79=l9_74.y;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_80=l9_79;
vec2 l9_81;
float l9_82;
...
{
l9_83=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_84=l9_78;
float l9_85=1.0;
sc_ClampUV(l9_84,iconUvMinMax.x,iconUvMinMax.z,l9_83,l9_85);
float l9_86=l9_84;
float l9_87=l9_85;
bool l9_88;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_88=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_89=l9_80;
float l9_90=l9_87;
sc_ClampUV(l9_89,iconUvMinMax.y,iconUvMinMax.w,l9_88,l9_90);
l9_82=l9_90;
...
#endif
vec2 l9_91=sc_TransformUV(l9_81,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_92=l9_91.x;
float l9_93=l9_82;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_76,l9_93);
float l9_94=l9_91.y;
float l9_95=l9_93;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_76,l9_95);
float l9_96=l9_95;
vec3 l9_97=sc_SamplingCoordsViewToGlobal(vec2(l9_92,l9_94),iconLayout,iconGetStereoViewIndex());
vec4 l9_98=texture(iconArrSC,l9_97,0.0);
vec4 l9_99;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_99=mix(iconBorderColor,l9_98,vec4(l9_96));
}
#else
{
l9_99=l9_98;
...
#else
{
bool l9_100=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_101=l9_74.x;
sc_SoftwareWrapEarly(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_102=l9_101;
float l9_103=l9_74.y;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_104=l9_103;
vec2 l9_105;
float l9_106;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_108=l9_102;
float l9_109=1.0;
sc_ClampUV(l9_108,iconUvMinMax.x,iconUvMinMax.z,l9_107,l9_109);
float l9_110=l9_108;
float l9_111=l9_109;
bool l9_112;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_112=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_113=l9_104;
float l9_114=l9_111;
sc_ClampUV(l9_113,iconUvMinMax.y,iconUvMinMax.w,l9_112,l9_114);
l9_106=l9_114;
...
#endif
vec2 l9_115=sc_TransformUV(l9_105,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_116=l9_115.x;
float l9_117=l9_106;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_100,l9_117);
float l9_118=l9_115.y;
float l9_119=l9_117;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_100,l9_119);
float l9_120=l9_119;
vec3 l9_121=sc_SamplingCoordsViewToGlobal(vec2(l9_116,l9_118),iconLayout,iconGetStereoViewIndex());
vec4 l9_122=texture(icon,l9_121.xy,0.0);
vec4 l9_123;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_123=mix(iconBorderColor,l9_122,vec4(l9_120));
}
#else
{
l9_123=l9_122;
...
#if (iconLayout==2)
{
bool l9_126=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_127=l9_74.x;
sc_SoftwareWrapEarly(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_128=l9_127;
float l9_129=l9_74.y;
sc_SoftwareWrapEarly(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_130=l9_129;
vec2 l9_131;
float l9_132;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_134=l9_128;
float l9_135=1.0;
sc_ClampUV(l9_134,iconUvMinMax.x,iconUvMinMax.z,l9_133,l9_135);
float l9_136=l9_134;
float l9_137=l9_135;
bool l9_138;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_138=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_138=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_139=l9_130;
float l9_140=l9_137;
sc_ClampUV(l9_139,iconUvMinMax.y,iconUvMinMax.w,l9_138,l9_140);
l9_132=l9_140;
...
#endif
vec2 l9_141=sc_TransformUV(l9_131,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_142=l9_141.x;
float l9_143=l9_132;
sc_SoftwareWrapLate(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_126,l9_143);
float l9_144=l9_141.y;
float l9_145=l9_143;
sc_SoftwareWrapLate(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_126,l9_145);
float l9_146=l9_145;
vec3 l9_147=sc_SamplingCoordsViewToGlobal(vec2(l9_142,l9_144),iconLayout,iconGetStereoViewIndex());
vec4 l9_148=texture(iconArrSC,l9_147,0.0);
vec4 l9_149;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_149=mix(iconBorderColor,l9_148,vec4(l9_146));
}
#else
{
l9_149=l9_148;
...
#else
{
bool l9_150=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_151=l9_74.x;
sc_SoftwareWrapEarly(l9_151,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_152=l9_151;
float l9_153=l9_74.y;
sc_SoftwareWrapEarly(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_154=l9_153;
vec2 l9_155;
float l9_156;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_157=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_157=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_158=l9_152;
float l9_159=1.0;
sc_ClampUV(l9_158,iconUvMinMax.x,iconUvMinMax.z,l9_157,l9_159);
float l9_160=l9_158;
float l9_161=l9_159;
bool l9_162;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_162=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_163=l9_154;
float l9_164=l9_161;
sc_ClampUV(l9_163,iconUvMinMax.y,iconUvMinMax.w,l9_162,l9_164);
l9_156=l9_164;
l9_155=vec2(l9_160,l9_163);
}
#else
{
l9_156=1.0;
l9_155=vec2(l9_152,l9_154);
}
#endif
vec2 l9_165=sc_TransformUV(l9_155,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_166=l9_165.x;
float l9_167=l9_156;
sc_SoftwareWrapLate(l9_166,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_150,l9_167);
float l9_168=l9_165.y;
float l9_169=l9_167;
sc_SoftwareWrapLate(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_150,l9_169);
float l9_170=l9_169;
vec3 l9_171=sc_SamplingCoordsViewToGlobal(vec2(l9_166,l9_168),iconLayout,iconGetStereoViewIndex());
vec4 l9_172=texture(icon,l9_171.xy,0.0);
vec4 l9_173;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_173=mix(iconBorderColor,l9_172,vec4(l9_170));
}
#else
{
l9_173=l9_172;
...
{
l9_124=Port_Input2_N003;
}
vec4 l9_174=vec4(l9_124);
vec4 l9_175=mix(l9_72,l9_75,l9_174);
float l9_176=l9_175.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_176<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_176<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_177,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_179;
...
{
l9_181=clamp(l9_176*2.0,0.0,1.0);
}
#else
{
float l9_182;
...
{
l9_182=clamp(dot(l9_175.xyz,vec3(l9_176)),0.0,1.0);
}
#else
{
float l9_183;
...
{
l9_184=(1.0-dot(l9_175.xyz,vec3(0.33333001)))*l9_176;
}
#else
{
float l9_185;
...
{
l9_185=(1.0-clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0))*l9_176;
}
#else
{
float l9_186;
...
{
l9_186=clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0)*l9_176;
}
#else
{
float l9_187;
#if (sc_BlendMode_Add)
{
l9_187=clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_188;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_188=clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0)*l9_176;
}
#else
{
float l9_189;
...
{
l9_189=dot(l9_175.xyz,vec3(0.33333001))*l9_176;
}
#else
{
float l9_190;
#if (sc_BlendMode_Min)
{
l9_190=1.0-clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_191;
#if (sc_BlendMode_Max)
{
l9_191=clamp(dot(l9_175.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_191=1.0;
...
#endif
l9_179=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_175.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_180);
}
#else
{
vec4 l9_192;
...
#if (sc_FramebufferFetch)
{
l9_194=sc_readFragData0_Platform();
}
#else
{
...
{
l9_196=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_195,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_196=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_195,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_194=l9_196;
}
#endif
vec3 l9_197=mix(l9_194.xyz,definedBlend(l9_194.xyz,l9_175.xyz).xyz,vec3(l9_176));
vec4 l9_198=vec4(l9_197.x,l9_197.y,l9_197.z,vec4(0.0).w);
l9_198.w=1.0;
l9_193=l9_198;
}
#else
...
#if (sc_Voxelization)
{
l9_199=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_200;
#if (sc_OutputBounds)
{
float l9_201=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_200=vec4(l9_201,1.0-l9_201,1.0,1.0);
}
#else
{
vec4 l9_202;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_202=vec4(mix(vec3(1.0),l9_175.xyz,vec3(l9_176)),l9_176);
}
#else
{
vec4 l9_203;
...
#endif
l9_203=vec4(l9_175.xyz*l9_204,l9_204);
}
#else
{
l9_203=l9_175;
...
vec4 l9_207=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_205,vec4(0.0)));
vec4 l9_208=clamp(l9_207,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_209=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_209-0.0039215689)),min(1.0,l9_209+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_210).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_211=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_210).xy);
float l9_212=packValue(l9_211);
int l9_219=int(l9_208.w*255.0);
float l9_220=packValue(l9_219);
sc_writeFragData0Internal(vec4(packValue(l9_211),packValue(l9_211),packValue(l9_211),packValue(l9_211)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_212,packValue(l9_211),packValue(l9_211),packValue(l9_211)));
sc_writeFragData2(vec4(l9_220,packValue(l9_219),packValue(l9_219),packValue(l9_219)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_223=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_223).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_228==0)
{
l9_231=texture(sc_OITAlpha0,l9_223);
l9_230=texture(sc_OITDepthLow0,l9_223);
l9_229=texture(sc_OITDepthHigh0,l9_223);
}
else
{
l9_231=vec4(0.0);
...
if (l9_228==1)
{
l9_234=texture(sc_OITAlpha1,l9_223);
l9_233=texture(sc_OITDepthLow1,l9_223);
l9_232=texture(sc_OITDepthHigh1,l9_223);
}
else
{
l9_234=l9_231;
...
if (any(notEqual(l9_232,vec4(0.0)))||any(notEqual(l9_233,vec4(0.0))))
{
int l9_235[8]=l9_224;
unpackValues(l9_232.w,l9_228,l9_235);
unpackValues(l9_232.z,l9_228,l9_235);
unpackValues(l9_232.y,l9_228,l9_235);
unpackValues(l9_232.x,l9_228,l9_235);
unpackValues(l9_233.w,l9_228,l9_235);
unpackValues(l9_233.z,l9_228,l9_235);
unpackValues(l9_233.y,l9_228,l9_235);
unpackValues(l9_233.x,l9_228,l9_235);
int l9_244[8]=l9_225;
unpackValues(l9_234.w,l9_228,l9_244);
unpackValues(l9_234.z,l9_228,l9_244);
unpackValues(l9_234.y,l9_228,l9_244);
unpackValues(l9_234.x,l9_228,l9_244);
}
l9_228++;
continue;
}
...
vec4 l9_249=texture(sc_OITFilteredDepthBoundsTexture,l9_223);
vec2 l9_250=l9_249.xy;
int l9_251;
#if (sc_SkinBonesCount>0)
{
l9_251=encodeDepth(((1.0-l9_249.x)*1000.0)+getDepthOrderingEpsilon(),l9_250);
}
#else
{
l9_251=0;
...
#endif
int l9_252=encodeDepth(viewSpaceDepth(),l9_250);
vec4 l9_253;
l9_253=l9_208*l9_208.w;
vec4 l9_254;
int l9_255=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_255<8)
{
int l9_256=l9_224[l9_255];
int l9_257=l9_252-l9_251;
bool l9_258=l9_256<l9_257;
bool l9_259;
if (l9_258)
{
l9_259=l9_224[l9_255]>0;
}
else
{
l9_259=l9_258;
...
if (l9_259)
{
vec3 l9_260=l9_253.xyz*(1.0-(float(l9_225[l9_255])/255.0));
l9_254=vec4(l9_260.x,l9_260.y,l9_260.z,l9_253.w);
}
else
{
l9_254=l9_253;
