...
#endif
uvec3 l9_52=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
vec4 l9_91=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_89,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_93-0.0039215689)),min(1.0,l9_93+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_95),packValue(l9_95),packValue(l9_95),packValue(l9_95)),sc_UniformConstants.x,sc_ShaderCacheConstant);
