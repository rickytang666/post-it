...
#endif
vec3 l9_24=mix(l9_21.xyz,definedBlend(l9_21.xyz,l9_1.xyz).xyz,vec3(l9_3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_3)),l9_3);
}
#else
{
vec4 l9_30;
...
vec4 l9_34=sc_OutputMotionVectorIfNeeded(max(l9_32,vec4(0.0)));
