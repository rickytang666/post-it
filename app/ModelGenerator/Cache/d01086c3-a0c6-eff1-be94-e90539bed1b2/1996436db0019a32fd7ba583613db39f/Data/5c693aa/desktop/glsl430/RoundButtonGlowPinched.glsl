...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int glow_mapLayout 80 0
...
vec2 l9_4=l9_2+Port_Offset_N009;
vec4 l9_5;
#if (glow_mapLayout==2)
{
bool l9_6=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0));
float l9_7=l9_4.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_8=l9_7;
float l9_9=l9_4.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,l9_6,l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,l9_6,l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_28=texture(glow_mapArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_29=mix(glow_mapBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#else
{
bool l9_30=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0));
float l9_31=l9_4.x;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_32=l9_31;
float l9_33=l9_4.y;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
#if (SC_USE_UV_MIN_MAX_glow_map)
...
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,l9_30,l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,l9_30,l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_52=texture(glow_map,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_53=mix(glow_mapBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
float l9_54=clamp(l9_5.x,0.0,1.0);
vec4 l9_55;
if (l9_54<Port_Position1_N007)
{
l9_55=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_54/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_56;
if (l9_54<Port_Position2_N007)
{
l9_56=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_54-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_56=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_54-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_55=l9_56;
}
bool l9_57=PreviewEnabled==1;
bool l9_58;
if (l9_57)
{
l9_58=!l9_0;
...
if (l9_55.x<float(l9_55.x<Port_Input1_N003))
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_55.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_55.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_62,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_64;
...
{
l9_66=clamp(l9_55.w*2.0,0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_67=clamp(dot(l9_55.xyz,vec3(l9_55.w)),0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_69=(1.0-dot(l9_55.xyz,vec3(0.33333001)))*l9_55.w;
}
#else
{
float l9_70;
...
{
l9_70=(1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0))*l9_55.w;
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_55.w;
}
#else
{
float l9_72;
#if (sc_BlendMode_Add)
{
l9_72=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_73=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_55.w;
}
#else
{
float l9_74;
...
{
l9_74=dot(l9_55.xyz,vec3(0.33333001))*l9_55.w;
}
#else
{
float l9_75;
#if (sc_BlendMode_Min)
{
l9_75=1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_76;
#if (sc_BlendMode_Max)
{
l9_76=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_76=1.0;
...
#endif
l9_64=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_55.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_65);
}
#else
{
vec4 l9_77;
...
#endif
vec3 l9_82=mix(l9_79.xyz,definedBlend(l9_79.xyz,l9_55.xyz).xyz,vec3(l9_55.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_87=vec4(mix(vec3(1.0),l9_55.xyz,vec3(l9_55.w)),l9_55.w);
}
#else
{
vec4 l9_88;
...
#endif
l9_88=vec4(l9_55.xyz*l9_89,l9_89);
}
#else
{
l9_88=l9_55;
...
vec4 l9_92=sc_OutputMotionVectorIfNeeded(max(l9_90,vec4(0.0)));
