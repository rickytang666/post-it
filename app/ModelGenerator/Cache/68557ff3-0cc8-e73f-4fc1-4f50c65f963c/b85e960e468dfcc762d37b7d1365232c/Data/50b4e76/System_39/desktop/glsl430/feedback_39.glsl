...
{
l9_0=texture(renderTarget0ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget0Layout,renderTarget0GetStereoViewIndex()),0.0);
}
#else
{
l9_0=texture(renderTarget0,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget0Layout,renderTarget0GetStereoViewIndex()).xy,0.0);
}
#endif
vec4 l9_1;
#if (renderTarget1Layout==2)
{
l9_1=texture(renderTarget1ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget1Layout,renderTarget1GetStereoViewIndex()),0.0);
}
#else
{
l9_1=texture(renderTarget1,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget1Layout,renderTarget1GetStereoViewIndex()).xy,0.0);
}
#endif
vec4 l9_2;
#if (renderTarget2Layout==2)
{
l9_2=texture(renderTarget2ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex()),0.0);
}
#else
{
l9_2=texture(renderTarget2,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex()).xy,0.0);
}
#endif
vec4 l9_3;
#if (renderTarget3Layout==2)
{
l9_3=texture(renderTarget3ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex()),0.0);
}
#else
{
l9_3=texture(renderTarget3,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex()).xy,0.0);
}
#endif
