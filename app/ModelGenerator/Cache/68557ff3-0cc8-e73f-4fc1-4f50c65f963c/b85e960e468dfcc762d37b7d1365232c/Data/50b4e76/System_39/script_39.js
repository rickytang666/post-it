...
// Register
//////////////////////////////////////////////////////////////
//TODO: replace with options map
VfxManager.prototype.register = function(simMaterial,
	renderMaterial,
	texelCount,
	instanceCount,
	vfxComponent,
	...
	for ( const vfx of pass.vfxObjects) {
		...
		if (vfx.sortByDepthEffective && (vfx.sortPostEffects.length > 0 ) ) {
			...
			for ( var j = 0; j < MAX_COPIES; j++) {
				...
				var str = "modelMatrix[" + j.toString() + "]";
				depthAndIDFeedbackMaterial[str] = vfx.sceneObjects[j].getTransform().getWorldTransform();
			}
...
var updateUniforms = function()
{
	...
	var viewMatrixInverse = renderCameraTransform.getWorldTransform();
	...
	*/
	...
	// VFX_OBJECT.modelMatrix[COPY_ID] = modelMatrix;
	...
	*/
	...
	simulatePass.vfxCameraPosition = renderCameraTransform.getWorldPosition();
...
var initialize = function()
{
	...
	const vfxInfo = global._ngsVfxManager.register(MAT_SIMULATE,
		MAT_RENDER,
		TEXEL_COUNT,
		INSTANCE_COUNT,
		vfxComponent,
