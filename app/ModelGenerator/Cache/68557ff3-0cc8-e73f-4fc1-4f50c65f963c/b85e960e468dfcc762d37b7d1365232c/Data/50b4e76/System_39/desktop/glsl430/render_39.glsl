...
vec3 l9_8=gParticle.Matrix*tangent.xyz;
varTangent=vec4(l9_8.x,l9_8.y,l9_8.z,varTangent.w);
varTangent.w=tangent.w;
varPackedTex=vec4(texture0,texture1);
vec4 l9_9=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
vec4 l9_10;
...
float l9_12=l9_9.w;
vec4 l9_13=l9_9;
l9_13.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_12))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_12;
l9_11=l9_13;
}
else
{
...
float l9_2=((((distance(varPos,sc_Camera.position)*Port_Input1_N017)-Port_RangeMinA_N018)/((Port_RangeMaxA_N018-Port_RangeMinA_N018)+1e-06))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_3;
