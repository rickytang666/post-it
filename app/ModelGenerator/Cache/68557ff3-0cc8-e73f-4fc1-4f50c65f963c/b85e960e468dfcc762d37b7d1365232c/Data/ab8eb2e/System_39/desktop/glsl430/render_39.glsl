...
//texture texture2DArray intensityTextureArrSC 0:35:0:21
...
//texture texture2DArray sc_ScreenTextureArrSC 0:42:0:30
...
//spec_const int sc_StereoViewID 60 0
//SG_REFLECTION_END
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[ssInstanceID/40];
}
else
{
l9_17=l9_16;
...
gParticle.collisionCount_N119=0.0+(((DecodeFloat8(renderTarget0SampleViewBias(l9_31,0.0).x,true)-0.0)*(255.0-0.0))/l9_30);
...
if (!l9_1)
{
l9_2=vfxBatchEnable[ssInstanceID/40]==false;
}
else
{
l9_2=l9_1;
...
gParticle.Matrix=quaternionToMatrix(gParticle.Quaternion);
vec3 l9_8=gParticle.Position+((gParticle.Matrix*position.xyz)*gParticle.Size);
varPosAndMotion=vec4(l9_8.x,l9_8.y,l9_8.z,varPosAndMotion.w);
vec3 l9_9=gParticle.Matrix*normal;
...
vec4 l9_11=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
vec4 l9_12;
...
float l9_2=((((distance(varPosAndMotion.xyz,sc_Camera.position)*Port_Input1_N017)-Port_RangeMinA_N018)/((Port_RangeMaxA_N018-Port_RangeMinA_N018)+1e-06))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_3;
...
float l9_4=((max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),mat3(l9_0,cross(l9_1,l9_0),l9_1)*Port_Normal_N002)),Port_Exponent_N002),0.0)*Port_Intensity_N002)*Port_Input1_N063)+l9_3;
...
{
l9_20=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_20=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_16=l9_20;
}
#endif
vec3 l9_21=mix(l9_16.xyz,definedBlend(l9_16.xyz,l9_13.xyz).xyz,vec3(l9_12.x));
...
{
l9_26=vec4(mix(vec3(1.0),l9_13.xyz,vec3(l9_12.x)),l9_12.x);
}
#else
{
vec4 l9_27;
...
#endif
l9_27=vec4(l9_13.xyz*l9_28,l9_28);
}
#else
{
l9_27=l9_13;
