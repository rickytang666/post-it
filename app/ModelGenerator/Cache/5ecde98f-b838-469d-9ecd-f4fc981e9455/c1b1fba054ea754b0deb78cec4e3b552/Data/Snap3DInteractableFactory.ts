    ...
    return new Promise((resolve, reject) => {
      ...
      this.generateSnap3DPrompt(originalText)
        .then((cleanPrompt) => {
          ...
          // Ensure the text component never truncates
          const textComp = outputObj.getComponent("Component.Text") as Text;
          if (textComp) {
            textComp.overflowMode = TextOverflowMode.Overflow;
            textComp.wordwrap = true;
            textComp.maxLines = 0; // unlimited lines
          }
