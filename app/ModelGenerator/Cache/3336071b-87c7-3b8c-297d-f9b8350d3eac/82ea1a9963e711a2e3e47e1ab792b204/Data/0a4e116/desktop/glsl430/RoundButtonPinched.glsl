...
vec3 l9_13=l9_12*Port_Import_N089;
...
vec3 l9_17=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_16,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037);
vec4 l9_18;
#if (simple_round_buttonLayout==2)
{
bool l9_19=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0));
float l9_20=l9_17.x;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x);
float l9_21=l9_20;
float l9_22=l9_17.y;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
...
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,simple_round_buttonUvMinMax.x,simple_round_buttonUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,simple_round_buttonUvMinMax.y,simple_round_buttonUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,l9_19,l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,l9_19,l9_38);
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),simple_round_buttonLayout,simple_round_buttonGetStereoViewIndex());
vec4 l9_41=texture(simple_round_buttonArrSC,l9_40,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_42=mix(simple_round_buttonBorderColor,l9_41,vec4(l9_39));
}
#else
{
l9_42=l9_41;
...
#else
{
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0));
float l9_44=l9_17.x;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x);
float l9_45=l9_44;
float l9_46=l9_17.y;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y);
float l9_47=l9_46;
vec2 l9_48;
float l9_49;
#if (SC_USE_UV_MIN_MAX_simple_round_button)
...
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_51=l9_45;
float l9_52=1.0;
sc_ClampUV(l9_51,simple_round_buttonUvMinMax.x,simple_round_buttonUvMinMax.z,l9_50,l9_52);
float l9_53=l9_51;
float l9_54=l9_52;
bool l9_55;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y==3;
}
#else
{
l9_55=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_56=l9_47;
float l9_57=l9_54;
sc_ClampUV(l9_56,simple_round_buttonUvMinMax.y,simple_round_buttonUvMinMax.w,l9_55,l9_57);
l9_49=l9_57;
...
#endif
vec2 l9_58=sc_TransformUV(l9_48,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform);
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,l9_43,l9_62);
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),simple_round_buttonLayout,simple_round_buttonGetStereoViewIndex());
vec4 l9_65=texture(simple_round_button,l9_64.xy,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_66=mix(simple_round_buttonBorderColor,l9_65,vec4(l9_63));
}
#else
{
l9_66=l9_65;
...
#endif
vec4 l9_67=vec4(Port_Import_N027)*l9_18;
vec2 l9_68=l9_4*Port_Input1_N010;
float l9_69=clamp(length(l9_68+Port_Input2_N010),0.0,1.0);
vec4 l9_70;
if (l9_69<Port_Position1_N030)
{
l9_70=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_69/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_70=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_69-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec3 l9_71=-l9_5;
vec4 l9_72=mix(l9_70,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_71,l9_12*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_73=l9_72.w;
vec3 l9_74=(l9_67.xyz+Port_Input1_N002)+l9_72.xyz;
...
#endif
sc_writeFragData0Internal(max(l9_76,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_78;
...
{
l9_81=clamp(dot(l9_75.xyz,vec3(l9_73)),0.0,1.0);
}
#else
{
float l9_82;
...
{
l9_83=(1.0-dot(l9_75.xyz,vec3(0.33333001)))*l9_73;
}
#else
{
float l9_84;
...
{
l9_84=(1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0))*l9_73;
}
#else
{
float l9_85;
...
{
l9_85=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_73;
}
#else
{
float l9_86;
#if (sc_BlendMode_Add)
{
l9_86=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_87;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_87=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_73;
}
#else
{
float l9_88;
...
{
l9_88=dot(l9_75.xyz,vec3(0.33333001))*l9_73;
}
#else
{
float l9_89;
#if (sc_BlendMode_Min)
{
l9_89=1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_90;
#if (sc_BlendMode_Max)
{
l9_90=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_90=1.0;
...
#endif
l9_78=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_75.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_79);
}
#else
{
vec4 l9_91;
...
#if (sc_FramebufferFetch)
{
l9_93=sc_readFragData0_Platform();
}
#else
{
...
{
l9_95=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_94,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_95=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_94,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_93=l9_95;
}
#endif
vec3 l9_96=mix(l9_93.xyz,definedBlend(l9_93.xyz,l9_75.xyz).xyz,vec3(l9_73));
vec4 l9_97=vec4(l9_96.x,l9_96.y,l9_96.z,vec4(0.0).w);
l9_97.w=1.0;
l9_92=l9_97;
}
#else
...
#if (sc_Voxelization)
{
l9_98=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_99;
#if (sc_OutputBounds)
{
float l9_100=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_99=vec4(l9_100,1.0-l9_100,1.0,1.0);
}
#else
{
vec4 l9_101;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_101=vec4(mix(vec3(1.0),l9_75.xyz,vec3(l9_73)),l9_73);
}
#else
{
vec4 l9_102;
...
#endif
l9_102=vec4(l9_75.xyz*l9_103,l9_103);
}
#else
{
l9_102=l9_75;
...
vec4 l9_106=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_104,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_109).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_110=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_109).xy);
...
if (l9_127==0)
{
l9_130=texture(sc_OITAlpha0,l9_122);
l9_129=texture(sc_OITDepthLow0,l9_122);
l9_128=texture(sc_OITDepthHigh0,l9_122);
}
else
{
l9_130=vec4(0.0);
...
if (l9_127==1)
{
l9_133=texture(sc_OITAlpha1,l9_122);
l9_132=texture(sc_OITDepthLow1,l9_122);
l9_131=texture(sc_OITDepthHigh1,l9_122);
}
else
{
l9_133=l9_130;
...
vec4 l9_148=texture(sc_OITFilteredDepthBoundsTexture,l9_122);
