...
float l9_8=scaleFactor+1.234e-06;
vec3 l9_9;
vec3 l9_10;
vec3 l9_11;
if (l9_4)
...
l9_11=varTangent.xyz;
l9_10=varNormalAndMotion.xyz;
l9_9=(sc_ModelMatrix*vec4((((scaleX*(varColor.x-Port_Input1_N021))*Port_Input2_N014)/l9_8)+l9_7.x,(((scaleY*((varColor.y-Port_Input1_N018)*Port_Input1_N002))*Port_Input2_N019)/l9_8)+l9_7.y,l9_7.z+(((scaleZ*(varColor.z-Port_Input1_N008))*Port_Input2_N023)/l9_8),1.0)).xyz;
}
...
#if (sc_RenderingSpace==3)
{
l9_14=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_15;
#if (sc_RenderingSpace==2)
{
l9_15=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_16;
#if (sc_RenderingSpace==1)
{
l9_16=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_16=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_18=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_19;
...
#if (sc_RenderingSpace==1)
{
l9_21=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_21=l9_0.position;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_28=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
...
#endif
vec4 l9_0=vec4(varPosAndMotion.xyz,1.0);
...
if (l9_44>0.0)
{
vec3 l9_46=cross(normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0).xyz),normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(normalize(varNormalAndMotion.xyz),0.0)).xyz));
vec2 l9_47=l9_46.yx;
l9_47.x=l9_46.y*(-1.0);
