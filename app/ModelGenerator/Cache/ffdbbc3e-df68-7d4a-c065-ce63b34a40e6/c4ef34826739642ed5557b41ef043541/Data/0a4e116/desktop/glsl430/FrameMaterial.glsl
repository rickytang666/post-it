...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_matcapTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_matcapTexture 78 -1
//spec_const int intensityTextureLayout 79 0
//spec_const int matcapTextureLayout 80 0
...
vec3 l9_6=varNormal;
float l9_7=scaleFactor+1.234e-06;
vec3 l9_8;
vec3 l9_9;
vec3 l9_10;
if (l9_2)
...
l9_10=varTangent.xyz;
l9_9=l9_6;
l9_8=(sc_ModelMatrix*vec4((((scaleX*(varColor.x-Port_Input1_N021))*Port_Input2_N014)/l9_7)+l9_5.x,(((scaleY*((varColor.y-Port_Input1_N018)*Port_Input1_N002))*Port_Input2_N019)/l9_7)+l9_5.y,l9_5.z+(((scaleZ*(varColor.z-Port_Input1_N008))*Port_Input2_N023)/l9_7),1.0)).xyz;
}
varPos=l9_8;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_26=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
...
#if (sc_FramebufferFetch)
{
l9_125=sc_readFragData0_Platform();
}
#else
{
...
#endif
vec3 l9_128=mix(l9_125.xyz,definedBlend(l9_125.xyz,l9_109.xyz).xyz,vec3(l9_108));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_133=vec4(mix(vec3(1.0),l9_109.xyz,vec3(l9_108)),l9_108);
}
#else
{
vec4 l9_134;
...
#endif
l9_134=vec4(l9_109.xyz*l9_135,l9_135);
}
#else
{
l9_134=l9_109;
...
vec4 l9_138=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_136,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_140-0.0039215689)),min(1.0,l9_140+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_142),packValue(l9_142),packValue(l9_142),packValue(l9_142)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_184,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
