...
#endif
vec3 l9_18=mix(l9_15.xyz,definedBlend(l9_15.xyz,lineColor.xyz).xyz,vec3(lineColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_23=vec4(mix(vec3(1.0),lineColor.xyz,vec3(lineColor.w)),lineColor.w);
}
#else
{
vec4 l9_24;
...
{
l9_25=clamp(lineColor.w,0.0,1.0);
}
#else
{
l9_25=lineColor.w;
...
#endif
l9_24=vec4(lineColor.xyz*l9_25,l9_25);
}
#else
{
l9_24=lineColor;
