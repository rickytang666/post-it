...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 92 -1
//spec_const int Tweak_N25Layout 93 0
//spec_const int Tweak_N6Layout 94 0
//spec_const int intensityTextureLayout 95 0
//spec_const int planet_refl_mapLayout 96 0
...
ssGlobals l9_14=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1);
mat3 l9_15=mat3(l9_6,l9_5,l9_7);
vec3 l9_16=-l9_4;
vec3 l9_17=normalize(l9_16);
vec3 l9_18=normalize(cross(l9_17,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_19=cross(l9_18,l9_17);
vec2 l9_20=((mat3(vec3(l9_18.x,l9_19.x,l9_17.x),vec3(l9_18.y,l9_19.y,l9_17.y),vec3(l9_18.z,l9_19.z,l9_17.z))*normalize(l9_15*Port_Import_N013)).xy*0.5)+vec2(0.5);
vec4 l9_21;
#if (planet_refl_mapLayout==2)
{
bool l9_22=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_23=l9_20.x;
sc_SoftwareWrapEarly(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_24=l9_23;
float l9_25=l9_20.y;
sc_SoftwareWrapEarly(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_26=l9_25;
vec2 l9_27;
float l9_28;
...
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_30=l9_24;
float l9_31=1.0;
sc_ClampUV(l9_30,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_29,l9_31);
float l9_32=l9_30;
float l9_33=l9_31;
bool l9_34;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_35=l9_26;
float l9_36=l9_33;
sc_ClampUV(l9_35,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_34,l9_36);
l9_28=l9_36;
...
#endif
vec2 l9_37=sc_TransformUV(l9_27,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_38=l9_37.x;
float l9_39=l9_28;
sc_SoftwareWrapLate(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_22,l9_39);
float l9_40=l9_37.y;
float l9_41=l9_39;
sc_SoftwareWrapLate(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_22,l9_41);
float l9_42=l9_41;
vec3 l9_43=sc_SamplingCoordsViewToGlobal(vec2(l9_38,l9_40),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_44=texture(planet_refl_mapArrSC,l9_43,0.0);
vec4 l9_45;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_45=mix(planet_refl_mapBorderColor,l9_44,vec4(l9_42));
}
#else
{
l9_45=l9_44;
...
#else
{
bool l9_46=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_47=l9_20.x;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_48=l9_47;
float l9_49=l9_20.y;
sc_SoftwareWrapEarly(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_50=l9_49;
vec2 l9_51;
float l9_52;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_54=l9_48;
float l9_55=1.0;
sc_ClampUV(l9_54,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_53,l9_55);
float l9_56=l9_54;
float l9_57=l9_55;
bool l9_58;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_59=l9_50;
float l9_60=l9_57;
sc_ClampUV(l9_59,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_58,l9_60);
l9_52=l9_60;
...
#endif
vec2 l9_61=sc_TransformUV(l9_51,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_62=l9_61.x;
float l9_63=l9_52;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_46,l9_63);
float l9_64=l9_61.y;
float l9_65=l9_63;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_46,l9_65);
float l9_66=l9_65;
vec3 l9_67=sc_SamplingCoordsViewToGlobal(vec2(l9_62,l9_64),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_68=texture(planet_refl_map,l9_67.xy,0.0);
vec4 l9_69;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_69=mix(planet_refl_mapBorderColor,l9_68,vec4(l9_66));
}
#else
{
l9_69=l9_68;
...
#endif
vec4 l9_70=vec4(reflIntensity)*l9_21;
vec4 l9_71;
#if (Tweak_N37)
{
vec2 l9_72;
Node3_Rotate_Coords(l9_2,Port_Rotation_N003,Port_Center_N003,l9_72,l9_14);
vec4 l9_73;
Node0_Gradient(l9_72.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_73,l9_14);
vec4 l9_74=l9_73;
vec2 l9_75=l9_2+Port_Offset_N062;
vec2 l9_76=((l9_75-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060;
vec4 l9_77;
#if (Tweak_N25Layout==2)
{
bool l9_78=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0));
float l9_79=l9_76.x;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_80=l9_79;
float l9_81=l9_76.y;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_82=l9_81;
vec2 l9_83;
float l9_84;
...
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_85=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_86=l9_80;
float l9_87=1.0;
sc_ClampUV(l9_86,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_85,l9_87);
float l9_88=l9_86;
float l9_89=l9_87;
bool l9_90;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_90=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_91=l9_82;
float l9_92=l9_89;
sc_ClampUV(l9_91,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_90,l9_92);
l9_84=l9_92;
...
#endif
vec2 l9_93=sc_TransformUV(l9_83,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_94=l9_93.x;
float l9_95=l9_84;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,l9_78,l9_95);
float l9_96=l9_93.y;
float l9_97=l9_95;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,l9_78,l9_97);
float l9_98=l9_97;
vec3 l9_99=sc_SamplingCoordsViewToGlobal(vec2(l9_94,l9_96),Tweak_N25Layout,Tweak_N25GetStereoViewIndex());
vec4 l9_100=texture(Tweak_N25ArrSC,l9_99,0.0);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_101=mix(Tweak_N25BorderColor,l9_100,vec4(l9_98));
}
#else
{
l9_101=l9_100;
...
#else
{
bool l9_102=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0));
float l9_103=l9_76.x;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_104=l9_103;
float l9_105=l9_76.y;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_106=l9_105;
vec2 l9_107;
float l9_108;
#if (SC_USE_UV_MIN_MAX_Tweak_N25)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_110=l9_104;
float l9_111=1.0;
sc_ClampUV(l9_110,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_109,l9_111);
float l9_112=l9_110;
float l9_113=l9_111;
bool l9_114;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_115=l9_106;
float l9_116=l9_113;
sc_ClampUV(l9_115,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_114,l9_116);
l9_108=l9_116;
...
#endif
vec2 l9_117=sc_TransformUV(l9_107,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_118=l9_117.x;
float l9_119=l9_108;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,l9_102,l9_119);
float l9_120=l9_117.y;
float l9_121=l9_119;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,l9_102,l9_121);
float l9_122=l9_121;
vec3 l9_123=sc_SamplingCoordsViewToGlobal(vec2(l9_118,l9_120),Tweak_N25Layout,Tweak_N25GetStereoViewIndex());
vec4 l9_124=texture(Tweak_N25,l9_123.xy,0.0);
vec4 l9_125;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_125=mix(Tweak_N25BorderColor,l9_124,vec4(l9_122));
}
#else
{
l9_125=l9_124;
...
#endif
l9_71=vec4(mix(l9_74.xyz,l9_77.xyz,vec3(l9_77.w)),0.0);
}
#else
{
vec2 l9_126;
Node3_Rotate_Coords(l9_2,Port_Rotation_N003,Port_Center_N003,l9_126,l9_14);
vec4 l9_127;
Node0_Gradient(l9_126.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_127,l9_14);
l9_71=l9_127;
}
#endif
vec4 l9_128=l9_70+l9_71;
vec4 l9_129;
#if (Tweak_N6Layout==2)
{
bool l9_130=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_131=l9_1.x;
sc_SoftwareWrapEarly(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_132=l9_131;
float l9_133=l9_1.y;
sc_SoftwareWrapEarly(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_134=l9_133;
vec2 l9_135;
float l9_136;
...
{
l9_137=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_137=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_138=l9_132;
float l9_139=1.0;
sc_ClampUV(l9_138,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_137,l9_139);
float l9_140=l9_138;
float l9_141=l9_139;
bool l9_142;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_142=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_142=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_143=l9_134;
float l9_144=l9_141;
sc_ClampUV(l9_143,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_142,l9_144);
l9_136=l9_144;
...
#endif
vec2 l9_145=sc_TransformUV(l9_135,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_146=l9_145.x;
float l9_147=l9_136;
sc_SoftwareWrapLate(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_130,l9_147);
float l9_148=l9_145.y;
float l9_149=l9_147;
sc_SoftwareWrapLate(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_130,l9_149);
float l9_150=l9_149;
vec3 l9_151=sc_SamplingCoordsViewToGlobal(vec2(l9_146,l9_148),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_152=texture(Tweak_N6ArrSC,l9_151,0.0);
vec4 l9_153;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_153=mix(Tweak_N6BorderColor,l9_152,vec4(l9_150));
}
#else
{
l9_153=l9_152;
...
#else
{
bool l9_154=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_155=l9_1.x;
sc_SoftwareWrapEarly(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_156=l9_155;
float l9_157=l9_1.y;
sc_SoftwareWrapEarly(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_158=l9_157;
vec2 l9_159;
float l9_160;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_161=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_161=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_162=l9_156;
float l9_163=1.0;
sc_ClampUV(l9_162,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_161,l9_163);
float l9_164=l9_162;
float l9_165=l9_163;
bool l9_166;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_166=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_166=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_167=l9_158;
float l9_168=l9_165;
sc_ClampUV(l9_167,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_166,l9_168);
l9_160=l9_168;
...
#endif
vec2 l9_169=sc_TransformUV(l9_159,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_170=l9_169.x;
float l9_171=l9_160;
sc_SoftwareWrapLate(l9_170,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_154,l9_171);
float l9_172=l9_169.y;
float l9_173=l9_171;
sc_SoftwareWrapLate(l9_172,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_154,l9_173);
float l9_174=l9_173;
vec3 l9_175=sc_SamplingCoordsViewToGlobal(vec2(l9_170,l9_172),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_176=texture(Tweak_N6,l9_175.xy,0.0);
vec4 l9_177;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_177=mix(Tweak_N6BorderColor,l9_176,vec4(l9_174));
}
#else
{
l9_177=l9_176;
...
#endif
vec3 l9_178=l9_128.xyz;
vec3 l9_179=mix(l9_178,(l9_129.xyz*l9_178).xyz,vec3(l9_129.w));
vec4 l9_180=vec4(l9_179.x,l9_179.y,l9_179.z,vec4(0.0).w);
l9_180.w=Port_Value2_N053;
...
{
l9_185=clamp(Port_Value2_N053*2.0,0.0,1.0);
}
#else
{
float l9_186;
...
{
l9_186=clamp(dot(l9_180.xyz,vec3(Port_Value2_N053)),0.0,1.0);
}
#else
{
float l9_187;
...
{
l9_188=(1.0-dot(l9_180.xyz,vec3(0.33333001)))*Port_Value2_N053;
}
#else
{
float l9_189;
...
{
l9_189=(1.0-clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N053;
}
#else
{
float l9_190;
...
{
l9_190=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_191;
#if (sc_BlendMode_Add)
{
l9_191=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_192;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_192=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_193;
...
{
l9_193=dot(l9_180.xyz,vec3(0.33333001))*Port_Value2_N053;
}
#else
{
float l9_194;
#if (sc_BlendMode_Min)
{
l9_194=1.0-clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_195;
#if (sc_BlendMode_Max)
{
l9_195=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_195=1.0;
...
#endif
l9_183=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_180.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_184);
}
#else
{
vec4 l9_196;
...
#if (sc_FramebufferFetch)
{
l9_198=sc_readFragData0_Platform();
}
#else
{
...
{
l9_200=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_199,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_200=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_199,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_198=l9_200;
}
#endif
vec3 l9_201=mix(l9_198.xyz,definedBlend(l9_198.xyz,l9_180.xyz).xyz,vec3(Port_Value2_N053));
vec4 l9_202=vec4(l9_201.x,l9_201.y,l9_201.z,vec4(0.0).w);
l9_202.w=1.0;
l9_197=l9_202;
}
#else
...
#if (sc_Voxelization)
{
l9_203=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_204;
#if (sc_OutputBounds)
{
float l9_205=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_204=vec4(l9_205,1.0-l9_205,1.0,1.0);
}
#else
{
vec4 l9_206;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_206=vec4(mix(vec3(1.0),l9_180.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_207;
...
{
l9_208=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_208=Port_Value2_N053;
}
#endif
l9_207=vec4(l9_180.xyz*l9_208,l9_208);
}
#else
{
l9_207=l9_180;
...
vec4 l9_211=sc_OutputMotionVectorIfNeeded(max(l9_209,vec4(0.0)));
