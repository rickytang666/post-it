...
varColor=color;
float l9_7=snoise(vec2(floor((sc_Time.x*Port_Multiplier_N012)*10000.0)*9.9999997e-05)*(Port_Scale_N013*0.5));
float l9_8=((glow_scale*Port_Input1_N021)/(Port_Input1_N019+1.234e-06))+Port_Input1_N020;
vec3 l9_9;
vec3 l9_10;
vec3 l9_11;
if (l9_4)
...
l9_11=varTangent.xyz;
l9_10=varNormalAndMotion.xyz;
l9_9=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3(((((floor(((l9_7*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N015)/((Port_RangeMaxA_N015-Port_RangeMinA_N015)+1e-06))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015))*vec3(Port_Value1_N018,((((Port_ValueIn_N035-vec4(Port_RangeMinA_N035))/vec4((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*((l9_8+Port_Input1_N017)-l9_8))+vec4(l9_8)).x,Port_Value3_N018),1.0)).xyz;
}
...
float l9_1=clamp(smoothstep(Port_Input0_N003,Port_Input1_N003,distance(((varTex01.xy-Port_Center_N006)*Port_Scale_N006)+Port_Center_N006,Port_Input1_N000)),0.0,1.0);
vec4 l9_2;
...
vec4 l9_8=(l9_2*vec4(smoothstep(Port_Input0_N009,Port_Input1_N009,varTex01.y)))*vec4(smoothstep(Port_Input0_N016,Port_Input1_N016,varTex01.y));
...
vec4 l9_39=sc_OutputMotionVectorIfNeeded(max(l9_37,vec4(0.0)));
