...
varColor=color;
vec3 l9_5=varNormal;
float l9_6=snoise(vec2(floor((sc_Time.x*Port_Multiplier_N012)*10000.0)*9.9999997e-05)*(Port_Scale_N013*0.5));
float l9_7=((glow_scale*Port_Input1_N021)/(Port_Input1_N019+1.234e-06))+Port_Input1_N020;
vec3 l9_8;
vec3 l9_9;
vec3 l9_10;
if (l9_2)
...
l9_10=varTangent.xyz;
l9_9=l9_5;
l9_8=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(((((floor(((l9_6*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N015)/((Port_RangeMaxA_N015-Port_RangeMinA_N015)+1e-06))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015))*vec3(Port_Value1_N018,((((Port_ValueIn_N035-vec4(Port_RangeMinA_N035))/vec4((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*((l9_7+Port_Input1_N017)-l9_7))+vec4(l9_7)).x,Port_Value3_N018),1.0)).xyz;
}
varPos=l9_8;
