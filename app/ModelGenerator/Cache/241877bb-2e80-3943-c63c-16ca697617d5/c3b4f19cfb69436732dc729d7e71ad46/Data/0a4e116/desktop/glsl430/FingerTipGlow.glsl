...
//sampler sampler glowTextureSmpSC 0:21
...
//texture texture2D glowTexture 0:3:0:21
...
//texture texture2DArray glowTextureArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glowTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glowTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int glowTextureLayout 80 0
...
uniform vec4 pokeGlowColor;
uniform vec4 pinchGlowColor;
uniform float pokePinchBlend;
uniform float pokeGlowBrightness;
uniform float pinchGlowBrightness;
...
uniform sampler2DArray glowTextureArrSC;
...
vec4 l9_3;
#if (glowTextureLayout==2)
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glowTexture)!=0));
float l9_5=l9_1.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x);
float l9_6=l9_5;
float l9_7=l9_1.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,glowTextureUvMinMax.x,glowTextureUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,glowTextureUvMinMax.y,glowTextureUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_glowTexture)!=0),glowTextureTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),glowTextureLayout,glowTextureGetStereoViewIndex());
vec4 l9_26=texture(glowTextureArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_27=mix(glowTextureBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glowTexture)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_glowTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,glowTextureUvMinMax.x,glowTextureUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,glowTextureUvMinMax.y,glowTextureUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_glowTexture)!=0),glowTextureTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),glowTextureLayout,glowTextureGetStereoViewIndex());
vec4 l9_50=texture(glowTexture,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_51=mix(glowTextureBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
vec4 l9_52=mix(pokeGlowColor,pinchGlowColor,vec4(pokePinchBlend));
vec3 l9_53=vec3(l9_3.xyz)*vec3(l9_52.xyz);
float l9_54=(l9_52.w*l9_3.w)*mix(pokeGlowBrightness,pinchGlowBrightness,pokePinchBlend);
vec4 l9_55=vec4(l9_53.x,l9_53.y,l9_53.z,vec4(0.0).w);
l9_55.w=l9_54;
...
#endif
sc_writeFragData0Internal(max(l9_56,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_58;
...
{
l9_61=clamp(dot(l9_55.xyz,vec3(l9_54)),0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_63=(1.0-dot(l9_55.xyz,vec3(0.33333001)))*l9_54;
}
#else
{
float l9_64;
...
{
l9_64=(1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0))*l9_54;
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_54;
}
#else
{
float l9_66;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_67=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_54;
}
#else
{
float l9_68;
...
{
l9_68=dot(l9_55.xyz,vec3(0.33333001))*l9_54;
}
#else
{
float l9_69;
...
#if (sc_FramebufferFetch)
{
l9_73=sc_readFragData0_Platform();
}
#else
{
...
#endif
vec3 l9_76=mix(l9_73.xyz,definedBlend(l9_73.xyz,l9_55.xyz).xyz,vec3(l9_54));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_55.xyz,vec3(l9_54)),l9_54);
}
#else
{
vec4 l9_82;
...
vec4 l9_86=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_84,vec4(0.0)));
