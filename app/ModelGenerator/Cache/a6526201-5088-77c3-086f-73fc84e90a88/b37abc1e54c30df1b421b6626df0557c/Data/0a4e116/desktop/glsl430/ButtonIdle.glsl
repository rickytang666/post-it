...
vec2 l9_69=l9_5*Port_Input1_N009;
float l9_70=clamp(length(l9_69+Port_Input2_N009),0.0,1.0);
vec4 l9_71;
if (l9_70<Port_Position1_N007)
{
l9_71=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_70/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_72;
if (l9_70<Port_Position2_N007)
{
l9_72=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_70-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_72=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_70-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_71=l9_72;
}
...
float l9_78=clamp(l9_71.x,0.0,1.0);
float l9_79;
if (l9_78<Port_Position1_N018)
{
l9_79=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_78/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_80;
if (l9_78<Port_Position2_N018)
{
l9_80=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_78-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_81;
if (l9_78<Port_Position3_N018)
{
l9_81=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_78-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_81=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_78-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_80=l9_81;
}
l9_79=l9_80;
}
vec4 l9_82=vec4(l9_71.x,l9_71.y,l9_71.z,vec4(0.0).w);
l9_82.w=l9_79;
vec2 l9_83=l9_6-Port_Center_N002;
vec2 l9_84=(l9_83*Port_Scale_N002)+Port_Center_N002;
vec4 l9_85;
#if (iconLayout==2)
{
bool l9_86=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_87=l9_84.x;
sc_SoftwareWrapEarly(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_88=l9_87;
float l9_89=l9_84.y;
sc_SoftwareWrapEarly(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_90=l9_89;
vec2 l9_91;
float l9_92;
...
{
l9_93=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_93=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_94=l9_88;
float l9_95=1.0;
sc_ClampUV(l9_94,iconUvMinMax.x,iconUvMinMax.z,l9_93,l9_95);
float l9_96=l9_94;
float l9_97=l9_95;
bool l9_98;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_98=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_98=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_99=l9_90;
float l9_100=l9_97;
sc_ClampUV(l9_99,iconUvMinMax.y,iconUvMinMax.w,l9_98,l9_100);
l9_92=l9_100;
...
#endif
vec2 l9_101=sc_TransformUV(l9_91,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_102=l9_101.x;
float l9_103=l9_92;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_86,l9_103);
float l9_104=l9_101.y;
float l9_105=l9_103;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_86,l9_105);
float l9_106=l9_105;
vec3 l9_107=sc_SamplingCoordsViewToGlobal(vec2(l9_102,l9_104),iconLayout,iconGetStereoViewIndex());
vec4 l9_108=texture(iconArrSC,l9_107,0.0);
vec4 l9_109;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_109=mix(iconBorderColor,l9_108,vec4(l9_106));
}
#else
{
l9_109=l9_108;
...
#else
{
bool l9_110=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_111=l9_84.x;
sc_SoftwareWrapEarly(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_112=l9_111;
float l9_113=l9_84.y;
sc_SoftwareWrapEarly(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_114=l9_113;
vec2 l9_115;
float l9_116;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_117=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_117=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_118=l9_112;
float l9_119=1.0;
sc_ClampUV(l9_118,iconUvMinMax.x,iconUvMinMax.z,l9_117,l9_119);
float l9_120=l9_118;
float l9_121=l9_119;
bool l9_122;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_122=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_122=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_123=l9_114;
float l9_124=l9_121;
sc_ClampUV(l9_123,iconUvMinMax.y,iconUvMinMax.w,l9_122,l9_124);
l9_116=l9_124;
...
#endif
vec2 l9_125=sc_TransformUV(l9_115,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_126=l9_125.x;
float l9_127=l9_116;
sc_SoftwareWrapLate(l9_126,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_110,l9_127);
float l9_128=l9_125.y;
float l9_129=l9_127;
sc_SoftwareWrapLate(l9_128,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_110,l9_129);
float l9_130=l9_129;
vec3 l9_131=sc_SamplingCoordsViewToGlobal(vec2(l9_126,l9_128),iconLayout,iconGetStereoViewIndex());
vec4 l9_132=texture(icon,l9_131.xy,0.0);
vec4 l9_133;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_133=mix(iconBorderColor,l9_132,vec4(l9_130));
}
#else
{
l9_133=l9_132;
...
#if (iconLayout==2)
{
bool l9_136=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_137=l9_84.x;
sc_SoftwareWrapEarly(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_138=l9_137;
float l9_139=l9_84.y;
sc_SoftwareWrapEarly(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_140=l9_139;
vec2 l9_141;
float l9_142;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_143=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_143=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_144=l9_138;
float l9_145=1.0;
sc_ClampUV(l9_144,iconUvMinMax.x,iconUvMinMax.z,l9_143,l9_145);
float l9_146=l9_144;
float l9_147=l9_145;
bool l9_148;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_148=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_148=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_149=l9_140;
float l9_150=l9_147;
sc_ClampUV(l9_149,iconUvMinMax.y,iconUvMinMax.w,l9_148,l9_150);
l9_142=l9_150;
...
#endif
vec2 l9_151=sc_TransformUV(l9_141,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_152=l9_151.x;
float l9_153=l9_142;
sc_SoftwareWrapLate(l9_152,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_136,l9_153);
float l9_154=l9_151.y;
float l9_155=l9_153;
sc_SoftwareWrapLate(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_136,l9_155);
float l9_156=l9_155;
vec3 l9_157=sc_SamplingCoordsViewToGlobal(vec2(l9_152,l9_154),iconLayout,iconGetStereoViewIndex());
vec4 l9_158=texture(iconArrSC,l9_157,0.0);
vec4 l9_159;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_159=mix(iconBorderColor,l9_158,vec4(l9_156));
}
#else
{
l9_159=l9_158;
...
#else
{
bool l9_160=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_161=l9_84.x;
sc_SoftwareWrapEarly(l9_161,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_162=l9_161;
float l9_163=l9_84.y;
sc_SoftwareWrapEarly(l9_163,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_164=l9_163;
vec2 l9_165;
float l9_166;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_167=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_168=l9_162;
float l9_169=1.0;
sc_ClampUV(l9_168,iconUvMinMax.x,iconUvMinMax.z,l9_167,l9_169);
float l9_170=l9_168;
float l9_171=l9_169;
bool l9_172;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_172=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_172=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_173=l9_164;
float l9_174=l9_171;
sc_ClampUV(l9_173,iconUvMinMax.y,iconUvMinMax.w,l9_172,l9_174);
l9_166=l9_174;
...
#endif
vec2 l9_175=sc_TransformUV(l9_165,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_176=l9_175.x;
float l9_177=l9_166;
sc_SoftwareWrapLate(l9_176,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_160,l9_177);
float l9_178=l9_175.y;
float l9_179=l9_177;
sc_SoftwareWrapLate(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_160,l9_179);
float l9_180=l9_179;
vec3 l9_181=sc_SamplingCoordsViewToGlobal(vec2(l9_176,l9_178),iconLayout,iconGetStereoViewIndex());
vec4 l9_182=texture(icon,l9_181.xy,0.0);
vec4 l9_183;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_183=mix(iconBorderColor,l9_182,vec4(l9_180));
}
#else
{
l9_183=l9_182;
...
{
l9_134=Port_Input2_N003;
}
vec4 l9_184=vec4(l9_134);
vec4 l9_185=mix(l9_68+l9_82,l9_85,l9_184);
float l9_186=l9_185.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_186<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_186<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_187,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_189;
...
{
l9_191=clamp(l9_186*2.0,0.0,1.0);
}
#else
{
float l9_192;
...
{
l9_192=clamp(dot(l9_185.xyz,vec3(l9_186)),0.0,1.0);
}
#else
{
float l9_193;
...
{
l9_194=(1.0-dot(l9_185.xyz,vec3(0.33333001)))*l9_186;
}
#else
{
float l9_195;
...
{
l9_195=(1.0-clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0))*l9_186;
}
#else
{
float l9_196;
...
{
l9_196=clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0)*l9_186;
}
#else
{
float l9_197;
#if (sc_BlendMode_Add)
{
l9_197=clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_198;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_198=clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0)*l9_186;
}
#else
{
float l9_199;
...
{
l9_199=dot(l9_185.xyz,vec3(0.33333001))*l9_186;
}
#else
{
float l9_200;
#if (sc_BlendMode_Min)
{
l9_200=1.0-clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_201;
#if (sc_BlendMode_Max)
{
l9_201=clamp(dot(l9_185.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_201=1.0;
...
#endif
l9_189=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_185.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_190);
}
#else
{
vec4 l9_202;
...
#if (sc_FramebufferFetch)
{
l9_204=sc_readFragData0_Platform();
}
#else
{
...
{
l9_206=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_205,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_206=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_205,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_204=l9_206;
}
#endif
vec3 l9_207=mix(l9_204.xyz,definedBlend(l9_204.xyz,l9_185.xyz).xyz,vec3(l9_186));
...
#if (sc_Voxelization)
{
l9_209=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_210;
#if (sc_OutputBounds)
{
float l9_211=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_210=vec4(l9_211,1.0-l9_211,1.0,1.0);
}
#else
{
vec4 l9_212;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_212=vec4(mix(vec3(1.0),l9_185.xyz,vec3(l9_186)),l9_186);
}
#else
{
vec4 l9_213;
...
#endif
l9_213=vec4(l9_185.xyz*l9_214,l9_214);
}
#else
{
l9_213=l9_185;
...
vec4 l9_217=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_215,vec4(0.0)));
vec4 l9_218=clamp(l9_217,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_219=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_219-0.0039215689)),min(1.0,l9_219+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_221=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_220).xy);
float l9_222=packValue(l9_221);
int l9_229=int(l9_218.w*255.0);
float l9_230=packValue(l9_229);
sc_writeFragData0Internal(vec4(packValue(l9_221),packValue(l9_221),packValue(l9_221),packValue(l9_221)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_222,packValue(l9_221),packValue(l9_221),packValue(l9_221)));
sc_writeFragData2(vec4(l9_230,packValue(l9_229),packValue(l9_229),packValue(l9_229)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_233=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_233).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_238==0)
{
l9_241=texture(sc_OITAlpha0,l9_233);
l9_240=texture(sc_OITDepthLow0,l9_233);
l9_239=texture(sc_OITDepthHigh0,l9_233);
}
else
{
l9_241=vec4(0.0);
...
if (l9_238==1)
{
l9_244=texture(sc_OITAlpha1,l9_233);
l9_243=texture(sc_OITDepthLow1,l9_233);
l9_242=texture(sc_OITDepthHigh1,l9_233);
}
else
{
l9_244=l9_241;
...
if (any(notEqual(l9_242,vec4(0.0)))||any(notEqual(l9_243,vec4(0.0))))
{
int l9_245[8]=l9_234;
unpackValues(l9_242.w,l9_238,l9_245);
unpackValues(l9_242.z,l9_238,l9_245);
unpackValues(l9_242.y,l9_238,l9_245);
unpackValues(l9_242.x,l9_238,l9_245);
unpackValues(l9_243.w,l9_238,l9_245);
unpackValues(l9_243.z,l9_238,l9_245);
unpackValues(l9_243.y,l9_238,l9_245);
unpackValues(l9_243.x,l9_238,l9_245);
int l9_254[8]=l9_235;
unpackValues(l9_244.w,l9_238,l9_254);
unpackValues(l9_244.z,l9_238,l9_254);
unpackValues(l9_244.y,l9_238,l9_254);
unpackValues(l9_244.x,l9_238,l9_254);
}
l9_238++;
continue;
}
...
vec4 l9_259=texture(sc_OITFilteredDepthBoundsTexture,l9_233);
vec2 l9_260=l9_259.xy;
int l9_261;
#if (sc_SkinBonesCount>0)
{
l9_261=encodeDepth(((1.0-l9_259.x)*1000.0)+getDepthOrderingEpsilon(),l9_260);
}
#else
{
l9_261=0;
...
#endif
int l9_262=encodeDepth(viewSpaceDepth(),l9_260);
vec4 l9_263;
l9_263=l9_218*l9_218.w;
vec4 l9_264;
int l9_265=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_265<8)
{
int l9_266=l9_234[l9_265];
int l9_267=l9_262-l9_261;
bool l9_268=l9_266<l9_267;
bool l9_269;
if (l9_268)
{
l9_269=l9_234[l9_265]>0;
}
else
{
l9_269=l9_268;
...
if (l9_269)
{
vec3 l9_270=l9_263.xyz*(1.0-(float(l9_235[l9_265])/255.0));
l9_264=vec4(l9_270.x,l9_270.y,l9_270.z,l9_263.w);
}
else
{
l9_264=l9_263;
