...
#endif
sc_writeFragData0Internal(max(l9_85,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_87;
...
#if (sc_FramebufferFetch)
{
l9_102=sc_readFragData0_Platform();
}
#else
{
...
vec4 l9_115=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_113,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_117-0.0039215689)),min(1.0,l9_117+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_119),packValue(l9_119),packValue(l9_119),packValue(l9_119)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_120,packValue(l9_119),packValue(l9_119),packValue(l9_119)));
sc_writeFragData2(vec4(l9_128,packValue(l9_127),packValue(l9_127),packValue(l9_127)));
