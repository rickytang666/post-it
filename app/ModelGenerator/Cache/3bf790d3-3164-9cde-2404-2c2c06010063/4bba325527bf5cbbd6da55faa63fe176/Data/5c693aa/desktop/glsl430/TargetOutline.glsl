...
float l9_9=float(l9_0);
ssGlobals l9_10=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_8,varNormalAndMotion.xyz,normalize((sc_ModelMatrixInverse*vec4(varNormalAndMotion.xyz,0.0)).xyz),l9_9);
vec3 param_3;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_3,l9_10);
vec3 l9_11=param_3;
...
float l9_15;
if ((float(l9_9>Port_Input1_N013)*1.0)!=0.0)
{
l9_15=abs(lineWeight)*Port_Input1_N017;
}
else
{
l9_15=abs(lineWeight);
}
vec3 l9_16=vec3(l9_15);
vec3 param_8;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_8,l9_10);
vec3 l9_17=param_8;
vec3 l9_18;
vec3 l9_19;
vec3 l9_20;
if (l9_5)
{
l9_20=varTangent.xyz;
l9_19=varNormalAndMotion.xyz;
l9_18=varPosAndMotion.xyz;
}
else
{
l9_20=varTangent.xyz;
l9_19=l9_17;
l9_18=(sc_ModelMatrix*vec4(l9_8+(l9_14*l9_16),1.0)).xyz;
}
varPosAndMotion=vec4(l9_18.x,l9_18.y,l9_18.z,varPosAndMotion.w);
vec3 l9_21=normalize(l9_19);
varNormalAndMotion=vec4(l9_21.x,l9_21.y,l9_21.z,varNormalAndMotion.w);
vec3 l9_22=normalize(l9_20);
varTangent=vec4(l9_22.x,l9_22.y,l9_22.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_23=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_24;
#if (sc_RenderingSpace==2)
{
l9_24=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_25;
#if (sc_RenderingSpace==1)
{
l9_25=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_25=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_27=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_28;
#if (sc_RenderingSpace==2)
{
l9_28=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_29;
#if (sc_RenderingSpace==1)
{
l9_29=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
l9_29=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_30=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_30=l9_1.position;
...
#endif
vec4 l9_31=sc_ProjectorMatrix*l9_30;
varShadowTex=((l9_31.xy/vec2(l9_31.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_32;
...
{
vec4 l9_34=l9_26;
l9_34.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_26.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_26.w;
l9_33=l9_34;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_36=l9_32.xy+(sc_TAAJitterOffset*l9_32.w);
l9_35=vec4(l9_36.x,l9_36.y,l9_32.z,l9_32.w);
}
#else
{
l9_35=l9_32;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_37=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_6,l9_1.texture1);
sc_BlendVertex(l9_37);
sc_SkinVertex(l9_37);
int l9_38=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_39=int(voxelization_params_0.w);
vec4 l9_40=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_37.position).xyz+vec3(float(l9_38%l9_39)*voxelization_params_0.y,float(l9_38/l9_39)*voxelization_params_0.y,(float(l9_38)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_40.w=1.0;
varScreenPos=l9_40;
sc_SetClipPosition(l9_40*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_41=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_6,l9_1.texture1);
sc_BlendVertex(l9_41);
sc_SkinVertex(l9_41);
vec2 l9_42=((l9_41.position.xy/vec2(l9_41.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_42.x,l9_42.y,varTex01.z,varTex01.w);
vec4 l9_43=sc_ModelMatrixVoxelization*l9_41.position;
vec3 l9_44=l9_43.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_44.x,l9_44.y,l9_44.z,varPosAndMotion.w);
vec3 l9_45=normalize(l9_41.normal);
varNormalAndMotion=vec4(l9_45.x,l9_45.y,l9_45.z,varNormalAndMotion.w);
vec4 l9_46=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_44.x,l9_44.y,l9_44.z,l9_43.w);
vec4 l9_47=vec4(l9_46.x,l9_46.y,l9_46.z,vec4(0.0).w);
l9_47.w=1.0;
varScreenPos=l9_47;
sc_SetClipPosition(l9_47*1.0);
}
#endif
}
#endif
Interpolator_gInstanceID=l9_9;
vec4 l9_48=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_49=vec4(l9_48.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_50=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_49;
vec4 l9_51=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_49).xyz,1.0);
vec2 l9_52=((l9_50.xy/vec2(l9_50.w)).xy-(l9_51.xy/vec2(l9_51.w)).xy)*0.5;
varPosAndMotion.w=l9_52.x;
varNormalAndMotion.w=l9_52.y;
}
#endif
}
#endif
...
vec4 l9_32=sc_OutputMotionVectorIfNeeded(max(l9_30,vec4(0.0)));
