...
vec4 l9_174;
if (l9_173<Port_Position1_N030)
{
l9_174=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_173/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_173<Port_Position2_N030)
{
l9_175=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_173-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_176;
if (l9_173<Port_Position3_N030)
{
l9_176=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_173-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_177;
if (l9_173<Port_Position4_N030)
{
l9_177=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_173-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_177=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_173-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_176=l9_177;
}
l9_175=l9_176;
...
vec3 l9_178=-l9_5;
vec4 l9_179=mix(l9_174,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(l9_178,l9_12*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_180=l9_117+l9_179;
float l9_181=l9_180.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_181<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_181<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_182,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_184;
...
{
l9_186=clamp(l9_181*2.0,0.0,1.0);
}
#else
{
float l9_187;
...
{
l9_187=clamp(dot(l9_180.xyz,vec3(l9_181)),0.0,1.0);
}
#else
{
float l9_188;
...
{
l9_189=(1.0-dot(l9_180.xyz,vec3(0.33333001)))*l9_181;
}
#else
{
float l9_190;
...
{
l9_190=(1.0-clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0))*l9_181;
}
#else
{
float l9_191;
...
{
l9_191=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0)*l9_181;
}
#else
{
float l9_192;
#if (sc_BlendMode_Add)
{
l9_192=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_193;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_193=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0)*l9_181;
}
#else
{
float l9_194;
...
{
l9_194=dot(l9_180.xyz,vec3(0.33333001))*l9_181;
}
#else
{
float l9_195;
#if (sc_BlendMode_Min)
{
l9_195=1.0-clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_196;
#if (sc_BlendMode_Max)
{
l9_196=clamp(dot(l9_180.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_196=1.0;
...
#endif
l9_184=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_180.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_185);
}
#else
{
vec4 l9_197;
...
#if (sc_FramebufferFetch)
{
l9_199=sc_readFragData0_Platform();
}
#else
{
...
{
l9_201=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_200,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_201=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_200,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_199=l9_201;
}
#endif
vec3 l9_202=mix(l9_199.xyz,definedBlend(l9_199.xyz,l9_180.xyz).xyz,vec3(l9_181));
...
#if (sc_Voxelization)
{
l9_204=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_205;
#if (sc_OutputBounds)
{
float l9_206=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_205=vec4(l9_206,1.0-l9_206,1.0,1.0);
}
#else
{
vec4 l9_207;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_207=vec4(mix(vec3(1.0),l9_180.xyz,vec3(l9_181)),l9_181);
}
#else
{
vec4 l9_208;
...
#endif
l9_208=vec4(l9_180.xyz*l9_209,l9_209);
}
#else
{
l9_208=l9_180;
...
vec4 l9_212=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_210,vec4(0.0)));
vec4 l9_213=clamp(l9_212,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_214=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_214-0.0039215689)),min(1.0,l9_214+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_215=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_215).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_216=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_215).xy);
float l9_217=packValue(l9_216);
int l9_224=int(l9_213.w*255.0);
float l9_225=packValue(l9_224);
sc_writeFragData0Internal(vec4(packValue(l9_216),packValue(l9_216),packValue(l9_216),packValue(l9_216)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_217,packValue(l9_216),packValue(l9_216),packValue(l9_216)));
sc_writeFragData2(vec4(l9_225,packValue(l9_224),packValue(l9_224),packValue(l9_224)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_228=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_228).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_233==0)
{
l9_236=texture(sc_OITAlpha0,l9_228);
l9_235=texture(sc_OITDepthLow0,l9_228);
l9_234=texture(sc_OITDepthHigh0,l9_228);
}
else
{
l9_236=vec4(0.0);
...
if (l9_233==1)
{
l9_239=texture(sc_OITAlpha1,l9_228);
l9_238=texture(sc_OITDepthLow1,l9_228);
l9_237=texture(sc_OITDepthHigh1,l9_228);
}
else
{
l9_239=l9_236;
...
if (any(notEqual(l9_237,vec4(0.0)))||any(notEqual(l9_238,vec4(0.0))))
{
int l9_240[8]=l9_229;
unpackValues(l9_237.w,l9_233,l9_240);
unpackValues(l9_237.z,l9_233,l9_240);
unpackValues(l9_237.y,l9_233,l9_240);
unpackValues(l9_237.x,l9_233,l9_240);
unpackValues(l9_238.w,l9_233,l9_240);
unpackValues(l9_238.z,l9_233,l9_240);
unpackValues(l9_238.y,l9_233,l9_240);
unpackValues(l9_238.x,l9_233,l9_240);
int l9_249[8]=l9_230;
unpackValues(l9_239.w,l9_233,l9_249);
unpackValues(l9_239.z,l9_233,l9_249);
unpackValues(l9_239.y,l9_233,l9_249);
unpackValues(l9_239.x,l9_233,l9_249);
}
l9_233++;
continue;
}
...
vec4 l9_254=texture(sc_OITFilteredDepthBoundsTexture,l9_228);
vec2 l9_255=l9_254.xy;
int l9_256;
#if (sc_SkinBonesCount>0)
{
l9_256=encodeDepth(((1.0-l9_254.x)*1000.0)+getDepthOrderingEpsilon(),l9_255);
}
#else
{
l9_256=0;
...
#endif
int l9_257=encodeDepth(viewSpaceDepth(),l9_255);
vec4 l9_258;
l9_258=l9_213*l9_213.w;
vec4 l9_259;
int l9_260=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_260<8)
{
int l9_261=l9_229[l9_260];
int l9_262=l9_257-l9_256;
bool l9_263=l9_261<l9_262;
bool l9_264;
if (l9_263)
{
l9_264=l9_229[l9_260]>0;
}
else
{
l9_264=l9_263;
...
if (l9_264)
{
vec3 l9_265=l9_258.xyz*(1.0-(float(l9_230[l9_260])/255.0));
l9_259=vec4(l9_265.x,l9_265.y,l9_265.z,l9_258.w);
}
else
{
l9_259=l9_258;
...
sc_writeFragData0Internal(l9_258,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
