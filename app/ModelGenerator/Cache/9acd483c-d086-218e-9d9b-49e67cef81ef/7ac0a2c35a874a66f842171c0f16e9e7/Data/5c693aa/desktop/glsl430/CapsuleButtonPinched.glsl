...
vec4 l9_174;
if (l9_173<Port_Position1_N067)
{
l9_174=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_173/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_173<Port_Position2_N067)
{
l9_175=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_173-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_176;
if (l9_173<Port_Position3_N067)
{
l9_176=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_173-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_176=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_173-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_175=l9_176;
}
l9_174=l9_175;
...
vec3 l9_177=-l9_5;
vec4 l9_178=mix(l9_174,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_177,l9_12*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_179=l9_117+l9_178;
...
#endif
vec3 l9_201=mix(l9_198.xyz,definedBlend(l9_198.xyz,l9_179.xyz).xyz,vec3(l9_180));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_206=vec4(mix(vec3(1.0),l9_179.xyz,vec3(l9_180)),l9_180);
}
#else
{
vec4 l9_207;
...
#endif
l9_207=vec4(l9_179.xyz*l9_208,l9_208);
}
#else
{
l9_207=l9_179;
