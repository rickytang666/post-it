...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),normalize(sc_Camera.position-varPos),varPos,varColor,varPackedTex.xy,varPackedTex.zw,l9_1,l9_3,l9_4,l9_5);
...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_6);
vec4 l9_9=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_6);
vec4 l9_10=param_8;
float l9_11;
...
#endif
float l9_68=(l9_9*l9_10).w*l9_11;
...
{
vec2 l9_74;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_6);
l9_73=l9_74;
}
#else
{
...
{
vec2 l9_76;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_76,l9_6);
l9_75=l9_76;
}
#else
{
...
{
vec2 l9_130;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_130,l9_6);
l9_129=l9_130;
}
#else
{
...
{
vec2 l9_132;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_132,l9_6);
l9_131=l9_132;
}
#else
{
...
vec3 l9_185=mat3(l9_3,l9_5,l9_4)*normalize((l9_182*dot(l9_182,l9_184))-(l9_184*l9_182.z));
...
#endif
uvec3 l9_192=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_192.x,l9_192.y,l9_192.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_193=l9_190/vec3(dot(abs(l9_190),vec3(1.0)));
vec2 l9_194=vec2(clamp(-l9_193.z,0.0,1.0));
vec2 l9_195=l9_193.xy;
uint l9_196=packHalf2x16(l9_195+mix(-l9_194,l9_194,step(vec2(0.0),l9_195)));
uvec2 l9_197=uvec2(l9_196&65535u,l9_196>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_197.x,l9_197.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
...
#endif
vec4 param_4;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_4,l9_18);
vec4 l9_22=param_4;
vec4 param_9;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_9,l9_18);
vec4 l9_23=param_9;
float l9_24;
#if (ENABLE_OPACITY_TEX)
{
...
{
vec2 l9_28;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_28,l9_18);
l9_27=l9_28;
}
#else
{
...
{
vec2 l9_30;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_30,l9_18);
l9_29=l9_30;
}
#else
{
...
#if (opacityTexLayout==2)
{
bool l9_32=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_33=l9_25.x;
...
float l9_48=l9_47.x;
float l9_49=l9_38;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_32,l9_49);
float l9_50=l9_47.y;
float l9_51=l9_49;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_32,l9_51);
float l9_52=l9_51;
...
#else
{
bool l9_56=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_57=l9_25.x;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_58=l9_57;
float l9_59=l9_25.y;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_60=l9_59;
vec2 l9_61;
float l9_62;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_64=l9_58;
float l9_65=1.0;
sc_ClampUV(l9_64,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_63,l9_65);
float l9_66=l9_64;
float l9_67=l9_65;
bool l9_68;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_69=l9_60;
float l9_70=l9_67;
sc_ClampUV(l9_69,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_68,l9_70);
l9_62=l9_70;
...
#endif
vec2 l9_71=sc_TransformUV(l9_61,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_72=l9_71.x;
float l9_73=l9_62;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_56,l9_73);
float l9_74=l9_71.y;
float l9_75=l9_73;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_56,l9_75);
float l9_76=l9_75;
vec3 l9_77=sc_SamplingCoordsViewToGlobal(vec2(l9_72,l9_74),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_78=texture(opacityTex,l9_77.xy,0.0);
vec4 l9_79;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_79=mix(opacityTexBorderColor,l9_78,vec4(l9_76));
}
#else
{
l9_79=l9_78;
...
#else
{
l9_80=Port_Input2_N072;
}
#endif
float l9_81=(l9_22*l9_23).w*l9_24;
float l9_82=l9_81*l9_80;
vec3 l9_83;
#if (ENABLE_NORMALMAP)
{
mat3 l9_84=mat3(l9_3,l9_1,l9_2);
vec2 l9_85;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_85=l9_6;
...
{
vec2 l9_88;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_88,l9_18);
l9_87=l9_88;
}
#else
{
...
{
vec2 l9_90;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_90,l9_18);
l9_89=l9_90;
}
#else
{
...
#if (normalTexLayout==2)
{
bool l9_92=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_93=l9_85.x;
sc_SoftwareWrapEarly(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_94=l9_93;
float l9_95=l9_85.y;
sc_SoftwareWrapEarly(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_96=l9_95;
vec2 l9_97;
float l9_98;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_99=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_99=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_100=l9_94;
float l9_101=1.0;
sc_ClampUV(l9_100,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_99,l9_101);
float l9_102=l9_100;
float l9_103=l9_101;
bool l9_104;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_104=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_104=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_105=l9_96;
float l9_106=l9_103;
sc_ClampUV(l9_105,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_104,l9_106);
l9_98=l9_106;
...
#endif
vec2 l9_107=sc_TransformUV(l9_97,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_108=l9_107.x;
float l9_109=l9_98;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_92,l9_109);
float l9_110=l9_107.y;
float l9_111=l9_109;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_92,l9_111);
float l9_112=l9_111;
vec3 l9_113=sc_SamplingCoordsViewToGlobal(vec2(l9_108,l9_110),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_114=texture(normalTexArrSC,l9_113,0.0);
vec4 l9_115;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_115=mix(normalTexBorderColor,l9_114,vec4(l9_112));
}
#else
{
l9_115=l9_114;
...
#else
{
bool l9_116=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_117=l9_85.x;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_118=l9_117;
float l9_119=l9_85.y;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_120=l9_119;
vec2 l9_121;
float l9_122;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_124=l9_118;
float l9_125=1.0;
sc_ClampUV(l9_124,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_123,l9_125);
float l9_126=l9_124;
float l9_127=l9_125;
bool l9_128;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_128=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_129=l9_120;
float l9_130=l9_127;
sc_ClampUV(l9_129,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_128,l9_130);
l9_122=l9_130;
...
#endif
vec2 l9_131=sc_TransformUV(l9_121,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_132=l9_131.x;
float l9_133=l9_122;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_116,l9_133);
float l9_134=l9_131.y;
float l9_135=l9_133;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_116,l9_135);
float l9_136=l9_135;
vec3 l9_137=sc_SamplingCoordsViewToGlobal(vec2(l9_132,l9_134),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_138=texture(normalTex,l9_137.xy,0.0);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_139=mix(normalTexBorderColor,l9_138,vec4(l9_136));
}
#else
{
l9_139=l9_138;
...
{
vec2 l9_144;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_144,l9_18);
l9_143=l9_144;
}
#else
{
...
{
vec2 l9_146;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_146,l9_18);
l9_145=l9_146;
}
#else
{
...
#if (detailNormalTexLayout==2)
{
bool l9_148=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_149=l9_141.x;
sc_SoftwareWrapEarly(l9_149,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_150=l9_149;
float l9_151=l9_141.y;
sc_SoftwareWrapEarly(l9_151,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_152=l9_151;
vec2 l9_153;
float l9_154;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_155=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_155=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_156=l9_150;
float l9_157=1.0;
sc_ClampUV(l9_156,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_155,l9_157);
float l9_158=l9_156;
float l9_159=l9_157;
bool l9_160;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_160=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_160=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_161=l9_152;
float l9_162=l9_159;
sc_ClampUV(l9_161,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_160,l9_162);
l9_154=l9_162;
...
#endif
vec2 l9_163=sc_TransformUV(l9_153,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_164=l9_163.x;
float l9_165=l9_154;
sc_SoftwareWrapLate(l9_164,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_148,l9_165);
float l9_166=l9_163.y;
float l9_167=l9_165;
sc_SoftwareWrapLate(l9_166,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_148,l9_167);
float l9_168=l9_167;
vec3 l9_169=sc_SamplingCoordsViewToGlobal(vec2(l9_164,l9_166),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_170=texture(detailNormalTexArrSC,l9_169,0.0);
vec4 l9_171;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_171=mix(detailNormalTexBorderColor,l9_170,vec4(l9_168));
}
#else
{
l9_171=l9_170;
...
#else
{
bool l9_172=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_173=l9_141.x;
sc_SoftwareWrapEarly(l9_173,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_174=l9_173;
float l9_175=l9_141.y;
sc_SoftwareWrapEarly(l9_175,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_176=l9_175;
vec2 l9_177;
float l9_178;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_179=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
...
float l9_180=l9_174;
float l9_181=1.0;
sc_ClampUV(l9_180,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_179,l9_181);
float l9_182=l9_180;
float l9_183=l9_181;
bool l9_184;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_184=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_184=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_185=l9_176;
float l9_186=l9_183;
sc_ClampUV(l9_185,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_184,l9_186);
l9_178=l9_186;
...
#endif
vec2 l9_187=sc_TransformUV(l9_177,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_188=l9_187.x;
float l9_189=l9_178;
sc_SoftwareWrapLate(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_172,l9_189);
float l9_190=l9_187.y;
float l9_191=l9_189;
sc_SoftwareWrapLate(l9_190,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_172,l9_191);
float l9_192=l9_191;
vec3 l9_193=sc_SamplingCoordsViewToGlobal(vec2(l9_188,l9_190),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_194=texture(detailNormalTex,l9_193.xy,0.0);
vec4 l9_195;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_195=mix(detailNormalTexBorderColor,l9_194,vec4(l9_192));
}
#else
{
l9_195=l9_194;
...
#endif
l9_140=((l9_147.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_140=Port_Default_N113;
}
#endif
vec3 l9_196=mix(vec3(0.0,0.0,1.0),((l9_91.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_197=mix(vec3(0.0,0.0,1.0),l9_140,vec3(Port_Strength2_N200));
vec3 l9_198=l9_197*vec3(-1.0,-1.0,1.0);
vec3 l9_199=l9_84*normalize((l9_196*dot(l9_196,l9_198))-(l9_198*l9_196.z));
float l9_200=dot(l9_199,l9_199);
float l9_201;
if (l9_200>0.0)
{
...
#else
{
float l9_202=dot(l9_2,l9_2);
float l9_203;
if (l9_202>0.0)
{
l9_203=1.0/sqrt(l9_202);
}
else
{
l9_203=0.0;
...
#endif
float l9_205=clamp(l9_82,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_205<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_205<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_206=max(l9_19.xyz,vec3(0.0));
vec4 l9_207;
#if (sc_ProjectiveShadowsCaster)
{
l9_207=vec4(l9_206,l9_205);
}
#else
{
l9_207=ngsCalculateLighting(l9_206,l9_205,l9_204,l9_8,l9_9,Port_Emissive_N036,0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_208=max(l9_207,vec4(0.0));
float l9_209;
if ((float(l9_6.x<Level)*1.0)!=0.0)
{
l9_209=innerColorMultiplier;
}
else
{
l9_209=outerColorMultiplier;
}
vec4 l9_210=l9_208*vec4(l9_209+1.0);
float l9_211=l9_208.w;
vec4 l9_212=vec4(l9_210.x,l9_210.y,l9_210.z,vec4(0.0).w);
l9_212.w=l9_211;
if (l9_0)
{
vec4 l9_213;
...
#endif
sc_writeFragData0Internal(max(l9_213,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_215;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_217=clamp(l9_211*2.0,0.0,1.0);
}
#else
{
float l9_218;
...
{
l9_218=clamp(dot(l9_212.xyz,vec3(l9_211)),0.0,1.0);
}
#else
{
float l9_219;
...
#if (sc_BlendMode_Multiply)
{
l9_220=(1.0-dot(l9_212.xyz,vec3(0.33333001)))*l9_211;
}
#else
{
float l9_221;
...
{
l9_221=(1.0-clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0))*l9_211;
}
#else
{
float l9_222;
#if (sc_BlendMode_ColoredGlass)
{
l9_222=clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0)*l9_211;
}
#else
{
float l9_223;
#if (sc_BlendMode_Add)
{
l9_223=clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_224;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_224=clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0)*l9_211;
}
#else
{
float l9_225;
...
{
l9_225=dot(l9_212.xyz,vec3(0.33333001))*l9_211;
}
#else
{
float l9_226;
#if (sc_BlendMode_Min)
{
l9_226=1.0-clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_227;
#if (sc_BlendMode_Max)
{
l9_227=clamp(dot(l9_212.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_227=1.0;
...
#endif
l9_215=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_212.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_216);
}
#else
{
vec4 l9_228;
...
vec3 l9_231=mix(l9_230,definedBlend(l9_230,l9_212.xyz).xyz,vec3(l9_211));
...
#if (sc_Voxelization)
{
l9_233=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_234;
#if (sc_OutputBounds)
{
float l9_235=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_234=vec4(l9_235,1.0-l9_235,1.0,1.0);
}
#else
{
vec4 l9_236;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_236=vec4(mix(vec3(1.0),l9_212.xyz,vec3(l9_211)),l9_211);
}
#else
{
vec4 l9_237;
...
#endif
l9_237=vec4(l9_212.xyz*l9_238,l9_238);
}
#else
{
l9_237=l9_212;
...
vec4 l9_241=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_239,vec4(0.0)));
vec4 l9_242=clamp(l9_241,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_243=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_243-0.0039215689)),min(1.0,l9_243+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_244).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_245=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_244).xy);
float l9_246=packValue(l9_245);
int l9_253=int(l9_242.w*255.0);
float l9_254=packValue(l9_253);
sc_writeFragData0Internal(vec4(packValue(l9_245),packValue(l9_245),packValue(l9_245),packValue(l9_245)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_246,packValue(l9_245),packValue(l9_245),packValue(l9_245)));
sc_writeFragData2(vec4(l9_254,packValue(l9_253),packValue(l9_253),packValue(l9_253)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_257).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_262==0)
{
l9_265=texture(sc_OITAlpha0,l9_257);
l9_264=texture(sc_OITDepthLow0,l9_257);
l9_263=texture(sc_OITDepthHigh0,l9_257);
}
else
{
l9_265=vec4(0.0);
...
if (l9_262==1)
{
l9_268=texture(sc_OITAlpha1,l9_257);
l9_267=texture(sc_OITDepthLow1,l9_257);
l9_266=texture(sc_OITDepthHigh1,l9_257);
}
else
{
l9_268=l9_265;
...
if (any(notEqual(l9_266,vec4(0.0)))||any(notEqual(l9_267,vec4(0.0))))
{
int l9_269[8]=l9_258;
unpackValues(l9_266.w,l9_262,l9_269);
unpackValues(l9_266.z,l9_262,l9_269);
unpackValues(l9_266.y,l9_262,l9_269);
unpackValues(l9_266.x,l9_262,l9_269);
unpackValues(l9_267.w,l9_262,l9_269);
unpackValues(l9_267.z,l9_262,l9_269);
unpackValues(l9_267.y,l9_262,l9_269);
unpackValues(l9_267.x,l9_262,l9_269);
int l9_278[8]=l9_259;
unpackValues(l9_268.w,l9_262,l9_278);
unpackValues(l9_268.z,l9_262,l9_278);
unpackValues(l9_268.y,l9_262,l9_278);
unpackValues(l9_268.x,l9_262,l9_278);
}
l9_262++;
continue;
}
...
vec4 l9_283=texture(sc_OITFilteredDepthBoundsTexture,l9_257);
vec2 l9_284=l9_283.xy;
int l9_285;
#if (sc_SkinBonesCount>0)
{
l9_285=encodeDepth(((1.0-l9_283.x)*1000.0)+getDepthOrderingEpsilon(),l9_284);
}
#else
{
l9_285=0;
...
#endif
int l9_286=encodeDepth(viewSpaceDepth(),l9_284);
vec4 l9_287;
l9_287=l9_242*l9_242.w;
vec4 l9_288;
int l9_289=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_289<8)
{
int l9_290=l9_258[l9_289];
int l9_291=l9_286-l9_285;
bool l9_292=l9_290<l9_291;
bool l9_293;
if (l9_292)
{
l9_293=l9_258[l9_289]>0;
}
else
{
l9_293=l9_292;
...
if (l9_293)
{
vec3 l9_294=l9_287.xyz*(1.0-(float(l9_259[l9_289])/255.0));
l9_288=vec4(l9_294.x,l9_294.y,l9_294.z,l9_287.w);
}
else
{
l9_288=l9_287;
...
sc_writeFragData0Internal(l9_287,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
