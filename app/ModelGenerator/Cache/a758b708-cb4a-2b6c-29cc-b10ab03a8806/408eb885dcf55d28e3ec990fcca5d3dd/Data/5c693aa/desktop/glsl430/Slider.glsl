...
#endif
uvec3 l9_192=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
vec4 l9_241=sc_OutputMotionVectorIfNeeded(max(l9_239,vec4(0.0)));
