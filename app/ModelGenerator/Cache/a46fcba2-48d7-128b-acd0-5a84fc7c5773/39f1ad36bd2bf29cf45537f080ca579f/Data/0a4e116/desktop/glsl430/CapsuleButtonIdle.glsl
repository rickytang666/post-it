...
vec4 l9_173;
if (l9_172<Port_Position1_N007)
{
l9_173=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_172/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_174;
if (l9_172<Port_Position2_N007)
{
l9_174=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_172-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_172<Port_Position3_N007)
{
l9_175=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_172-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_175=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_172-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_174=l9_175;
}
l9_173=l9_174;
}
vec2 l9_176=l9_4*Port_Input1_N028;
float l9_177=clamp(length(l9_176+Port_Input2_N028),0.0,1.0);
vec4 l9_178;
if (l9_177<Port_Position1_N031)
{
l9_178=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_177/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_179;
if (l9_177<Port_Position2_N031)
{
l9_179=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_177-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_180;
if (l9_177<Port_Position3_N031)
{
l9_180=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_177-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_180=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_177-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_179=l9_180;
}
l9_178=l9_179;
}
vec4 l9_181=mix(l9_173,l9_178,l9_178);
float l9_182=clamp(l9_173.x,0.0,1.0);
float l9_183;
if (l9_182<Port_Position1_N011)
{
l9_183=mix(Port_Value0_N011,Port_Value1_N011,clamp(l9_182/Port_Position1_N011,0.0,1.0));
}
else
{
float l9_184;
if (l9_182<Port_Position2_N011)
{
l9_184=mix(Port_Value1_N011,Port_Value2_N011,clamp((l9_182-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0));
}
else
{
float l9_185;
if (l9_182<Port_Position3_N011)
{
l9_185=mix(Port_Value2_N011,Port_Value3_N011,clamp((l9_182-Port_Position2_N011)/(Port_Position3_N011-Port_Position2_N011),0.0,1.0));
}
else
{
l9_185=mix(Port_Value3_N011,Port_Value4_N011,clamp((l9_182-Port_Position3_N011)/(1.0-Port_Position3_N011),0.0,1.0));
}
l9_184=l9_185;
}
l9_183=l9_184;
}
vec4 l9_186=vec4(l9_181.x,l9_181.y,l9_181.z,vec4(0.0).w);
l9_186.w=l9_183;
...
#if (sc_FramebufferFetch)
{
l9_206=sc_readFragData0_Platform();
}
#else
{
...
{
l9_208=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_207,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_208=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_207,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_206=l9_208;
}
#endif
vec3 l9_209=mix(l9_206.xyz,definedBlend(l9_206.xyz,l9_187.xyz).xyz,vec3(l9_188));
...
#if (sc_Voxelization)
{
l9_211=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_212;
#if (sc_OutputBounds)
{
float l9_213=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_212=vec4(l9_213,1.0-l9_213,1.0,1.0);
}
#else
{
vec4 l9_214;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_214=vec4(mix(vec3(1.0),l9_187.xyz,vec3(l9_188)),l9_188);
}
#else
{
vec4 l9_215;
...
#endif
l9_215=vec4(l9_187.xyz*l9_216,l9_216);
}
#else
{
l9_215=l9_187;
...
vec4 l9_219=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_217,vec4(0.0)));
vec4 l9_220=clamp(l9_219,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_221=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_221-0.0039215689)),min(1.0,l9_221+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_222=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_222).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_223=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_222).xy);
float l9_224=packValue(l9_223);
int l9_231=int(l9_220.w*255.0);
float l9_232=packValue(l9_231);
sc_writeFragData0Internal(vec4(packValue(l9_223),packValue(l9_223),packValue(l9_223),packValue(l9_223)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_224,packValue(l9_223),packValue(l9_223),packValue(l9_223)));
sc_writeFragData2(vec4(l9_232,packValue(l9_231),packValue(l9_231),packValue(l9_231)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_235=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_235).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_240==0)
{
l9_243=texture(sc_OITAlpha0,l9_235);
l9_242=texture(sc_OITDepthLow0,l9_235);
l9_241=texture(sc_OITDepthHigh0,l9_235);
}
else
{
l9_243=vec4(0.0);
...
if (l9_240==1)
{
l9_246=texture(sc_OITAlpha1,l9_235);
l9_245=texture(sc_OITDepthLow1,l9_235);
l9_244=texture(sc_OITDepthHigh1,l9_235);
}
else
{
l9_246=l9_243;
...
if (any(notEqual(l9_244,vec4(0.0)))||any(notEqual(l9_245,vec4(0.0))))
{
int l9_247[8]=l9_236;
unpackValues(l9_244.w,l9_240,l9_247);
unpackValues(l9_244.z,l9_240,l9_247);
unpackValues(l9_244.y,l9_240,l9_247);
unpackValues(l9_244.x,l9_240,l9_247);
unpackValues(l9_245.w,l9_240,l9_247);
unpackValues(l9_245.z,l9_240,l9_247);
unpackValues(l9_245.y,l9_240,l9_247);
unpackValues(l9_245.x,l9_240,l9_247);
int l9_256[8]=l9_237;
unpackValues(l9_246.w,l9_240,l9_256);
unpackValues(l9_246.z,l9_240,l9_256);
unpackValues(l9_246.y,l9_240,l9_256);
unpackValues(l9_246.x,l9_240,l9_256);
}
l9_240++;
continue;
}
...
vec4 l9_261=texture(sc_OITFilteredDepthBoundsTexture,l9_235);
vec2 l9_262=l9_261.xy;
int l9_263;
#if (sc_SkinBonesCount>0)
{
l9_263=encodeDepth(((1.0-l9_261.x)*1000.0)+getDepthOrderingEpsilon(),l9_262);
}
#else
{
l9_263=0;
...
#endif
int l9_264=encodeDepth(viewSpaceDepth(),l9_262);
vec4 l9_265;
l9_265=l9_220*l9_220.w;
vec4 l9_266;
int l9_267=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_267<8)
{
int l9_268=l9_236[l9_267];
int l9_269=l9_264-l9_263;
bool l9_270=l9_268<l9_269;
bool l9_271;
if (l9_270)
{
l9_271=l9_236[l9_267]>0;
}
else
{
l9_271=l9_270;
...
if (l9_271)
{
vec3 l9_272=l9_265.xyz*(1.0-(float(l9_237[l9_267])/255.0));
l9_266=vec4(l9_272.x,l9_272.y,l9_272.z,l9_265.w);
}
else
{
l9_266=l9_265;
...
sc_writeFragData0Internal(l9_265,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
