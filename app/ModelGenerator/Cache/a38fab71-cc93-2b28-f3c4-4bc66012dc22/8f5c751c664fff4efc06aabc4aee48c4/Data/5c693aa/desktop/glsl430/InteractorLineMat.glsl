...
varColor=color;
ssGlobals l9_7=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_5,varPosAndMotion.xyz,normalize(sc_Camera.position-varPosAndMotion.xyz));
vec3 l9_8;
if ((l9_5.x*1.0)!=0.0)
{
vec3 l9_9;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_9,l9_7);
l9_8=varPosAndMotion.xyz-l9_9;
}
else
{
vec3 l9_10;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_10,l9_7);
l9_8=varPosAndMotion.xyz+l9_10;
}
vec3 l9_11;
vec3 l9_12;
vec3 l9_13;
if (l9_4)
{
l9_13=varTangent.xyz;
l9_12=varNormalAndMotion.xyz;
l9_11=varPosAndMotion.xyz;
}
else
{
l9_13=varTangent.xyz;
...
varPosAndMotion=vec4(l9_11.x,l9_11.y,l9_11.z,varPosAndMotion.w);
vec3 l9_14=normalize(l9_12);
varNormalAndMotion=vec4(l9_14.x,l9_14.y,l9_14.z,varNormalAndMotion.w);
...
#if (sc_RenderingSpace==3)
{
l9_16=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_17;
#if (sc_RenderingSpace==2)
{
l9_17=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_18;
#if (sc_RenderingSpace==1)
{
l9_18=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_18=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_20=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_21;
#if (sc_RenderingSpace==2)
{
l9_21=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_22;
...
#if (sc_RenderingSpace==1)
{
l9_23=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_23=l9_0.position;
...
{
vec4 l9_27=l9_19;
l9_27.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_19.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_19.w;
l9_26=l9_27;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_29=l9_25.xy+(sc_TAAJitterOffset*l9_25.w);
l9_28=vec4(l9_29.x,l9_29.y,l9_25.z,l9_25.w);
}
#else
{
l9_28=l9_25;
...
int l9_32=int(voxelization_params_0.w);
vec4 l9_33=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_30.position).xyz+vec3(float(l9_31%l9_32)*voxelization_params_0.y,float(l9_31/l9_32)*voxelization_params_0.y,(float(l9_31)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_33.w=1.0;
varScreenPos=l9_33;
...
sc_SkinVertex(l9_34);
vec2 l9_35=((l9_34.position.xy/vec2(l9_34.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_35.x,l9_35.y,varTex01.z,varTex01.w);
vec4 l9_36=sc_ModelMatrixVoxelization*l9_34.position;
vec3 l9_37=l9_36.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_37.x,l9_37.y,l9_37.z,varPosAndMotion.w);
vec3 l9_38=normalize(l9_34.normal);
varNormalAndMotion=vec4(l9_38.x,l9_38.y,l9_38.z,varNormalAndMotion.w);
vec4 l9_39=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_37.x,l9_37.y,l9_37.z,l9_36.w);
...
#endif
vec4 l9_41=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_42=vec4(l9_41.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_43=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_42;
vec4 l9_44=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_42).xyz,1.0);
vec2 l9_45=((l9_43.xy/vec2(l9_43.w)).xy-(l9_44.xy/vec2(l9_44.w)).xy)*0.5;
varPosAndMotion.w=l9_45.x;
varNormalAndMotion.w=l9_45.y;
}
#endif
}
#endif
...
vec4 param_7;
Node37_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),param_7,ssGlobals(sc_Time.x,sc_Time.y,0.0,varTex01.xy));
vec4 l9_0=param_7;
...
vec4 l9_29=sc_OutputMotionVectorIfNeeded(max(l9_27,vec4(0.0)));
...
vec4 l9_71=texture(sc_OITFilteredDepthBoundsTexture,l9_45);
vec2 l9_72=l9_71.xy;
int l9_73;
#if (sc_SkinBonesCount>0)
{
