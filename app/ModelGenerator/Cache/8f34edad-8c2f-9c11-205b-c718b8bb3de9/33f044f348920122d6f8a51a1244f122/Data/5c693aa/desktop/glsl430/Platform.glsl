...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 85 -1
//spec_const int Tweak_N6Layout 86 0
//spec_const int intensityTextureLayout 87 0
//spec_const int planet_refl_mapLayout 88 0
...
mat3 l9_14=mat3(l9_6,l9_5,l9_7);
vec3 l9_15=-l9_4;
...
float l9_70=radians(Port_Rotation_N003);
vec2 l9_71=l9_3-Port_Center_N003;
float l9_72=clamp((vec2(dot(vec2(cos(l9_70),sin(l9_70)),l9_71),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_73;
if (l9_72<colorRatio)
{
l9_73=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_72/colorRatio,0.0,1.0)));
}
else
{
l9_73=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_72-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
bool l9_74=PreviewEnabled==1;
bool l9_75;
if (l9_74)
{
l9_75=!l9_0;
...
vec4 l9_79=l9_69+l9_73;
vec4 l9_80;
#if (Tweak_N6Layout==2)
{
bool l9_81=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_82=l9_2.x;
sc_SoftwareWrapEarly(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_83=l9_82;
float l9_84=l9_2.y;
sc_SoftwareWrapEarly(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_85=l9_84;
vec2 l9_86;
float l9_87;
...
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_88=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_89=l9_83;
float l9_90=1.0;
sc_ClampUV(l9_89,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_88,l9_90);
float l9_91=l9_89;
float l9_92=l9_90;
bool l9_93;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_93=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_93=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_94=l9_85;
float l9_95=l9_92;
sc_ClampUV(l9_94,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_93,l9_95);
l9_87=l9_95;
...
#endif
vec2 l9_96=sc_TransformUV(l9_86,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_97=l9_96.x;
float l9_98=l9_87;
sc_SoftwareWrapLate(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_81,l9_98);
float l9_99=l9_96.y;
float l9_100=l9_98;
sc_SoftwareWrapLate(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_81,l9_100);
float l9_101=l9_100;
vec3 l9_102=sc_SamplingCoordsViewToGlobal(vec2(l9_97,l9_99),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_103=texture(Tweak_N6ArrSC,l9_102,0.0);
vec4 l9_104;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_104=mix(Tweak_N6BorderColor,l9_103,vec4(l9_101));
}
#else
{
l9_104=l9_103;
...
#else
{
bool l9_105=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_106=l9_2.x;
sc_SoftwareWrapEarly(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_107=l9_106;
float l9_108=l9_2.y;
sc_SoftwareWrapEarly(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_109=l9_108;
vec2 l9_110;
float l9_111;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_112=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_113=l9_107;
float l9_114=1.0;
sc_ClampUV(l9_113,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_112,l9_114);
float l9_115=l9_113;
float l9_116=l9_114;
bool l9_117;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_117=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_117=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_118=l9_109;
float l9_119=l9_116;
sc_ClampUV(l9_118,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_117,l9_119);
l9_111=l9_119;
...
#endif
vec2 l9_120=sc_TransformUV(l9_110,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_121=l9_120.x;
float l9_122=l9_111;
sc_SoftwareWrapLate(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_105,l9_122);
float l9_123=l9_120.y;
float l9_124=l9_122;
sc_SoftwareWrapLate(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_105,l9_124);
float l9_125=l9_124;
vec3 l9_126=sc_SamplingCoordsViewToGlobal(vec2(l9_121,l9_123),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_127=texture(Tweak_N6,l9_126.xy,0.0);
vec4 l9_128;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_128=mix(Tweak_N6BorderColor,l9_127,vec4(l9_125));
}
#else
{
l9_128=l9_127;
...
#endif
vec3 l9_129=l9_79.xyz;
vec3 l9_130=mix(l9_129,(l9_80.xyz*l9_129).xyz,vec3(l9_80.w));
float l9_131=l9_79.w;
vec4 l9_132=vec4(l9_130.x,l9_130.y,l9_130.z,vec4(0.0).w);
l9_132.w=l9_131;
