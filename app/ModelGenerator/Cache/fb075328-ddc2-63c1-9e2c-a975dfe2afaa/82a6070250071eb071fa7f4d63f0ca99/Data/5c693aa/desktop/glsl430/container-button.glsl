...
vec4 l9_7=vec4(l9_6.normalWS,0.0);
l9_5=(sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6.positionWS,1.0)).xyz;
l9_4=normalize((sc_ModelMatrixInverse*l9_7).xyz);
l9_3=l9_6.uv0;
l9_2=normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_7).xyz);
}
else
{
vec4 l9_8=vec4(normalize(varNormalAndMotion.xyz),0.0);
l9_5=(sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0)).xyz;
l9_4=normalize((sc_ModelMatrixInverse*l9_8).xyz);
l9_3=varTex01.xy;
l9_2=normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_8).xyz);
}
vec3 l9_9=cross(normalize(l9_5),l9_2);
vec2 l9_10=l9_9.yx;
l9_10.x=l9_9.y*(-1.0);
vec2 l9_11=(l9_10*0.5)+vec2(0.5);
vec4 l9_12;
#if (additional_settings_btn_refl_texLayout==2)
{
bool l9_13=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_14=l9_11.x;
sc_SoftwareWrapEarly(l9_14,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_15=l9_14;
float l9_16=l9_11.y;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_17=l9_16;
vec2 l9_18;
float l9_19;
...
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_21=l9_15;
float l9_22=1.0;
sc_ClampUV(l9_21,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_20,l9_22);
float l9_23=l9_21;
float l9_24=l9_22;
bool l9_25;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_25=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
...
float l9_26=l9_17;
float l9_27=l9_24;
sc_ClampUV(l9_26,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_25,l9_27);
l9_19=l9_27;
...
#endif
vec2 l9_28=sc_TransformUV(l9_18,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_29=l9_28.x;
float l9_30=l9_19;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_13,l9_30);
float l9_31=l9_28.y;
float l9_32=l9_30;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_13,l9_32);
float l9_33=l9_32;
vec3 l9_34=sc_SamplingCoordsViewToGlobal(vec2(l9_29,l9_31),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_35=texture(additional_settings_btn_refl_texArrSC,l9_34,0.0);
vec4 l9_36;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_36=mix(additional_settings_btn_refl_texBorderColor,l9_35,vec4(l9_33));
}
#else
{
l9_36=l9_35;
...
#else
{
bool l9_37=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_38=l9_11.x;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_39=l9_38;
float l9_40=l9_11.y;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_41=l9_40;
vec2 l9_42;
float l9_43;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_45=l9_39;
float l9_46=1.0;
sc_ClampUV(l9_45,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_44,l9_46);
float l9_47=l9_45;
float l9_48=l9_46;
bool l9_49;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
...
float l9_50=l9_41;
float l9_51=l9_48;
sc_ClampUV(l9_50,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_49,l9_51);
l9_43=l9_51;
...
#endif
vec2 l9_52=sc_TransformUV(l9_42,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_37,l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_37,l9_56);
float l9_57=l9_56;
vec3 l9_58=sc_SamplingCoordsViewToGlobal(vec2(l9_53,l9_55),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_59=texture(additional_settings_btn_refl_tex,l9_58.xy,0.0);
vec4 l9_60;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_60=mix(additional_settings_btn_refl_texBorderColor,l9_59,vec4(l9_57));
}
#else
{
l9_60=l9_59;
...
#endif
float l9_61=length((vec4(l9_4.xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_62=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_63=max(l9_62,Port_Input1_N019);
float l9_64=clamp(l9_61,0.0,1.0);
vec4 l9_65;
if (l9_64<Port_Position1_N007)
{
l9_65=mix(l9_62,l9_63,vec4(clamp(l9_64/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_66;
if (l9_64<Port_Position2_N007)
{
l9_66=mix(l9_63,Port_Value2_N007,vec4(clamp((l9_64-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_66=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_64-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_65=l9_66;
}
bool l9_67=PreviewEnabled==1;
bool l9_68;
if (l9_67)
{
l9_68=!l9_0;
...
vec4 l9_72=l9_12+l9_65;
vec4 l9_73=baseColor*l9_65;
float l9_74=clamp((l9_61*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_75;
if (l9_74<=0.0)
{
l9_75=0.0;
...
{
l9_75=pow(l9_74,Port_Input1_N022);
}
float l9_76;
if (l9_75<=0.0)
{
...
{
l9_76=pow(l9_75,Port_Input1_N034);
}
float l9_77=l9_76*Port_Input1_N041;
vec2 l9_78=l9_3-Port_Center_N002;
vec2 l9_79=(l9_78*iconScale)+Port_Center_N002;
vec4 l9_80;
#if (iconLayout==2)
{
bool l9_81=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_82=l9_79.x;
sc_SoftwareWrapEarly(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_83=l9_82;
float l9_84=l9_79.y;
sc_SoftwareWrapEarly(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_85=l9_84;
vec2 l9_86;
float l9_87;
...
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_89=l9_83;
float l9_90=1.0;
sc_ClampUV(l9_89,iconUvMinMax.x,iconUvMinMax.z,l9_88,l9_90);
float l9_91=l9_89;
float l9_92=l9_90;
bool l9_93;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_93=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_94=l9_85;
float l9_95=l9_92;
sc_ClampUV(l9_94,iconUvMinMax.y,iconUvMinMax.w,l9_93,l9_95);
l9_87=l9_95;
l9_86=vec2(l9_91,l9_94);
}
#else
{
l9_87=1.0;
l9_86=vec2(l9_83,l9_85);
}
#endif
vec2 l9_96=sc_TransformUV(l9_86,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_97=l9_96.x;
float l9_98=l9_87;
sc_SoftwareWrapLate(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_81,l9_98);
float l9_99=l9_96.y;
float l9_100=l9_98;
sc_SoftwareWrapLate(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_81,l9_100);
float l9_101=l9_100;
vec3 l9_102=sc_SamplingCoordsViewToGlobal(vec2(l9_97,l9_99),iconLayout,iconGetStereoViewIndex());
vec4 l9_103=texture(iconArrSC,l9_102,0.0);
vec4 l9_104;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_104=mix(iconBorderColor,l9_103,vec4(l9_101));
}
#else
{
l9_104=l9_103;
...
#else
{
bool l9_105=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_106=l9_79.x;
sc_SoftwareWrapEarly(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_107=l9_106;
float l9_108=l9_79.y;
sc_SoftwareWrapEarly(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_109=l9_108;
vec2 l9_110;
float l9_111;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_113=l9_107;
float l9_114=1.0;
sc_ClampUV(l9_113,iconUvMinMax.x,iconUvMinMax.z,l9_112,l9_114);
float l9_115=l9_113;
float l9_116=l9_114;
bool l9_117;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_117=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_118=l9_109;
float l9_119=l9_116;
sc_ClampUV(l9_118,iconUvMinMax.y,iconUvMinMax.w,l9_117,l9_119);
l9_111=l9_119;
...
#endif
vec2 l9_120=sc_TransformUV(l9_110,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_121=l9_120.x;
float l9_122=l9_111;
sc_SoftwareWrapLate(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_105,l9_122);
float l9_123=l9_120.y;
float l9_124=l9_122;
sc_SoftwareWrapLate(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_105,l9_124);
float l9_125=l9_124;
vec3 l9_126=sc_SamplingCoordsViewToGlobal(vec2(l9_121,l9_123),iconLayout,iconGetStereoViewIndex());
vec4 l9_127=texture(icon,l9_126.xy,0.0);
vec4 l9_128;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_128=mix(iconBorderColor,l9_127,vec4(l9_125));
}
#else
{
l9_128=l9_127;
...
#endif
vec4 l9_129=mix(mix(mix(baseColor*(l9_72*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_73)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_77)),vec4(l9_80.xyz,0.0),vec4(l9_80.w));
float l9_130=max(l9_75,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_131=max(l9_80.w,l9_130)*alpha;
vec4 l9_132=vec4(l9_129.x,l9_129.y,l9_129.z,vec4(0.0).w);
l9_132.w=l9_131;
...
vec4 l9_163=sc_OutputMotionVectorIfNeeded(max(l9_161,vec4(0.0)));
