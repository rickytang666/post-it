...
#endif
sc_writeFragData0Internal(max(l9_52,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_54;
...
{
l9_56=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_57=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_58;
...
{
l9_59=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_60;
...
{
l9_60=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_62;
#if (sc_BlendMode_Add)
{
l9_62=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_63;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_63=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_64;
...
{
l9_64=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_65;
#if (sc_BlendMode_Min)
{
l9_65=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_66;
...
#endif
l9_54=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_55);
}
#else
{
vec4 l9_67;
...
#endif
vec3 l9_72=mix(l9_69.xyz,definedBlend(l9_69.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_77=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_78;
...
#endif
l9_78=vec4(l9_3.xyz*l9_79,l9_79);
}
#else
{
l9_78=l9_3;
