...
uniform float pokeOccludeGradientMaskPosition;
uniform int PreviewEnabled;
...
uniform float Port_Value1_N000;
uniform float Port_Value2_N000;
uniform float Port_Value3_N000;
...
#if (maskMapLayout==2)
{
bool l9_6=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_7=l9_2.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_8=l9_7;
float l9_9=l9_2.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_6,l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_6,l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),maskMapLayout,maskMapGetStereoViewIndex());
vec4 l9_28=texture(maskMapArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_29=mix(maskMapBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#else
{
bool l9_30=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_31=l9_2.x;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_32=l9_31;
float l9_33=l9_2.y;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
#if (SC_USE_UV_MIN_MAX_maskMap)
...
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_30,l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_30,l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),maskMapLayout,maskMapGetStereoViewIndex());
vec4 l9_52=texture(maskMap,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_53=mix(maskMapBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
float l9_54=radians(Port_Rotation_N018);
vec2 l9_55=l9_3-Port_Center_N018;
float l9_56=clamp((vec2(dot(vec2(cos(l9_54),sin(l9_54)),l9_55),0.0)+Port_Center_N018).x,0.0,1.0);
float l9_57;
if (l9_56<Port_Position1_N020)
{
l9_57=mix(Port_Value0_N020,Port_Value1_N020,clamp(l9_56/Port_Position1_N020,0.0,1.0));
}
else
{
float l9_58;
if (l9_56<pokeOccludeGradientMaskPosition)
{
l9_58=mix(Port_Value1_N020,Port_Value2_N020,clamp((l9_56-Port_Position1_N020)/(pokeOccludeGradientMaskPosition-Port_Position1_N020),0.0,1.0));
}
else
{
l9_58=mix(Port_Value2_N020,Port_Value3_N020,clamp((l9_56-pokeOccludeGradientMaskPosition)/(1.0-pokeOccludeGradientMaskPosition),0.0,1.0));
}
l9_57=l9_58;
}
bool l9_59=PreviewEnabled==1;
bool l9_60;
if (l9_59)
{
l9_60=!l9_0;
...
bool l9_61;
vec4 l9_62;
if (l9_60&&(20==PreviewNodeID))
{
vec4 l9_63=vec4(l9_57,l9_57,l9_57,1.0);
l9_63.w=1.0;
l9_62=l9_63;
l9_61=true;
}
...
float l9_64=l9_5.z*l9_57;
vec4 l9_65=vec4(1.0-pokePinchBlend)*vec4(Port_Value1_N000,Port_Value2_N000,Port_Value3_N000,l9_64);
float l9_66=l9_65.w;
...
#if (sc_Voxelization)
{
l9_89=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_90;
#if (sc_OutputBounds)
{
float l9_91=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_90=vec4(l9_91,1.0-l9_91,1.0,1.0);
}
#else
{
vec4 l9_92;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_92=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_66)),l9_66);
}
#else
{
vec4 l9_93;
...
#endif
l9_93=vec4(l9_65.xyz*l9_94,l9_94);
}
#else
{
l9_93=l9_65;
...
vec4 l9_97=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_95,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_99-0.0039215689)),min(1.0,l9_99+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_101),packValue(l9_101),packValue(l9_101),packValue(l9_101)),sc_UniformConstants.x,sc_ShaderCacheConstant);
