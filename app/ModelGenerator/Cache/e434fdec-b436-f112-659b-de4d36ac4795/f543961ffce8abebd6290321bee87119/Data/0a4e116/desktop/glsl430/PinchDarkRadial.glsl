...
#endif
vec4 param_6;
Node78_Gradient(l9_6.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_6,l9_18);
vec4 l9_22=param_6;
vec4 param_11;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_11,l9_18);
vec4 l9_23=param_11;
float l9_24;
#if (ENABLE_OPACITY_TEX)
{
...
vec4 l9_209=l9_208*vec4(colorMultiplier+1.0);
float l9_210=l9_208.w;
...
#if (sc_Voxelization)
{
l9_232=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_233;
#if (sc_OutputBounds)
{
float l9_234=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_233=vec4(l9_234,1.0-l9_234,1.0,1.0);
}
#else
{
vec4 l9_235;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_235=vec4(mix(vec3(1.0),l9_211.xyz,vec3(l9_210)),l9_210);
}
#else
{
vec4 l9_236;
...
#endif
l9_236=vec4(l9_211.xyz*l9_237,l9_237);
}
#else
{
l9_236=l9_211;
...
vec4 l9_240=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_238,vec4(0.0)));
vec4 l9_241=clamp(l9_240,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_242=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_242-0.0039215689)),min(1.0,l9_242+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_243=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_243).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_244=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_243).xy);
float l9_245=packValue(l9_244);
int l9_252=int(l9_241.w*255.0);
float l9_253=packValue(l9_252);
sc_writeFragData0Internal(vec4(packValue(l9_244),packValue(l9_244),packValue(l9_244),packValue(l9_244)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_245,packValue(l9_244),packValue(l9_244),packValue(l9_244)));
sc_writeFragData2(vec4(l9_253,packValue(l9_252),packValue(l9_252),packValue(l9_252)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_256=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_256).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_261==0)
{
l9_264=texture(sc_OITAlpha0,l9_256);
l9_263=texture(sc_OITDepthLow0,l9_256);
l9_262=texture(sc_OITDepthHigh0,l9_256);
}
else
{
l9_264=vec4(0.0);
...
if (l9_261==1)
{
l9_267=texture(sc_OITAlpha1,l9_256);
l9_266=texture(sc_OITDepthLow1,l9_256);
l9_265=texture(sc_OITDepthHigh1,l9_256);
}
else
{
l9_267=l9_264;
...
if (any(notEqual(l9_265,vec4(0.0)))||any(notEqual(l9_266,vec4(0.0))))
{
int l9_268[8]=l9_257;
unpackValues(l9_265.w,l9_261,l9_268);
unpackValues(l9_265.z,l9_261,l9_268);
unpackValues(l9_265.y,l9_261,l9_268);
unpackValues(l9_265.x,l9_261,l9_268);
unpackValues(l9_266.w,l9_261,l9_268);
unpackValues(l9_266.z,l9_261,l9_268);
unpackValues(l9_266.y,l9_261,l9_268);
unpackValues(l9_266.x,l9_261,l9_268);
int l9_277[8]=l9_258;
unpackValues(l9_267.w,l9_261,l9_277);
unpackValues(l9_267.z,l9_261,l9_277);
unpackValues(l9_267.y,l9_261,l9_277);
unpackValues(l9_267.x,l9_261,l9_277);
}
l9_261++;
continue;
}
...
vec4 l9_282=texture(sc_OITFilteredDepthBoundsTexture,l9_256);
vec2 l9_283=l9_282.xy;
int l9_284;
#if (sc_SkinBonesCount>0)
{
l9_284=encodeDepth(((1.0-l9_282.x)*1000.0)+getDepthOrderingEpsilon(),l9_283);
}
#else
{
l9_284=0;
...
#endif
int l9_285=encodeDepth(viewSpaceDepth(),l9_283);
vec4 l9_286;
l9_286=l9_241*l9_241.w;
vec4 l9_287;
int l9_288=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_288<8)
{
int l9_289=l9_257[l9_288];
int l9_290=l9_285-l9_284;
bool l9_291=l9_289<l9_290;
bool l9_292;
if (l9_291)
{
l9_292=l9_257[l9_288]>0;
}
else
{
l9_292=l9_291;
...
if (l9_292)
{
vec3 l9_293=l9_286.xyz*(1.0-(float(l9_258[l9_288])/255.0));
l9_287=vec4(l9_293.x,l9_293.y,l9_293.z,l9_286.w);
}
else
{
l9_287=l9_286;
...
sc_writeFragData0Internal(l9_286,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
