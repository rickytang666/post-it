...
#endif
vec4 param_5;
Node78_Gradient(varTex01.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_6);
vec4 l9_9=param_5;
vec4 param_10;
...
vec4 l9_240=sc_OutputMotionVectorIfNeeded(max(l9_238,vec4(0.0)));
