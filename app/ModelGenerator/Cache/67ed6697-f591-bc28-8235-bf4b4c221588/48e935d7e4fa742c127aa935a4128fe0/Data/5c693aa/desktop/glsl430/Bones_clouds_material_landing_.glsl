...
float l9_8=l9_7.y;
float l9_9=floor(float(l9_8<Port_Input1_N021));
vec4 l9_10;
if (l9_9==0.0)
{
l9_10=vec4(l9_8);
...
if (l9_9==1.0)
{
l9_11=Port_Value1_N025;
}
else
{
l9_11=Port_Default_N025;
}
l9_10=l9_11;
}
vec3 l9_12;
...
if (l9_4)
{
l9_14=varTangent.xyz;
l9_13=varNormalAndMotion.xyz;
l9_12=varPosAndMotion.xyz;
}
else
{
l9_14=varTangent.xyz;
l9_13=varNormalAndMotion.xyz;
l9_12=(sc_ModelMatrix*vec4(l9_7.x,l9_10.x,l9_7.z,1.0)).xyz;
}
varPosAndMotion=vec4(l9_12.x,l9_12.y,l9_12.z,varPosAndMotion.w);
vec3 l9_15=normalize(l9_13);
varNormalAndMotion=vec4(l9_15.x,l9_15.y,l9_15.z,varNormalAndMotion.w);
...
#if (sc_RenderingSpace==3)
{
l9_17=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_18;
#if (sc_RenderingSpace==2)
{
l9_18=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_19;
#if (sc_RenderingSpace==1)
{
l9_19=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_19=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_21=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_22;
#if (sc_RenderingSpace==2)
{
l9_22=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_23;
...
#if (sc_RenderingSpace==1)
{
l9_24=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_24=l9_0.position;
...
#if (sc_TAAEnabled)
{
vec2 l9_30=l9_26.xy+(sc_TAAJitterOffset*l9_26.w);
l9_29=vec4(l9_30.x,l9_30.y,l9_26.z,l9_26.w);
}
#else
{
l9_29=l9_26;
...
#endif
sc_SetClipPosition(l9_29);
#if (sc_Voxelization)
{
sc_Vertex_t l9_31=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_31);
sc_SkinVertex(l9_31);
int l9_32=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_33=int(voxelization_params_0.w);
vec4 l9_34=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_31.position).xyz+vec3(float(l9_32%l9_33)*voxelization_params_0.y,float(l9_32/l9_33)*voxelization_params_0.y,(float(l9_32)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_34.w=1.0;
varScreenPos=l9_34;
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_35=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_35);
sc_SkinVertex(l9_35);
vec2 l9_36=((l9_35.position.xy/vec2(l9_35.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_36.x,l9_36.y,varTex01.z,varTex01.w);
vec4 l9_37=sc_ModelMatrixVoxelization*l9_35.position;
vec3 l9_38=l9_37.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_38.x,l9_38.y,l9_38.z,varPosAndMotion.w);
vec3 l9_39=normalize(l9_35.normal);
varNormalAndMotion=vec4(l9_39.x,l9_39.y,l9_39.z,varNormalAndMotion.w);
vec4 l9_40=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_38.x,l9_38.y,l9_38.z,l9_37.w);
vec4 l9_41=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_41.w=1.0;
varScreenPos=l9_41;
sc_SetClipPosition(l9_41*1.0);
}
#endif
}
#endif
vec4 l9_42=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_43=vec4(l9_42.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_44=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_43;
vec4 l9_45=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_43).xyz,1.0);
vec2 l9_46=((l9_44.xy/vec2(l9_44.w)).xy-(l9_45.xy/vec2(l9_45.w)).xy)*0.5;
varPosAndMotion.w=l9_46.x;
varNormalAndMotion.w=l9_46.y;
}
#endif
}
#endif
...
vec4 l9_0=sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0);
vec3 l9_1=normalize(varTangent.xyz);
vec3 l9_2=normalize(varNormalAndMotion.xyz);
float l9_3=floor(float(l9_0.y<Port_Input1_N040));
vec3 l9_4;
if (l9_3==0.0)
{
vec3 l9_5;
Node66_Switch(0.0,vec3(0.0),vec3(0.0),Port_Default_N066,l9_5,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0.xyz,l9_1,l9_2,cross(l9_2,l9_1)*varTangent.w,normalize(sc_Camera.position-varPosAndMotion.xyz),varPosAndMotion.xyz));
l9_4=l9_5;
}
else
{
...
#endif
vec3 l9_26=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_7.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_7.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_32;
...
vec4 l9_36=sc_OutputMotionVectorIfNeeded(max(l9_34,vec4(0.0)));
