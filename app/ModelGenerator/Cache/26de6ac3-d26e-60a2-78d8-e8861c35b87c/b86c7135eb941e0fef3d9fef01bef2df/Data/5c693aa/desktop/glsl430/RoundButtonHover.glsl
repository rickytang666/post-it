...
{
vec4 l9_72;
if (l9_69<Port_Position3_N007)
{
l9_72=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_69-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_72=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_69-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_71=l9_72;
}
l9_70=l9_71;
...
vec3 l9_73=-l9_5;
vec4 l9_74=mix(l9_70,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(l9_73,l9_12*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_75=l9_74.w;
vec3 l9_76=(l9_67.xyz+Port_Input1_N002)+l9_74.xyz;
...
{
l9_83=clamp(dot(l9_77.xyz,vec3(l9_75)),0.0,1.0);
}
#else
{
float l9_84;
...
{
l9_85=(1.0-dot(l9_77.xyz,vec3(0.33333001)))*l9_75;
}
#else
{
float l9_86;
...
{
l9_86=(1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0))*l9_75;
}
#else
{
float l9_87;
...
{
l9_87=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_75;
}
#else
{
float l9_88;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_89=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_75;
}
#else
{
float l9_90;
...
{
l9_90=dot(l9_77.xyz,vec3(0.33333001))*l9_75;
}
#else
{
float l9_91;
...
#endif
vec3 l9_98=mix(l9_95.xyz,definedBlend(l9_95.xyz,l9_77.xyz).xyz,vec3(l9_75));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_103=vec4(mix(vec3(1.0),l9_77.xyz,vec3(l9_75)),l9_75);
}
#else
{
vec4 l9_104;
...
vec4 l9_108=sc_OutputMotionVectorIfNeeded(max(l9_106,vec4(0.0)));
