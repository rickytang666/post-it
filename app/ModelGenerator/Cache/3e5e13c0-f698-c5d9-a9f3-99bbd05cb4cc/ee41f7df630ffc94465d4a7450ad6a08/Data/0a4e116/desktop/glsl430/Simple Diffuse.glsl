...
#endif
uvec3 l9_2=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
#endif
sc_writeFragData0Internal(max(l9_10,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_12;
#if (sc_ProjectiveShadowsCaster)
