...
vec3 l9_7=varNormal;
vec4 param_5;
Node17_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),Port_Default_N017,param_5,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_6,varColor,texture3));
vec3 l9_8;
vec3 l9_9;
vec3 l9_10;
if (l9_3)
{
l9_10=varTangent.xyz;
l9_9=varNormal;
l9_8=varPos;
}
else
...
l9_10=varTangent.xyz;
l9_9=l9_7;
l9_8=(sc_ModelMatrix*vec4(((l9_6*vec3((float(l9_0)*Port_Input1_N009)+Port_Input1_N007,Port_Value2_N059,Port_Value3_N059))*param_5.xyz)*vec3(smoothstep(Port_Input0_N006,Port_Input1_N006,fire_scale)),1.0)).xyz;
}
varPos=l9_8;
varNormal=normalize(l9_9);
vec3 l9_11=normalize(l9_10);
...
#if (sc_RenderingSpace==3)
{
l9_12=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_13;
#if (sc_RenderingSpace==2)
{
l9_13=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_14;
#if (sc_RenderingSpace==1)
{
l9_14=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_14=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_16=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_17;
...
#if (sc_RenderingSpace==1)
{
l9_18=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_18=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_19=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_19=l9_1.position;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_26=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_30=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_4,l9_1.texture1);
sc_BlendVertex(l9_30);
sc_SkinVertex(l9_30);
vec2 l9_31=((l9_30.position.xy/vec2(l9_30.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_31.x,l9_31.y,varPackedTex.z,varPackedTex.w);
vec4 l9_32=sc_ModelMatrixVoxelization*l9_30.position;
vec3 l9_33=l9_32.xyz-voxelization_params_camera_pos;
varPos=l9_33.xyz;
varNormal=normalize(l9_30.normal);
vec4 l9_34=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_33.x,l9_33.y,l9_33.z,l9_32.w);
...
#if (sc_FramebufferFetch)
{
l9_107=sc_readFragData0_Platform();
}
#else
{
...
vec4 l9_120=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_118,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_122-0.0039215689)),min(1.0,l9_122+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_124),packValue(l9_124),packValue(l9_124),packValue(l9_124)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_125,packValue(l9_124),packValue(l9_124),packValue(l9_124)));
sc_writeFragData2(vec4(l9_133,packValue(l9_132),packValue(l9_132),packValue(l9_132)));
...
sc_writeFragData0Internal(l9_121,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
