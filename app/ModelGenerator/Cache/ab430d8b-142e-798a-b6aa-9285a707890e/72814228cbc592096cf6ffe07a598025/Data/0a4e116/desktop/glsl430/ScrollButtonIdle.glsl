...
vec2 l9_118=l9_4*Port_Input1_N028;
float l9_119=clamp(length(l9_118+Port_Input2_N028),0.0,1.0);
vec4 l9_120;
if (l9_119<Port_Position1_N031)
{
l9_120=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_119/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_121;
if (l9_119<Port_Position2_N031)
{
l9_121=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_119-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_122;
if (l9_119<Port_Position3_N031)
{
l9_122=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_119-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_122=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_119-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_121=l9_122;
}
l9_120=l9_121;
}
vec3 l9_123=l9_12*Port_Import_N041;
float l9_124=dot(l9_123,l9_123);
float l9_125;
if (l9_124>0.0)
{
...
vec3 l9_127=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_126,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
vec4 l9_128;
#if (capsule_btn_refl_tex_1Layout==2)
{
bool l9_129=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_130=l9_127.x;
sc_SoftwareWrapEarly(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_131=l9_130;
float l9_132=l9_127.y;
sc_SoftwareWrapEarly(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_133=l9_132;
vec2 l9_134;
float l9_135;
...
{
l9_136=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
...
float l9_137=l9_131;
float l9_138=1.0;
sc_ClampUV(l9_137,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_136,l9_138);
float l9_139=l9_137;
float l9_140=l9_138;
bool l9_141;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_141=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_141=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_142=l9_133;
float l9_143=l9_140;
sc_ClampUV(l9_142,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_141,l9_143);
l9_135=l9_143;
...
#endif
vec2 l9_144=sc_TransformUV(l9_134,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_145=l9_144.x;
float l9_146=l9_135;
sc_SoftwareWrapLate(l9_145,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_129,l9_146);
float l9_147=l9_144.y;
float l9_148=l9_146;
sc_SoftwareWrapLate(l9_147,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_129,l9_148);
float l9_149=l9_148;
vec3 l9_150=sc_SamplingCoordsViewToGlobal(vec2(l9_145,l9_147),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_151=texture(capsule_btn_refl_tex_1ArrSC,l9_150,0.0);
vec4 l9_152;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_152=mix(capsule_btn_refl_tex_1BorderColor,l9_151,vec4(l9_149));
}
#else
{
l9_152=l9_151;
...
#else
{
bool l9_153=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_154=l9_127.x;
sc_SoftwareWrapEarly(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_155=l9_154;
float l9_156=l9_127.y;
sc_SoftwareWrapEarly(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_157=l9_156;
vec2 l9_158;
float l9_159;
#if (SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)
...
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_160=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
...
float l9_161=l9_155;
float l9_162=1.0;
sc_ClampUV(l9_161,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_160,l9_162);
float l9_163=l9_161;
float l9_164=l9_162;
bool l9_165;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_165=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_165=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_166=l9_157;
float l9_167=l9_164;
sc_ClampUV(l9_166,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_165,l9_167);
l9_159=l9_167;
...
#endif
vec2 l9_168=sc_TransformUV(l9_158,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_169=l9_168.x;
float l9_170=l9_159;
sc_SoftwareWrapLate(l9_169,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_153,l9_170);
float l9_171=l9_168.y;
float l9_172=l9_170;
sc_SoftwareWrapLate(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_153,l9_172);
float l9_173=l9_172;
vec3 l9_174=sc_SamplingCoordsViewToGlobal(vec2(l9_169,l9_171),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_175=texture(capsule_btn_refl_tex_1,l9_174.xy,0.0);
vec4 l9_176;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_176=mix(capsule_btn_refl_tex_1BorderColor,l9_175,vec4(l9_173));
}
#else
{
l9_176=l9_175;
...
#endif
vec4 l9_177=vec4(Port_Import_N027)*l9_128;
float l9_178=clamp(((l9_177.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_179;
if (l9_178<Port_Position1_N005)
{
l9_179=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_178/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_180;
if (l9_178<Port_Position2_N005)
{
l9_180=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_178-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_180=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_178-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_179=l9_180;
}
vec3 l9_181=-l9_5;
vec4 l9_182=mix(l9_179,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_181,l9_12*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_183=l9_120+l9_182;
float l9_184;
if (l9_119<Port_Position1_N016)
{
l9_184=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_119/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_185;
if (l9_119<Port_Position2_N016)
{
l9_185=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_119-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_186;
if (l9_119<Port_Position3_N016)
{
l9_186=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_119-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_186=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_119-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_185=l9_186;
}
l9_184=l9_185;
}
vec4 l9_187=vec4(l9_183.x,l9_183.y,l9_183.z,vec4(0.0).w);
l9_187.w=l9_184;
vec4 l9_188=l9_117+l9_187;
float l9_189=l9_188.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_189<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_189<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_190,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_192;
...
{
l9_194=clamp(l9_189*2.0,0.0,1.0);
}
#else
{
float l9_195;
...
{
l9_195=clamp(dot(l9_188.xyz,vec3(l9_189)),0.0,1.0);
}
#else
{
float l9_196;
...
{
l9_197=(1.0-dot(l9_188.xyz,vec3(0.33333001)))*l9_189;
}
#else
{
float l9_198;
...
{
l9_198=(1.0-clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0))*l9_189;
}
#else
{
float l9_199;
...
{
l9_199=clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0)*l9_189;
}
#else
{
float l9_200;
#if (sc_BlendMode_Add)
{
l9_200=clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_201;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_201=clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0)*l9_189;
}
#else
{
float l9_202;
...
{
l9_202=dot(l9_188.xyz,vec3(0.33333001))*l9_189;
}
#else
{
float l9_203;
#if (sc_BlendMode_Min)
{
l9_203=1.0-clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_204;
#if (sc_BlendMode_Max)
{
l9_204=clamp(dot(l9_188.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_204=1.0;
...
#endif
l9_192=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_188.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_193);
}
#else
{
vec4 l9_205;
...
#if (sc_FramebufferFetch)
{
l9_207=sc_readFragData0_Platform();
}
#else
{
vec2 l9_208=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_209;
#if (sc_ScreenTextureLayout==2)
{
l9_209=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_208,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_209=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_208,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_207=l9_209;
}
#endif
vec3 l9_210=mix(l9_207.xyz,definedBlend(l9_207.xyz,l9_188.xyz).xyz,vec3(l9_189));
vec4 l9_211=vec4(l9_210.x,l9_210.y,l9_210.z,vec4(0.0).w);
l9_211.w=1.0;
l9_206=l9_211;
}
#else
...
#if (sc_Voxelization)
{
l9_212=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_213;
#if (sc_OutputBounds)
{
float l9_214=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_213=vec4(l9_214,1.0-l9_214,1.0,1.0);
}
#else
{
vec4 l9_215;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_215=vec4(mix(vec3(1.0),l9_188.xyz,vec3(l9_189)),l9_189);
}
#else
{
vec4 l9_216;
...
#endif
l9_216=vec4(l9_188.xyz*l9_217,l9_217);
}
#else
{
l9_216=l9_188;
...
vec4 l9_220=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_218,vec4(0.0)));
...
#endif
int l9_224=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_223).xy);
...
if (l9_241==0)
{
l9_244=texture(sc_OITAlpha0,l9_236);
l9_243=texture(sc_OITDepthLow0,l9_236);
l9_242=texture(sc_OITDepthHigh0,l9_236);
}
else
{
l9_244=vec4(0.0);
...
if (l9_241==1)
{
l9_247=texture(sc_OITAlpha1,l9_236);
l9_246=texture(sc_OITDepthLow1,l9_236);
l9_245=texture(sc_OITDepthHigh1,l9_236);
}
else
{
l9_247=l9_244;
...
vec4 l9_262=texture(sc_OITFilteredDepthBoundsTexture,l9_236);
