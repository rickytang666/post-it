...
varColor=color;
vec3 l9_5=varNormal;
float l9_6=floor(float(idleTalkThinking));
vec4 l9_7;
if (l9_6==0.0)
{
float l9_8=((Port_TimeA_N053+Port_TimeTransition_N053)+Port_TimeB_N053)+9.9999997e-05;
l9_7=vec4(mix(Port_ValueA_N053,Port_ValueB_N053,smoothstep(Port_TimeA_N053/l9_8,1.0-(Port_TimeB_N053/l9_8),abs((mod((sc_Time.x/l9_8)+Port_TimeBias_N053,1.0)*2.0)-1.0))));
}
else
{
vec4 l9_9;
if (l9_6==1.0)
{
float l9_10=((Port_TimeA_N063+Port_TimeTransition_N063)+Port_TimeB_N063)+9.9999997e-05;
l9_9=vec4(mix(Port_ValueA_N063,Port_ValueB_N063,smoothstep(Port_TimeA_N063/l9_10,1.0-(Port_TimeB_N063/l9_10),abs((mod((sc_Time.x/l9_10)+(((((floor(((snoise(vec2(floor(fract(sc_Time.x*Port_Multiplier_N001)*10000.0)*9.9999997e-05)*(Port_Scale_N047*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N048)/((Port_RangeMaxA_N048-Port_RangeMinA_N048)+1e-06))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048),1.0)*2.0)-1.0))));
}
else
{
vec4 l9_11;
if (l9_6==2.0)
{
l9_11=Port_Value2_N061;
}
else
{
l9_11=Port_Default_N061;
}
l9_9=l9_11;
}
l9_7=l9_9;
...
l9_14=varTangent.xyz;
l9_13=l9_5;
l9_12=(sc_ModelMatrix*vec4((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*l9_7.xyz,1.0)).xyz;
}
varPos=l9_12;
varNormal=normalize(l9_13);
...
#if (sc_RenderingSpace==2)
{
l9_21=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_22;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_30=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_34=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_34);
sc_SkinVertex(l9_34);
vec2 l9_35=((l9_34.position.xy/vec2(l9_34.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_35.x,l9_35.y,varPackedTex.z,varPackedTex.w);
vec4 l9_36=sc_ModelMatrixVoxelization*l9_34.position;
vec3 l9_37=l9_36.xyz-voxelization_params_camera_pos;
varPos=l9_37.xyz;
varNormal=normalize(l9_34.normal);
vec4 l9_38=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_37.x,l9_37.y,l9_37.z,l9_36.w);
vec4 l9_39=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_39.w=1.0;
varScreenPos=l9_39;
sc_SetClipPosition(l9_39*1.0);
}
#endif
}
#endif
...
vec4 l9_349=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_347,vec4(0.0)));
